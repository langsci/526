\scp{\tsc{Teor-Kur}}{11-04}
The Teor language is spoken on an island to the south of the
Watubela string of islands,
and Kur is spoken on the nearby northwestern most islands of the Kei archipelago.
...
Kei and Tanimbar languages by \citet{Hughes1987} based on lexical
similarity that is closer to Kei (54{\%})
and Fordata (57{\%}) than to \tsc{Eastern Islands} languages of Maluku.
But lexical similarity with Yamdena (48{\%}) is about the same
as with Geser (49{\%}).

Regarding the data sources,
the only accessible data for Teor is the word list in \citet{Wallace1869}.\footnote{
		Shortly before the final version of this manuscript was
		submitted for typesetting and publication we received a 479-item
		Teor wordlist (see appendix \ref{ch:ComWor}) from Craig Marshall.
		This wordlist confirms that Teor has the defining sound changes
...
The only data for Kur we have been able to access is the word list
...
between \tsc{Teor-Kur} and \tsc{Tanimbar-Bomberai}.
However, more reflexes of *z are clearly needed before any definitive
statements can be made.
Teor *daRaq > ‹larah› blood may also attest a link between
\tsc{Teor-Kur} and \tsc{Tanimbar-Bomberai} as members of \tsc{Nuclear Tanimbar-Bomberai}
...
llll}
\lsptoprule
%\tbx{11-4}	&	PMP	&	Teor	&	Kur	&	local gl.	\\	\midrule
%\endfirsthead
\tbx{11-04}	&	PMP	&	Teor	&	Kur	&	local gl.	\\	\midrule
%\endhead
...
*ə, and *-ay/*-aw in final syllables for Teor
and Kur is shown in \qf{11-05}--\qf{11-08}.
...
Teor and Kur do not have *-aw > \it{a}.

\noindent{\wg\st{6pt}\tblr{>{\hspace{-\tabcolsep}}l<{\hspace{-\tabcolsep}}
>{\hspace{-\tabcolsep}\enspace}
lllll}
\lsptoprule
%\tbx{11-05}	&	PMP	&	Teor	&	Kur	&	local gl.\\	\midrule
%\endfirsthead
&	&	PMP	&	Teor	&	Kur	&	local gl.\\	\midrule
%\endhead
...
Kur has variant forms for *anak (\it{an\tbr{ak} hira} ‘children’
...
One example which can be gleaned from the Kur data is *bat\tbr{u}
+ *pəñu > \it{fa\tbr{u}t pen} ‘turtle rock’ but *bat\tbr{u} > \it{fat\tbr{i}n} ‘seed'.
Potential examples from Teor are given in \qf{11-00}.

\noindent{\wg\st{6pt}\tblr{>{\hspace{-\tabcolsep}}l<{\hspace{-\tabcolsep}}
>{\hspace{-\tabcolsep}\enspace}
lll}
\lsptoprule
\tbx{11-00}	&	PMP	&	Teor	& local gl.	\\	\midrule
...
Kur has *ə/*a/*-ay > \it{a}.
Teor has *ə/*a/*-ay > ‹a› in most cases,
but *ə/*a > ‹a›, ‹e› /iC{\gap}{\#}.
Thus, Teor *ma-qit\tbr{ə}m > ‹mit\tbr{e}n› ‘black’ is consistent
with *siw\tbr{a} > ‹siw\tbr{e}› ‘nine’,
*qasiR\tbr{a} > ‹sir\tbr{e}n› ‘salt’,
and *miñ\tbr{a}k > ‹min\tbr{e}k› ‘sweet’
and we can tentatively posit that *ə
and *a merged in final syllables in Teor.

Kur is an important witness in the region as it is the only language
which retains *p unchanged in all positions.
Teor, like other languages of the region,
has lenition of *p > ‹f›.
...
llll}
\lsptoprule
%\tbx{11-9}	&	PMP	&	Teor	&	Kur	&	local gl.	\\	\midrule
%\endfirsthead
\tbx{11-09}	&	PMP	&	Teor	&	Kur	&	local gl.	\\	\midrule
%\endhead
...
Teor and Kur have *j > {\0} in all reflexes which have been identified,
with the exception of reflexes of *pajay ‘rice’.\footnote{
		Teor data provided by Craig Marshall has medial *j > \it{l}
		in all reflexes except those of *qaləjaw.}
The retention of *p = \it{p} in Teor indicates that this term
is a loan from another language.
Examples of *j in the available data are given in \qf{11-10}.
%*j > {\0} may be a defining change of \tsc{Teor-Kur} setting
...
llll}
\lsptoprule
%\tbx{11-10}	&	PMP	&	Teor	&	Kur	&	local gl.	\\	\midrule
%\endfirsthead
\tbx{11-10}	&	PMP	&	Teor	&	Kur	&	local gl.	\\	\midrule
%\endhead
...
PMP *s undergoes a split in Teor and Kur.
Teor has *s = \it{s} in two reflexes,
with one other potential reflex showing *s > {\0}.
Kur has *s > \it{s, h}.
Examples are given in \qf{11-11}.\footnote{
		Another potential
		reflex of *s in Kur is *asu > ‹yaa› \citep[33]{Rado2021},
		...
		‹yaa› is probably [yaʔa] which can be compared with Kei
		\it{yaha} and Fordata \it{yahaw} ‘dog’ reflecting intermediate **yasaw,
...
llll}
\lsptoprule
%\tbx{11-11}	&	PMP	&	Teor	&	Kur	&	local gl.	&		\\	\midrule
%\endfirsthead
\tbx{11-11}	&	PMP	&	Teor	&	Kur	&	local gl.		\\	\midrule
%\endhead
...
lllll}
\lsptoprule
%\tbx{11-12}	&	PMP	&	Teor	&	Kur	&	Kur \citep{vonRosenberg1867}	&	local gl.	\\	\midrule
%\endfirsthead
\tbx{11-12}	&	PMP	&	Teor	&	Kur	&	Kur	&	local gl.	\\ \hhline{~}
...
llll}
\lsptoprule
%\tbx{11-13}	&	PMP	&	Teor	&	Kur	&	local gl.	\\	\midrule
%\endfirsthead
\tbx{11-13}	&	PMP	&	Teor	&	Kur	&	local gl.	\\	\midrule
%\endhead
...
The change is confirmed by Kur \it{li\tbr{ŋ}ain}, Teor ‹la\tbr{g}ain›
‘path, way’, as well as \citet[84]{Hughes1987} who states; “Also,
velar nasals in Kur become voiced velar plosives in Ut [Teor].”
The change *ŋ > \it{g} is regionally common and also occurs
in nearby Kowiai (\srf{11-03-02} and \tsc{East Bomberai} (\srf{11-05-02}).
Denasalisation (*ŋ > \it{k} /V{\gap}V) also occurs in \tsc{East Seram} (\srf{11-02}).

\citet[84]{Hughes1987} also observes one difference between Kur
and his Teor data (collected from Ut village in the Kei Islands):
“There are some consistent phonetic changes between Kur
and Ut, particularly the palatalisation in Ut of word-final alveolar
nasals, laterals and voiceless alveolar plosives in Kur.” Such palatalisation
is not observed in the Teor data in \citet{Wallace1869}
