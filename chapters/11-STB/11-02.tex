...
Seram, minimally Bobot and Masiwang.
Salas may also belong in this node,
but no available data is available to be sure (\srf{07-05}).
\citet{LoskiLoski1989} link it
with \tsc{Ambon-Seram} languages to its west.

Following \citet{Collins1986}, the main change which unites Bobot
and Masiwang is medial *-ŋ- > \it{k}.
...
However, the modern reflexes (Bobot *R > \it{w}, {\0}; Masiwang
...
clearly set these languages apart from \tsc{Ambon-Seram}.
\citet{Collins1986} also includes \tsc{Seti} within \tsc{East Seram},
but we place it within \tsc{Ambon-Seram} (\srf{10-03-04}) on
the basis of  *ŋ > \it{n},\footnote{
		...
		in \tsc{Seti} is attributable to contact with neighbouring Bobot.
...
“East Rivers”, for Bobot and Masiwang.
However, under our classification this node is not necessary
as Bobot and Masiwang are the only languages
...
Masiwang *naŋuy > \it{ke-nani} ‘swim’ has irregular medial *-ŋ- > \it{n}.
...
Kowiai (\tsc{Eastern Islands}) has *ŋ > \it{g, ŋg} (\srf{11-03-02}),
...
Bobot	&	-\tbr{n}alan	&	{\hr}\tbr{n}aa	&	{\hr}na\tbr{k}u̥	&	{\hr}ya\tbr{k}in	&	{\hr}blo\tbr{k}a	&	{\hr}tali\tbr{k}a-n	&	{\hr}la\tbr{k}it	&	{\hr}ta\tbr{k}it	&	{\hr}ai ya\tbr{k}an\\
Masiwang	&	{\hr}\tbr{n}ala-n	&	{\hr}\tbr{n}alaʔ	&	{\hr}ke-na\tbr{n}i	&	{\hr}ta\tbr{k}in	&	{\hr}lo\tbr{k}a	&	{\hr}tali\tbr{k}a-n	&	{\hr}la\tbr{k}it	&	{\hr}ra\tbr{k}it	&	{\hr}sak{\tl}sa\tbr{k}an\\
Geser	&	{\hr}ŋasan	&	{\hr}ŋarak	&	{\hr}naŋu	&	{\hr}aŋin	&	{\hr}roŋan	&	{\hr}tiliŋa	&	{\hr}laŋit	&	\cg{(sela)}	&	{\hr}saŋ\\
Yamdena	&	{\hr}ŋara-ny	&	{\hr}ŋarak	&	\cg{(n-luri)}	&	\cg{(mnaur)}	&	{\hr}-deŋar	&	{\hr}tliŋa-ny	&	{\hr}laŋit	&	{\hr}-tasiŋ	&	{\hr}saŋa-ny\\
Kei	&	\cg{(mema-)}	&	\cg{(taun)}	&	{\hr}snaŋ	&	\cg{(niet)}	&	{\hr}denar	&	\cg{(aru-n)}	&	{\hr}lan	&	{\hr}tnanit	&	{\hr}haŋa\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†] {Compare Buru \it{ŋahe-t},
								Asilulu \it{nale}, East Kola \it{nahak},
								Southwest Tarangan \it{narak}
								all ‘year’.}
		\end{tablenotes}
	\end{threeparttable}
\end{adjustbox}
...
%Bobot	&	-\tbr{n}alan	&	{\hr\hr}\tbr{n}aa	&	{\hr}na\tbr{k}u̥	&	{\hr}ya\tbr{k}in	&	{\hr}a-vlo\tbr{k}a	\\
%Masiwang	&	{\hr}\tbr{n}ala-n	&	{\hr\hr}\tbr{n}alaʔ	&	{\hr}ke-na\tbr{n}i	&	{\hr}ta\tbr{k}in	&	{\hr}lo\tbr{k}a	\\	\midrule
%Geser	&	{\hr}ŋasan	&	{\hr\hr}ŋarak	&	{\hr}naŋu	&	{\hr}aŋin	&	{\hr}roŋan	\\
%Yamdena	&	{\hr}ŋara-ny	&	{\hr\hr}ŋarak	&	\cg{(n-luri)}	&	\cg{(mnaur)}	&	{\hr}-deŋar	\\
%Kei	&	\cg{(mema-)}	&	\hr\cg{(taun)}	&	{\hr}snaŋ	&	\cg{(niet)}	&	{\hr}denar	\\
		%\midrule\midrule
	%\end{tabular}}
	%{\st{6pt}
	%\begin{tabular}{lllll}
...
%Bobot	&	{\hr}tali\tbr{k}a-n	&	{\hr}la\tbr{k}it	&	{\hr}ta\tbr{k}it	&	{\hr}ai ya\tbr{k}an\\
%Masiwang	&	{\hr}tali\tbr{k}a-n	&	{\hr}la\tbr{k}it	&	{\hr}ra\tbr{k}it	&	{\hr}sak{\tl}sa\tbr{k}an\\	\midrule
%Geser	&	{\hr}tiliŋa	&	{\hr}laŋit	&	\cg{(sela)}	&	{\hr}saŋ\\
%Yamdena	&	{\hr}tliŋa-ny	&	{\hr}laŋit	&	{\hr}-tasiŋ	&	{\hr}saŋa-ny\\
%Kei	&	\cg{(aru-n)}	&	{\hr}lan	&	{\hr}tnanit	&	{\hr}haŋa\\
		%\lspbottomrule
	%\end{tabular}}
		%\begin{tablenotes}\tnsize
			%\item[†] {Compare Buru \it{ŋahet},
								%Asilulu \it{nale}, East Kola \it{nahak},
								%Southwest Tarangan \it{narak}
								%all ‘year’.}
		%\end{tablenotes}
...
Bobot	&	{\hr}uma	&	{\hr}la\tbr{w}a	&	{\hr}wa\tbr{w}at	&	{\hr}-luin	&	{\hr}vo{\tl}voi	&		&	\\
Masiwang	&	{\hr}\tbr{s}uma	&	{\hr}la\tbr{s}a	&	{\hr}wa\tbr{s}at	&	{\hr}lu\tbr{s}i-n	&	{\hr}hosi{\tl}ho\tbr{s}in	&	{\hr}me\tbr{s}anem	&	{\hr}ka\tbr{s}at\\	\midrule
Geser	&	{\hr}ruma	&	{\hr}rara	&	\cg{(tali)}	&	{\hr}ruri	&	{\hr}wou{\tl}wou	&	{\hr}urana	&	{\hr}karat\\
Yamdena	&	\cg{(rahan)}	&	{\hr}dara-ny	&	{\hr}waras	&	{\hr}duri	&	{\hr}be{\tl}bery	&	{\hr}merwan-e	&	{\hr}n-karat\\
Kei	&	\cg{(raha)}	&	{\hr}lar	&	{\hr}warat	&	{\hr}luri	&	{\hr}virun	&	{\hr}bran	&	\cg{(kik)}\\
		\lspbottomrule
	\end{tabular}
\end{adjustbox}
\end{table}
...
This is different from all \tsc{Ambon-Seram} languages (except
...
The merger of *l/*j also occurs in Banda (\srf{12-02}).
...
irregular reflexes of *l in the available data: *\tbr{l}ima > Bobot
\it{-\tbr{n}iman} ‘arm’, *qu\tbr{l}əj > Bobot \it{u\tbr{r}at} ‘worm’,
*kali > Masiwang \it{kai\tbr{s}} ‘dig’ (with final CV > VC metathesis),
and *ku\tbr{l}it > Bobot \it{-ku\tbr{r}it}, Masiwang \it{u\tbr{h}it} ‘skin’.
There is also one possible case of *j > \it{n}; Masiwang *ŋi\tbr{j}uŋ
> \it{ni\tbr{n}in}, as well as one possible case of *j > {\0} in *qalejaw > Bobot
\it{lia matan} ‘sun’ (Masiwang \it{fulan} ‘sun’),
though the regularity of *j > {\0} in this word in \tsc{Ambon-Seram}
...
Bobot	&	{\hr}fi\tbr{l}a	&	-na\tbr{l}an	&	{\hr}ma-ma\tbr{l}a	&	{\hr}-i\tbr{l}in	&	{\hr}wa\tbr{l}i-n	&	{\hr}fo\tbr{l}i\\
Masiwang	&	{\hr}hi\tbr{l}a	&	{\hr}na\tbr{l}a-n	&	{\hr}mo-ma\tbr{l}a	&	{\hr}ni\tbr{n}in	&	{\hr}wa\tbr{l}i(-n)	&	{\hr}ho\tbr{l}i\\	\midrule
Geser	&	{\hr}fis	&	{\hr}ŋasan	&	{\hr}kirimas	&	{\hr}so	&	{\hr}ali	&	{\hr}foli\\
Yamdena	&	{\hr}fir	&	{\hr}ŋara-ny	&	\cg{(-ŋretw)}	&	{\hr}iri-ŋw	&	{\hr}wai-ny	&	{\hr}feru\\
Onin	&	{\hr}firas	&	{\hr}gara-r	&	\cg{(atetar)}	&	{\hr}iri-r	&	{\hr}wari-r	&	{\hr}marik\\
		\lspbottomrule
	\end{tabular}
\end{table}
...
Bobot	&	{\hr}vu\tbr{l}an	&	{\hr}ba\tbr{l}íʔ	&	{\hr}to\tbr{l}(u̥)	&	-u\tbr{l}in katin	&	{\hr}to\tbr{l}in	\\
Masiwang	&	{\hr}hu\tbr{l}an	&	{\hr}m\tbr{l}i	&	{\hr}ain-to\tbr{l}i	&	{\hr}u\tbr{l}in	&	{\hr}to\tbr{l}in	\\	\midrule
Geser	&	{\hr}ulan	&	{\hr}malif	&	{\hr}tolu	&	{\hr}lu	&	{\hr}tolu	\\
Yamdena	&	{\hr}bulan	&	{\hr}n-malip	&	{\hr}tel	&	{\hr}ulu	&	\cg{(batin)}	\\
Onin	&	{\hr}punan	&	{\hr}a-manif	&	{\hr}teni	&	{\hr}unin	&	\cg{(patin)}	\\
		\lspbottomrule
	\end{tabular}
\end{table}
...
In final open syllables Masiwang usually has *u/*i > \it{i,}
while Bobot has reduction of *u/*i.
In the Atiahu dialect of Bobot the usual change is *u > {\0}
...
and also occurs in \tsc{Seti} and Bati.
Similarly, the change of final *u > \it{i} occurs in nearby
\tsc{Bomberai Tip} as well as Yamdena.\footnote{
		Final *u > \it{i} also occurs
		in Wetan and \tsc{Babar} (\tsc{Southwest Maluku}, \tsc{Timor-Babar}; \srf{04-06}).}
...
“Bobot (We.)” is from the Werinama dialect of Bobot
and “Bobot (At.)” is from the Atiahu dialect.
Atiahu Bobot data is from \citet{Wallace1869},
...
local gl.	&	breast	&	head	&	fear	&	egg	&	louse	&	feather	&	mouth	&	sea\\
PMP	&	*sus\tbr{u}	&	*qul\tbr{u}	&	*tak\tbr{u}t	&	*qatəl\tbr{u}R	&	*kut\tbr{u}	&	*bul\tbr{u}	&	*bib\tbr{i}R	&	*tas\tbr{i}k\\	\midrule
Bobot (We.)	&	-sus\tbr{i}n	&	-ul\tbr{i}n katin	&	{\hr}mta\tbr{i}t	&	{\hr}tol\tbr{i}n	&	{\hr}kut\tbr{i}n	&	{\hr}vul\tbr{i}n	&	{\hr}viv\tbr{i}n	&	{\hr}tas\tbr{i}\\
Bobot (At.)	&		&	‹yúl\tbr{i}n›	&		&	‹tól\tbr{i}n›	&	‹ut\tbr{u}›	&	‹ful\tbr{i}n›	&	\cg{(‹vudin›)}	&	‹tás\tbr{i}›\\
Masiwang	&	{\hr}sus\tbr{i}n	&	{\hr}ul\tbr{i}n	&	{\hr}kato\tbr{i}t	&	{\hr}tol\tbr{i}n	&	{\hr}taniman	&	{\hr}hul{\tl}hul\tbr{i}n	&	\cg{(uban)}	&	{\hr}tas\tbr{i}ʔ\\
		\lspbottomrule
	\end{tabular}
\end{adjustbox}
\end{table}
...
Bobot (We.)	&	{\hr}vatu̥	&	{\hr}yasu̥	&	{\hr}dutu̥	&	{\hr}dun	&	{\hr}vun(V̥)	&	{\hr}yafV̥	&	{\hr}ninV̥	&	{\hr}babutu̥	&	{\hr}kalV̥\\
Bobot (At.)	&	{\hr}hat	&	‹yás›	&		&		&		&	‹yaf›	&		&	‹babút›	&	\\
Masiwang	&	{\hr}hat\tbr{i}	&	{\hr}ya\tbr{i}	&	{\hr}tut\tbr{i}	&	{\hr}tu\tbr{i}n	&	{\hr}hu\tbr{i}n	&	{\hr}yah	&	{\hr}nim\tbr{i}n	&	{\hr}but\tbr{i}	&	{\hr}ka\tbr{i}s\\
		\lspbottomrule
	\end{tabular}
\end{adjustbox}
\end{table}
