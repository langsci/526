...
There have been differing views about the classification of Kowiai,
sometimes by the same scholars.
For example, \citet[272]{Blust1993} says,
“Koiwai appears to be a CMP language,
but it is not closely related to the Onin-Sekar-Uruangnirin group,
and its wider connections within CMP remain obscure.” Yet \citet{BlustTrussel2020}
assign Kowiai under SHWNG.

\citet[80]{WalkerR1982} and \citet[22]{WalkerWalker1991} note
that the king’s family in Kowiai traces its origins to the Gorom
region off of eastern Seram;
and that Geser-Gorom is the closest language to Kowiai,
based on lexical similarity
(\citealp[84, 93]{WalkerR1982}, \citealp[120--122]{WalkerWalker1991}).

Looking at historical phonology
and the lexicon, \citet{Zobel2014} also proposed that Kowiai’s
“closest relative” is Geser
and then Watubela, and presents data to support his claim.
...
Geser	&	ruk	&	taŋgi	&	barem	&	tei	&	fakaleus	&	abotan\\
Gorom	&	du	&	tagi	&	barem	&	tei	&	haleus	&	kiribotan\\
Watubela	&	lunam	&		&		&	teiʔ	&		&	kabetan\\
Kowiai	&	ruʔ	&	na-taŋ	&	barem	&	tei	&	na-ɸaraʔeus	&	abotan\\
		\lspbottomrule
	\end{tabular}
\end{table}
...
Kowiai shares both of the main phonological innovations that
...
language, Kowiai also shares a number of innovations with neighbouring
...
which is shared with Uruangnirin (\tsc{Bomberai Tip}, \srf{11-05-01}).
Nearby Teor also has *ŋ > \it{g} (\srf{11-04}).
...
\lsptoprule
%\tbx{00-2}	&	PMP	&	Kowiai	&	local gl.	\\	\midrule
%\endfirsthead
\tbx{11-02}	&	PMP	&	Kowiai	&	local gl.	\\	\midrule
%\endhead
	...
	&	*təri\tbr{ŋ}	&	tiri\tbr{n}	&	bamboo species (Malay `bambu Jawa')	\\
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{00-3}	&	PMP	&	Intermediate forms	&	Kowiai	&	local gl.	\\	\midrule
%\endfirsthead
\tbx{11-03}	&	PMP	&	\mc{2}{l}{Intermediate forms}	&	Kowiai	&	local gl.	\\	\midrule
%\endhead
