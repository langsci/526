...
meaning east of the Blust line to add ‘same sex sibling’.
Consequently one or two ‘opposite sex sibling’ terms appear sporadically
in several subgroups east of the Blust line.
...
%\mc{5}{c}{\tsc{Taliabu}}\\
\midrule
Taliabu	&		&		&	{\hr}foto	&	{\hr}naha\\
Soboyo	&	{\hr}kaka	&	{\hr}uli	&	{\hr}foto	&	{\hr}naha\\
Kadai	&	{\hr}kaka	&	{\hr}uli	&	{\hr}foto	&	{\hr}naha\\
%\midrule
%\mc{5}{c}{\tsc{Sula-Buru}}\\
\midrule
Mangole	&		&		&	{\hr}feta	&	{\hr}nai,\su{†} \cg{(sanasi)}\\
Sanana	&	{\hr}kàk	&		&	{\hr}feta	&	{\hr}nai,\su{†} \cg{(sanohi)}\\
Lisela	&	{\hr}kaka	&	{\hr}wai	&	{\hr}feta	&	{\hr}naha-t\\
Buru	&	{\hr}kai	&	{\hr}wai	&	{\hr}feta	&	{\hr}naha, naha-t\\
Ambelau	&	{\hr}ʔai-o	&	{\hr}βai-no	&	{\hr}bera	&	{\hr}naha-ni\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†] {
							Final \it{i{\#}} in Mangole
							and Sanana is unexplained,
...
and \tsc{Taliabu} languages, \tsc{Ambon-Seram} languages (\crf{ch:AS})
...
of who is speaking.
Alune has further reduced to a 2-term set
with `opposite sex sibling' vs. `same sex sibling'.
Languages of the \tsc{Piru Bay} branch have innovated a new word
**leku “opposite sex sibling”.
These are illustrated in \trf{07-04}.

\begin{table}[p]\centering\tcp{Three-term sibling sets in \tsc{Ambon-Seram} languages}{07-04}
...
Manipa	&	{\hr}haha	&		&	\\
Kelang	&	{\hr}haha	&		&	\\
Luhu	&	{\hr}kaka (< Mly.)\su{†}	&	{\hr}wali	&&	{\hr\hr}leu {}\\
Piru	&		&	{\hr}wali	&&	{\hr\hr}leu {}\\
Larike	&	{\hr}aʔa	&	{\hr}wale	&&	{\hr\hr}leko {}\\
Asilulu	&	{\hr}ʔaʔa-ni	&	{\hr}wali-mu	&&	{\hr\hr}leku {}\\
Paulohi	&	{\hr}waʔa	&	{\hr}waʀi\su{Δ}	&&	{\hr\hr}leʔu {}\\
Amahai	&	‹wa›	&	\hp{*w}ari	&&	{\hr\hr}reu {}\\
Kaibobo	&	{\hr}waʔa {\tl} aʔa	&	\hp{*w}ari	&&	{\hr}‹leu›\su{‖} {}\\
Waisamu	&	{\hr}waʔa	&	\hp{*w}ari	&&	{\hr}‹leu›\su{‖} {}\\
Kamarian	&	{\hr}waʔa	&	{\hr}wari	&&	{\hr}‹reu›\su{‖} {}\\
Tihulale	&	{\hr}waʔa	&	{\hr}wari	&&	{\hr}‹leu›\su{‖} {}\\
Rumakai	&	{\hr}waʔa	&	{\hr}wari	&&	{\hr}‹reu›\su{‖} {}\\
Haruku (Karu)	&	{\hr}waʔa	&	{\hr}wari	&&	{\hr}‹reu›\su{‖} {}\\
Haruku (Pelauw)	&	\cg{(laha-nu)}	&	{\hr}wari	&&	{\hr}‹leu›\su{‖} {}\\
Haruku\su{‡}	&	{\hr}waʔa	&	{\hr}wari	&&	{\hr\hr}reʔu {}\\
Saparua (Hatawano)	&	{\hr}waʔa	&	{\hr}wari	&&	 \\
Saparua	&	\cg{(u-wau)}	&	{\hr}wari-u	&&	{\hr\hr}u-leu {}\\
Nusalaut (Nalahia)	&	{\hr}waʔa	&		&&	 \\
Nusalaut	&	\cg{(waow)}	&	{\hr}wari	&&	{\hr}‹leu›\su{‖} {}\\
N. Alune	&		&	{\hr}kwali	&	{\hr}beta-i&\\
W. Alune	&		&		&	{\hr}weta, &{\hr}‹deu›\su{‖} {}\\
Yalahatan	&	{\hr}ʔaʔa-i	&	{\hr}wali-n	&	{\hr}heta-i&\\
Atamanu	&	{\hr}aʔa	&	{\hr}wali	&	{\hr}feta&\\
S. Nuaulu	&	{\hr}kaka-i	&	{\hr}wani-ni	&	{\hr}hota-i&\\
N. Nuaulu	&	{\hr}kaka-i	&	{\hr}wani-n	&	{\hr}fota-i&\\
Manusela	&		&		&	{\hr}hota-mu\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†]	{The expected Luhu reflex with glottal is found in the compound
								\it{wali-ʔaʔa} ‘same generation relatives’ \citep[145, note 112]{Collins1983}.}
			\item[‡]	{Haruku alternate data from \citet[137--151, {[}list 23{]}]{Stokhof1982a}.}
			\item[Δ]	{Paulohi ‹r› is explicitly described as uvular
...
Note that Alune has reduced to a 2-term set: \it{kwali} ‘same
sex sibling’ and \it{beta{\nbhyp}i} ‘opposite sex sibling’.
As with many languages in central Maluku,
...
So Alune \it{kwali mena} ‘older (in front) same sex sibling’
