...
nodes or languages in the \tsc{Bima-Lembata},
\tsc{Timor-Babar}, \tsc{Aru}, and \tsc{Seram-Tanimbar-Bomberai}
subgroups, it is worth noting that this particular merger affects
all nodes of \tsc{Sula-Buru}, \tsc{Ambon-Seram}, and \tsc{Seram-Tanimbar-Bomberai}.

Similarly, nearly all languages have *-aw > \it{a},
but several languages of the \tsc{Northwest Seram} node of \tsc{Ambon-Seram}
retain *aw unchanged or have *aw > \it{akw} (see \srf{10-02}),
preventing us from assigning *-aw > \it{a} to Proto-Ambon-Seram.
...
While Banda does have *-ay/*-aw > \it{a},
...
That is, *-ay/*-aw > \it{a} in Banda is due to parallel development.
...
ancestor of Banda and any of the other subgroups in the region.
This is part of the basis for treating Banda as an isolate.
...
and \tsc{Ambon-Seram} subgroups, indicating that the distinction
