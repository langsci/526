...
and \tsc{Ambon-Seram} as separate subgroups with distinct phonological
histories.
...
\begin{enumerate}
	\item	*-ay and *-aw
		\begin{itemize}[topsep=0pt,leftmargin=\dimexpr 15pt-6pt]	
			...
			\item	\tsc{Ambon-Seram} has *-ay > \it{a} but retains *-aw = **-aw
						in certain lexical items in Alune and related languages.
						See discussion and data in \srf{10-02}.
			\item	Banda has *-ay/*-aw > \it{a,} but final *a shows alternations
						of \it{a {\tl} o} which are not attested with reflexes of *-ay/*-aw,
						indicating that we cannot posit straightforward merger of *-ay/*-aw/*-a in Banda.
						See  discussion
	...
	\item	*mb, *mp, *ma-p
		\begin{itemize}[topsep=0pt,leftmargin=\dimexpr 15pt-6pt]
			\item	\tsc{Sula-Buru} merges *-mp-/*-mb-/*ma-p/*ma-b > **mb,
						...
						and *p = **p.
			\item	Nearly all \tsc{Ambon-Seram} languages merge *-mp-/*-mb- > **mp (devoiced).
						Data from many languages indicates that *ma-p
						and *ma-b must be kept distinct
						and fully reconstructed for \tsc{Ambon-Seram}.
			...
			\item	Banda merges *mb/*mp/*ma-p > \it{mb} retaining the cluster
	...
	\item	*n/*ñ/*ŋ
		\begin{itemize}[topsep=0pt,leftmargin=\dimexpr 15pt-6pt]
			...
			\item	\tsc{Ambon-Seram}
						and Banda merge *n/*ñ/*ŋ > \it{n} in all positions.
			\item	\tsc{Seram-Tanimbar-Bomberai} reflexes of *ŋ are diverse including:
						\it{ŋ, g, k, ŋg} and \it{n}.
						Notably, \tsc{East Seram} languages (those closest to \tsc{Ambon-Seram})
						have medial *ŋ > \it{k}
						and thus do not pattern with \tsc{Ambon-Seram} with respect to the nasals.
		\end{itemize}
	\item	*k
		\begin{itemize}[topsep=0pt,leftmargin=\dimexpr 15pt-6pt]
			...
			\item	\tsc{Ambon-Seram} sporadically retain a weakened *k > **k (>
			...
			\item	All branches of \tsc{Seram-Tanimbar-Bomberai} preserve *k =
						\it{k} in at least some words.
						Notably, languages from several branches also have word-final *k = \it{k}.
			\item	Banda preserves *k = \it{k} in all word positions in all identified reflexes.
		\end{itemize}
	\item	*q/*h
		\begin{itemize}[topsep=0pt,leftmargin=\dimexpr 15pt-6pt]
			\item	\tsc{Sula-Buru}
						and Banda have *q/*h > {\0} in all positions.
			\item	\tsc{Ambon-Seram} languages appear to retain conditioned and/or
						lexically specific traces of *q
						and *h in Kamarian,
						Alune and related languages (Naka{\Q}ela,
						Watui and Lisabata) along with possible traces in others
			...
			\item	Most \tsc{Seram-Tanimbar-Bomberai} languages have *q/*h > {\0},
						but Watubela has *q > \it{k} in all positions (\srf{11-03-01}).
		\end{itemize}
	\item	*ə
		\begin{itemize}[topsep=0pt,leftmargin=\dimexpr 15pt-6pt]
			\item	\tsc{Sula-Buru} *ə > \it{e} in both penultimate
						and ultimate syllables (contrasting with \tsc{Taliabu} *ə > \it{o}),
			\item	\tsc{Ambon-Seram} languages preserved *ə = **ə with subsequent
						**ə > \it{e, o, i} in complex ways.
						...
						for subgrouping \tsc{Piru Bay} languages.
			...
			\item	Banda has penultimate *ə > \it{e}
						and a split of final *ə > \it{o,
						e} as conditioned by the penultimate vowel.
						The reflexes of *ə
						and *a in final syllables are distinct in Banda,
						thus distinguishing Banda from \tsc{Seram-Tanimbar-Bomberai}.
						See discussion and data in \srf{12-05}.
			\item[] \hp{\,}
		\end{itemize}
	\item	*z
		\begin{itemize}[topsep=0pt,leftmargin=\dimexpr 15pt-6pt]
			\item	\tsc{Nuclear Sula-Buru} merge *y/*z > **y (> {\0} in Buru
						and Lisela is a secondary development).
						Ambelau has a split of *z > \it{l, h}.
			\item	\tsc{Ambon-Seram},
						\tsc{Seram-Tanimbar-Bomberai}, and Banda merge *d/*z,
						with **d the likely outcome in \tsc{Seram-Tanimbar-Bomberai},
						but **r in \tsc{Ambon-Seram} and Banda.
						\tsc{Ambon-Seram} has **r/*l > **l in many branches.
						See \srf{07-03-03} above, as well as \srf{10-01} and \srf{10-02}.
		\end{itemize}
	\item	*R/*l
		\begin{itemize}[topsep=0pt,leftmargin=\dimexpr 15pt-6pt]
			\item	\tsc{Ambon-Seram} mostly merged *R/*l > **l,
						with complications in Boano
						and Hoti meaning that a full merger cannot be posited for those languages.
			\item	In \tsc{Sula-Buru} the distinction is clearly retained with
						*R > \it{h}, *l = \it{l}.
			\item	\tsc{Seram-Tanimbar-Bomberai}
						and Banda also retain the distinction (\srf{07-04-01-02}).
		\end{itemize}
	\item	Apicals: *d/*z/*R/*l/*j
		\begin{itemize}[topsep=0pt,leftmargin=\dimexpr 15pt-6pt]
			...
			\item	\tsc{Ambon-Seram} gives the appearance of merging *d/*z/*R/*l/*j
...
and Collins are both right about the merger of PMP apicals in \tsc{Ambon-Seram}.
All 30 \tsc{Ambon-Seram} languages for which we have data have
...
and quite widespread in \tsc{Ambon-Seram} languages,
...
sound correspondences are at the two extremes of \tsc{Ambon-Seram},
with Boano in the west (\srf{10-03-01})
and the \tsc{Patakai-Manusela} branch in the east (\srf{10-03-03}) being stand-outs.
Sporadic exceptions are also distributed throughout
\tsc{Ambon-Seram} (see \tsc{Atamanu} \srf{10-03-02}).
...
the same words (except Kayeli).
We also see parallel development: e.g.
Sanana (\tsc{Sula-Buru}) and South Wemale (\tsc{Ambon-Seram})
...
\tsc{Taliabu}, South Nuaulu, Liana-Seti) reflexes of *-əj{\#}
...
are found in \tsc{Ambon-Seram} languages with PMP *d, *z, *R, *l.
The subtle differences retained in reflexes of *d,
*z, *R, *l, and *j in four branches of \tsc{Ambon-Seram} are
