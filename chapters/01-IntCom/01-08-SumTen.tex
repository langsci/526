...
and Timor-Leste require reconstructing a proto language that is very close to PMP\footnote{
		...
		various time-depths show clearly that Proto-Central-Eastern Malayo-Polynesian
...
\begin{itemize}
	...
	\begin{itemize}
			\item Examples of the postnasal voicing of stops
						would be PMP *ma-putiq > Buru (\tsc{Sula-Buru}) \it{boti} ‘white’,
						*ma-panas ‘hot’ > Buru \it{bana} ‘fire’.
			\item But we also note the presence of
						other patterns in the region,
						such as where the nasal is retained
						and the stop is lost, as in several Meto
			...
			\item Or the vowel is lost from the historical prefix,
						such as in Kambera (\tsc{Bima-Lembata}) *ma-panas > \it{mbanah-u} ‘hot’.
			\item Or the nasal and labial merge but stay voiceless,
						...
						This is also common in \tsc{Ambon-Seram}
						languages of central Maluku.
			\item In some cases *ma-p is retained in full
						with no reduction and no voicing,
						such as Yamdena \it{mafuti} ‘white’
						and \it{mefanas} ‘hot’, or Geser-Gorom \it{mafuti} ‘white’
						and \it{mahanas} ‘hot’
...
\item There is a tendency in the morphosyntax to have subject marking prefixes on some verbs;
			...
			We note that the subject prefixes of \tsc{Ambon-Seram} languages are also not cognate with the subject
...
\item The preposed possessor construction introduced in \srf{01-05}
			...
			Havu, Dhao, nor in languages of western Flores.
...
\item The sporadic presence of reflexes of {\#}muku ‘banana’\footnote{
				...
				is a pseudo-etymon, and has reflexes in at least two unrelated language families.
			...
			Aru and slightly further north to the Bomberai Peninsula,
...
Many Austronesian languages east of the Blust line display a number of features not found in languages
west of the line,
...
travelling from west to east we should be thinking about entering a zone of transition
