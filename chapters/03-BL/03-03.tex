...
\citet{Klamer1998a}, on Kambera, is the one full modern grammar available.
Two other modern linguistic descriptions have appeared in recent
years: \citet{GhanggoAte2018} describes reduplication in Kodi,
and \citet{Verdizade2019a} describes the phonology
and aspects of the morphosyntax of Laboya.
...
\citet{Grimes2010a} shows that while Havu
and Dhao are relatively close in their lexicons
and historical phonologies, they are significantly different
in their syntax and typology.
Both Havu and Dhao have six-vowel systems,
...
Dhao has an extra grade of obstruents not found in Havu.
Havu uses a template-inserted /e/ as its antepenultimate vowel,
whereas Dhao uses /a/.
In both languages, V-initial verb roots are inflected for person and number.
Havu is VSO and ergative marked.
Dhao is SVO and basically nominative-accusative, probably due
...
Speakers of the five dialects of Havu on the Sabu mainland claim
to understand each other,
but often with difficulty.
We separate Raijua as a separate language,
based on different ergative markers (Raijua \it{la},
versus Seba \it{ri}, and Dimu \it{ro/rovi}),
...
\tsc{Havu-Dhao} listed in \citet{Grimes2010a}.