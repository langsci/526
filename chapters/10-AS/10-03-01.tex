\sscp{Boano}{10-03-01}
Boano is spoken on a small island of the same name in the Manipa
Straits off the northwest coast of Seram.
Many Boano speakers were forcibly relocated by the Dutch to Manipa
Island in the mid 1600s at the end of the Hoamoal wars,
in efforts to gain a monopoly on the spice trade.

\citet{Stresemann1927} included Manipa, Kelang,
and Boano within his Sub-Ambon branch of Proto-Ambon.
\citeauthor{Stresemann1927}’s approach to the apical consonants for his Sub-Ambon
...
\citet{Collins1983} includes Boano within the \tsc{Piru Bay}
branch of his “Nunusaku”,
with its nearest relatives being Wakasihu, Alang, and Larike.
...
the phonological prehistory of our \tsc{Ambon-Seram} subgroup.
...
Boano belongs with \tsc{Ambon-Seram} on the basis of the merger
...
\citet[69--73]{Collins1983} groups Boano with Larike
and Wakasihu, two languages now relocated to the western end of Ambon Island.
Example \qf{10-25} shows *ai/*a(C)i > \it{e},
with the exception of \it{tai-a} ‘faeces’ which could be influenced
from the local Malay \it{tai},
...
%\endhead
	&	*kahiw	&	\tbr{e}-niʔi	&	tree, wood 	&	Proto-AS **kai > **ke, cf. Manipa \it{hen}	\\
	&	*wahiyəR	&	en-eʔe	&	water 	&	**wain > **wen > \it{en} [*R > \it{n}]; cf. Manipa \it{wel-e}	\\
	&	*qaqay, *waqay	&	\tbr{ee}	&	foot, leg 	&	cf. Manipa \it{ai}, Wakasihu \it{wei}	\\
	&	**saqi	&	s\tbr{e}-ʔe	&	paddle 	&	cf. Manipa \it{sai}, Wakasihu \it{sei}	\\
...
Manipa	&	-lau	&	{\hr}hon	&	{\hr}au	&	{\hr}au	&	{\hr\hr}u-kon-e	&	{\hr\hr}ro-	\\
Wakasihu	&	{\hr}lou	&	{\hr}hou	&	{\hr}owo	&	{\hr}ao-o	&	{\hr\hr}toun-a	&	{\hr\hr}ro-ʔu	\\
Asilulu	&	{\hr}lau	&	{\hr}hau-ni	&		&	{\hr}au	&		&		\\
Kelang	&		&		&		&		&	{\hr\hr}taun-a	&	{\hr\hr}rau	\\
Luhu	&		&		&	{\hr}au	&	{\hr}au	&	{\hr\hr}taun-a	&	{\hr\hr}rau	\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†] {Possibly from *taqun `year'. cf. Buru \it{taun} `full'. Manipa has *t > \it{k}.}
			\item[‡] {cf. Buru \it{dawe} `brother-in-law (m. s.)' }
		\end{tablenotes}
	\end{threeparttable}
%\end{adjustbox}
\end{table}
...
%\tbx{10-26}	&	PMP/PCM	&	Boano	&	gloss	&	compare	\\	\midrule
%%\endhead
	%&	*zauq	&	-l\tbr{ou}	&	far	&	Manipa \it{-lau}, Wakasihu \it{lou}, Asilulu \it{lau}	\\
	%&	*bahu	&	h\tbr{o}-ni	&	odour	&	Manipa \it{hon}, Wakasihu \it{hou}, Asilulu \it{hau-ni}	\\
	%&	*pahuq	&	\tbr{o}-eʔe	&	mango	&	Manipa \it{au}, Wakasihu \it{owo}, Luhu \it{au}	\\
	%&	**taun	&	t\tbr{o}n-iʔi	&	full	&	Manipa \it{u-kon-e} [*t > k], Wakasihu \it{toun-a}, Kelang, \it{taun-a}, Luhu \it{taun-a}, Asilulu \it{taun}, Buru \it{taun}	\\
	%&	**ndau	&	r\tbr{o}-ʔu	&	brother-in-law	&	Manipa \it{ro-}, Wakasihu \it{ro-ʔu}, Kelang \it{rau}, Luhu \it{rau}, Asilulu \it{rau}, Buru \it{dawe}	\\
	%&	*hapuy	&	\tbr{au}	&	fire	&	Manipa \it{au}, Wakasihu \it{ao-o}, Asilulu \it{au}, Luhu \it{au}	\\
%\lspbottomrule
%\end{tabularx}\mbox{}\\}
...
Consistently in Buru, PMP *d > \it{r} (over 80 instances),
...
Consistent with \tsc{Ambon-Seram}, Boano merges PMP *d/*z > \it{l},
...
\tbx{10-35}	&	*pi\tbr{l}iq	&	para-i\tbr{n}i-ʔe	&	choose	\\
	...
	&	**batə\tbr{l}u	&	hate\tbr{n}u	&	thick (cf. Hitu \it{hatelu}, Larike \it{hutido}, Geser \it{batolu} among others; metathesis from PMP *təbəl)	\\
...
Boano, Larike, and Wakasihu and placed them in a single branch (\tsc{East
Hoamoal}) of \tsc{West Piru Bay}.
We note that the conditioning environment for PMP *l > \it{n}
(adjacent to a high vowel) is the same as that for Larike *l > \it{d}.
However, this is also the conditioning environment for **l >
\it{r} in Amahai, \tsc{Kamarian}, Kaibobo, and Haruku, which \citet[100]{Collins1983}
places within \tsc{East Piru Bay}.
...
Firstly, if Boano truly belongs within \tsc{Piru Bay},
then Boano split off before the merger of PMP *d/*z/*R/*l/*j
that occurs in Larike
and Wakasihu (see \srf{10-01}).
Secondly, the merger of PMP *R/*l/*j > **l cannot be assigned
to the level of Proto-Ambon-Seram.
With regard to these segments,
a simpler treatment might be to have Boano be its own branch
within \tsc{Ambon-Seram} rather than linked to Larike
and Wakasihu, with *R/*l/*j > **l occurring in other \tsc{Ambon-Seram} languages.
If further work shows a close relationship between Boano,
Larike, and Wakasihu, then we would propose that the branch
containing these languages (\citeauthor{Collins1983}' \tsc{East Hoamoal}) be a primary
branch of \tsc{Ambon-Seram}.

If Boano is a primary branch,
the change *l/*j > **l can be assigned to the level of \tsc{Ambon-Seram}
...
and the Asilulu data together “indicate retention of a reflex
...
in Proto-Central Maluku must be revised.
Indeed, the Asilulu evidence presented here impels us to make
