...
Yalahatan is currently spoken in a couple of villages in south central Seram.
Atamanu is spoken in two villages on the northeastern coast of
the Elpaputih Bay (see \frf{07-03}).
Note that although Yalahatan
and Atamanu are said to be linguistically related to Alune,
they are separated by some distance.
\citet[38]{Collins1983} says, “The dispersal of the Atamanu language
(Haruru, Awaiya and Yalahatan) may be connected with the seventeenth
and eighteenth century colonial expeditions of attrition; at
least this is implied in local oral traditions.”

Yalahatan has occasional glottal-insertion between vowels (for
...
\lsptoprule
%\tbx{10-39}	&	PMP/PCM	&	Yalahatan	&	Atamanu	&	gloss	\\	\midrule
%\endfirsthead
	&	PMP/PCM	&	Yalahatan	&	Atamanu	&	gloss	\\	\midrule
%\endhead
\tbx{10-39}	&	*\tbr{l}u\tbr{l}un	&	\tbr{l}u\tbr{l}u-e	&		&	roll up	\\
	...
	&	*qatə\tbr{l}uR	&	te\tbr{l}ul-i	&	a\tbr{l}u-i	&	egg (Atamanu possibly non-cognate)	\\
...
*Rusuk has *R > \it{r} in Yalahatan,
but *R > \it{l} in Atamanu.
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-41}	&	PMP	&	Yalahatan	&	Atamanu	&	gloss	\\	\midrule
%\endfirsthead
	&	PMP	&	Yalahatan	&	Atamanu	&	gloss	\\	\midrule
%\endhead
\tbx{10-41}	&	*\tbr{R}umaq	&	\tbr{l}uma	&	\tbr{l}uma	&	house	\\
	...
	&	*qatəlu\tbr{R}	&	telu\tbr{l}-i	&	(alu-i)	&	egg (Atamanu \it{alu-i} probably non-cognate)	\\
	...
	&	*timu\tbr{R}	&	timi\tbr{l}-e	&	timu\tbr{l}-e	&	east monsoon  (*R > \it{l} /\it{i})	\\	\midrule
...
this also occurs in several \tsc{Ambon-Seram} languages for this item.
Examples include: Paulohi, Sepa,
Nusalaut, Saparua, and Wemale \it{manawa}, as well as Alune \it{manukwai {\tl} makwai}.
...
and is potentially significant in showing that \tsc{Ambon-Seram} *j/*l
...
llll}
\lsptoprule
%\tbx{10-43}	&	PMP	&	Yalahatan	&	Atamanu	&	gloss	\\	\midrule
%\endfirsthead
\tbx{10-43}	&	PMP	&	Yalahatan	&	Atamanu	&	gloss	\\	\midrule
%\endhead
...
in Yalahatan, the different reflexes of *j word finally show that the merger
is not complete in all environments.

\largerpage
Yalahatan has *z > \it{r},
as shown in \qf{10-44}, and *d > \it{r,
l} as shown in examples \qf{10-45} and \qf{10-46} respectively.
Atamanu is more regular with *z/*d > \it{r} in all identified reflexes.
\\
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-44}	&	PMP	&	Yalahatan	&	Atamanu	&	gloss	\\	\midrule
%\endfirsthead
	&	PMP	&	Yalahatan	&	Atamanu	&	gloss	\\	\midrule
%\endhead
...
\tbx{10-45}	&	*\tbr{d}uha	&	\tbr{r}ua	&	\tbr{r}ua	&	two	\\
	...
	&	*ma-u\tbr{d}əhi	&	mu\tbr{r}i	&	ana mu{\tl}mu\tbr{r}i	&	Yalahatan: `back, behind', Atamanu: `youngest child'	\\
...
The different reflexes of *d in Yalahatan in \qf{10-45}
...
Yalahatan \it{lale-i} ‘inside’ could be explained as progressive
assimilation, while Atamanu \it{palirare} ‘inside’ shows *l > \it{r} through regressive assimilation.
Given the consistency of Atamanu *d/*z > \it{r} it appears the
best solution at this point is to posit *d/*z > **r with subsequent
**r > \it{l, r} in Yalahatan.

To summarise, while Yalahatan
and Atamanu show a merger of *R/*l/*j > \it{l} in most cases,
