...
Seti is listed as a branch under Nunusaku,
...
%70	&	74	{\cgr}&	67	&	69	{\cgr}&	66	&	70	{\cgr}&	\mc{2}{l}{\it{Wahakaim}}			&	Wahakaim	\\
		%\lspbottomrule
	%\end{tabular}
%\end{table}
...
70	&	74&	67	&	69&	66	&	70&	\mc{2}{l}{\it{Wahakaim}}			&	Wahakaim	\\
		\lspbottomrule
	\end{tabular}
\end{table}
...
the “Liambata” data in \citet{Tauern1931} is the most divergent,
and this may represent Salas [sgu] or a variety of Benggoi [bgy].\footnote{
		The data in \citet[128--129]{Tauern1931} is entitled: “Liambata dialect
		of the Alifuru people of east Seram.
		Bonfia language”
		%(“Liambata-Dialekt der Alfuren von Ostseran. Bonfia-Sprache.”).
		Although in other sources “Bonfia” is used
		to refer to Masiwang,
		the data in Tauern is definitely not Masiwang.} 
...
\citet{Boot1893}									&	Kobi							&	source of \citeauthor{Stresemann1927}'s Kobi \\	
\citet{Wallace1869}								&	Ahtiago						&	source of \citeauthor{Stresemann1927}'s Liambata	\\	
\citet{Stresemann1927}						&	Liambata					&		\\	
\citet[122--128]{Tauern1931}			&	\mc{2}{l}{Uhei-Kaẖlakim}		\\	
\citet[128--139]{Tauern1931}			&	Liambata					&	different from \citeauthor{Stresemann1927}'s Liambata\\
\citet[177--180]{Stokhof1981a}		&	Maneo							&		\\	
\citet[181--184]{Stokhof1981a}		&	Teula							&		\\	
\citet{Collins1986}								&	Seti {\&} Adabai	&		\\	
\citet{McCollum-Grimes1990} 	&	Lapela-Kedalil		&		\\	
		\lspbottomrule
	\end{tabularx}
\end{table}

From west to east along the northeastern coast of the Teluti
bay villages where \tsc{Seti} is spoken lie in the following order
(other villages also occur in this area): Ulahaham,
Dihil, Lapela, Elnusa, Atiahu, and Adabai.
Note that Atiahu village lies between Elnusa
and Adabai, which together form a single grouping in \citet{LoskiLoski1989}.
Atiahu village is presumably where the “Ahtiago” data in Wallace
1869 was collected,\footnote{
\citet{Wallace1869} also has a word list
from “Ahtiago and Tobo” which is Bobot [bty] (\srf{11-02}).} 
which in turn appears to be the source of the “Liambata” data in \citet{Stresemann1927}.
It is thus possible that this Atiahu/Liambata variety of \tsc{Seti}
belongs with Elnusa and Adabai villages as a single variety/dialect of \tsc{Seti}.

Benggoi is another language/dialect cluster neighbouring \tsc{Seti},
and the two clusters have a number of similarities.
According to \citet[121]{LoskiLoski1989} “The Benggoi language
is spoken by 350 people in three villages in the Werinama
and Bula districts (Benggoi, Balakeo, and Lesa).
It is most closely related to \tsc{Seti} (59{\%}).
Although each of the dialects of Benggoi share only 70{\%} lexical
...
language in these three villages were similar.” Our Benggoi data
...
This data is different to the Atiahu/Liambata data in \citet{Wallace1869}
...
and Dihil villages, as well as Atiahu/Liambata (Elnusa-Adabai?) to its east.
%When this data needs to be distinguished from other varieties
%of \tsc{Seti} it is labelled “Liana-Seti”.
...
to its east, \tsc{Seti} and Benggoi have a few lexically specific innovations
which are shared with Manusela to the west.
Examples are given in \qf{10-58}.
%Liambata data in \qf{10-58} is from \citet{Stresemann1927}.

%\begin{table}\tcp{Lexically specific \tsc{Seti-Benggoi} and \tsc{Manusela} innovations}{10-00}
...
%Liana-Seti&ima-k	&	umal-a	&	ro-a	&	kalu-k	&	au-bulai	&	lela-k	&	foina\\
%Benggoi		&ima-m	&	umel-am	&	do-am	&		&	ya-huley	&	lela-m	&	hoin-am\\
...
\lsptoprule
%\tbx{10-58}	&	PMP	&	Liana-Seti	&	Benggoi	&	Manusela	&	gloss	&	innovation	\\	\midrule
%\endfirsthead
\tbx{10-58}	&	PMP	&	Liana-Seti	&	Benggoi	&	Manusela	&	gloss	&		\\	\midrule
%\endhead
...
\tsc{Seti} and Benggoi share *ŋ/*n > \it{n} in most words with \tsc{Ambon-Seram}.
Examples are given in \qf{10-59} below.
There are two exceptions in our data which are probably attributable
to contact with neighbouring Bobot and/or Masiwang.
These are the reflexes of *naŋuy ‘swim’ in \tsc{Seti}
and *saŋa ‘forked branch’ in Benggoi.
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-59}	&	PMP	&	Liana-S.	&	Benggoi	&	gloss	\\	\midrule
%\endfirsthead
\tbx{10-59}	&	PMP	&	Liana-S.	&	Benggoi	&	gloss	\\	\midrule
%\endhead
	...
	&	**\tbr{ŋ}aRək 	&	\tbr{n}aʔa	&	\tcg{(tahun)}	&	year; (PAMS, cf. Buru \it{ŋahe-t}, Asilulu \it{nale}, E. Kola \it{nahak,} SW. Tarangan \it{narak})	\\
	...
	&	*sa\tbr{ŋ}a	&	sa\tbr{nn}a	&	sok{\tl}so\tbr{k}-am	&	fork, branch (cf. Masiwang \it{sak{\tl}sa\tbr{k}an})	\\
	&	*na\tbr{ŋ}uy	&	au-na\tbr{k}	&	\tcg{(etinem)}	&	swim (cf. Bobot \it{na\tbr{k}u̥)}; Kobi Seti ‹ienè\tbr{n}› \citep[1187]{Boot1893}	\\
\lspbottomrule
\end{tabularx}\mbox{}\\}
...
For the most part,
*d/*z/*l/*j > \it{l} in \tsc{Seti} and Benggoi.
Word finally, *d/*z/*l/*j > \it{l,} {\0} with one possible case
of final *j > \it{n} in Benggoi (*uləj > \it{ulan-em} ‘worm’).
The reflexes of *d,
...
>{\raggedright\arraybackslash}X}
\lsptoprule
	%&		&	PMP	&	Liana-S.	&	Benggoi	&	gloss	\\	\midrule
%\endfirsthead	
&		&	PMP	&	Liana-S.	&	Benggoi	&	gloss	\\	\midrule
%\endhead	\midrule
\tbx{10-60}	&	*d	&	*\tbr{d}aRaq	&	\tbr{l}aha {\tl} \tbr{l}ahe	&	\tbr{l}ahi-m	&	blood	\\
	...
	&		&	*\tbr{d}aləm	&	\tbr{l}ali-k, fal\tbr{l}al	&	\tcg{(dalam)}	&	inside; Benggoi from Malay\\
...
\tbx{10-62}	&	*j	&	*pa\tbr{j}ay	&	ha\tbr{l}a	&	ha\tbr{l}e-m	&	rice	\\
	...
	&		&	*ma\tbr{j}a	&	ma\tbr{l}afu-a	&	me\tbr{l}a	&	Liana-S. `dry up', Benggoi `dry'	\\
	...
	&		&	*qalə\tbr{j}aw	&	lea	&	\tcg{(umelen-am)}	&	sun, day, sky (*j > {\0} in all \tsc{Ambon-Seram})	\\
...
> **inut-a > liana-Seti \it{int-a},
Benggoi \it{int-am} ‘skin’ and *qulu > **unu-a > \it{un-a} ‘head’.
However, *l > \it{n} does not occur in other words with adjacent
high vowels *bulu > Liana-Seti \it{fulaʔa},
Benggoi \it{kafult-em} ‘body hair’,
or in *qulu > Adabai Seti \it{ulu-,} Benggoi \it{ulu-m} ‘head’.
\\
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-63}	&	PMP	&	Liana-S.	&	Benggoi	&	gloss	\\	\midrule
%\endfirsthead
\tbx{10-63}	&	PMP	&	Liana-S.	&	Benggoi	&	gloss	\\	\midrule
%\endhead
	...
	&	*hu\tbr{l}aR	&	u\tbr{l}a (C)	&	u\tbr{l}a-m	&	snake (Seti Adabai dialect)	\\
	&	*tə\tbr{l}u	&	en-to\tbr{l}	&	en-to\tbr{l}	&	three	\\
	&	*wa\tbr{l}u	&	wa\tbr{l}	&	a\tbr{l}u	&	eight	\\
	&	**ma\tbr{l}ip	&	ma{\tl}ma\tbr{l}	&	mo\tbr{h}	&	laugh (Benggoi possibly non-cognate)	\\
	&	**ma\tbr{l}ip	&	mum\tbr{l}iya	&		&	smile	\\
	&	*qatə\tbr{l}uR	&	to\tbr{ll}a	&	to\tbr{l}-am	&	egg	\\
	&	*ba\tbr{l}abaw 	&	u\tbr{l}afa	&		&	rat, mouse	\\
	&	*qu\tbr{l}u	&	u\tbr{l}u- (C)	&	u\tbr{l}u-m	&	head (Seti Adabai dialect)	\\
	...
	&	*qa\tbr{l}ima	&	ima-k	&	ima-m	&	hand (irr. *l > {\0}, also in Manusela)	\\
\lspbottomrule
\end{tabularx}\mbox{}\\}
...
with *R > \it{l,} {\0} word finally.\footnote{
		One instance of
		*R > {\0} word medially is Liambata *duRi > \it{lu-im} ‘bone’
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-64}	&		&	PMP	&	Liana-S.	&	Benggoi	&	gloss	\\	\midrule
%\endfirsthead
\tbx{10-64}	&		&	PMP	&	Liana-S.	&	Benggoi	&	gloss	\\	\midrule
%\endhead
	...
	&		&		&	naba\tbr{l}a-k	&		&		\\
	&		&	*u\tbr{R}at	&	u\tbr{l}a tawal-e	&	\tcg{(urat)}	&	vein, tendon (Benggoi from Malay)	\\
...
\tbx{10-64b}	&	/{\gap}{\#}	&	*ndu\tbr{R}du\tbr{R} (?)	&	dó\tbr{l}-a (C)	&	\tcg{(bormuln-am)}	&	thunder	\\
	&		&	*timu\tbr{R}	&	tim\tbr{l}-a	&		&	east monsoon	\\
	&		&	*qatəlu\tbr{R}	&	to\tbr{l}l-a	&	to\tbr{l}-am	&	egg	\\
	&		&		&	to\tbr{l}-n-im	&		&	egg (Liambata, \citealp[22]{Stresemann1927})	\\
	&		&	*wahiyə\tbr{R}	&	wai-a	&	wei\tbr{l}-am	&	water	\\
	&		&	*busu\tbr{R}	&	usu-a	&	hus\tbr{l}-am	&	bow (*bu > u, also in Geser)	\\
	&		&	*hula\tbr{R}	&	ula (C)	&	ula-m	&	snake (Seti Adabai)	\\
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-65}	&	PMP	&	Liana-S.	&	Benggoi	&		\\	\midrule
%\endfirsthead
\tbx{10-65}	&	PMP	&	Liana-S.	&	Benggoi	&		\\	\midrule
%\endhead
	&	*da\tbr{R}aq	&	la\tbr{h}-a {\tl} la\tbr{h}-e	&	la\tbr{h}-im	&	blood	\\
	&	*ha\tbr{R}ezan	&	olam (C)	&	a\tbr{h}el-am	&	stairs (Liana-S. *R > {\0})	\\
	&	*wa\tbr{R}əj	&	ai we\tbr{h}el-a	&	iwel-am	&	vine, rope (Benggoi *R > {\0}, *j > \it{l})	\\
	&	*ti\tbr{R}əm	&	te\tbr{h}en-a	&		&	oyster	\\
	&	*laya\tbr{R}	&	laiya\tbr{l}-a	&	le\tbr{h}-am	&	sail (n.)	\\
	&	**ŋa\tbr{R}ək	&	na\tbr{ʔ}a	&	\tcg{(tahun)}	&	year (cf. Buru \it{ŋahe-t}, Asilulu \it{nale} among others)	\\
	&	*ku\tbr{R}ita	&	u\tbr{w}ita ?/uita/	&		&	octopus (cf. Bobot *R > w)	\\
	&	*ma\tbr{R}uqanay	&	mu\tbr{l}a(la)ina	&	mo\tbr{l}nan-am	&	male	\\
	&	*ma\tbr{R}uqanay	&	‹múana›	&		&	man (Liambata, \citealp[617]{Wallace1869}	\\
	&	*du\tbr{R}i	&	lui\tbr{l}-e	&	lui\tbr{l}-am	&	bone	\\
	&	*du\tbr{R}i	&	lu-im ?/lui-m/	&		&	bone (Liambata, \citealp[135]{Stresemann1927}	\\
	&	*\tbr{R}umbia	&	ipiya	&	(bam)	&	sago (*R > {\0} in many languages)	\\
	&	*haba\tbr{R}at	&	fa\tbr{r}at-a	&	\tcg{(barat)}	&	Liana-S. `west monsoon', Benggoi `west' < Malay	(irr. *R > \it{r}, also in \tsc{East Littoral} \srf{10-01-02}	\\
	&	*qa\tbr{R}us	&	a\tbr{r}us	&	a\tbr{r}us	&	current (in water) (irr. *R > \it{r}, Malay \it{arus}?)	\\
\lspbottomrule
\end{tabularx}\mbox{}\\}

\newpage
There are a number of reflexes of PMP reconstructions with *R
in the ``Liambata'' data in \citet{Tauern1931} which are either not
...
and **kambeR which have *R > \it{h}.\footnote{
		For **kambeR ‘saliva’ compare Proto-Rote-Meto
		*kambe ‘saliva’ \citep[192]{Edwards2021},
		Kamarian \it{aper} ‘mucus’, Nusalaut \it{apel} ‘mucus,
		snot’, and South Nuaulu \it{apai},
		\it{apana} ‘saliva’.}
\\
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-66}	&	PMP	&	Liambata	&	gloss	\\	\midrule
%\endfirsthead
\tbx{10-66}	&	PMP	&	``Liambata''	&	gloss	\\	\midrule
%\endhead
	...
	&	*laya\tbr{R}	&	lilaian-a	&	sail (cf. Liana-Seti \it{laiyal-a})	\\
...
often in words which also have unexpected *ə > \it{e} in other \tsc{Ambon-Seram} languages.
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-67}	&		&	PMP	&	Liana-S.	&	Benggoi	&	gloss	\\	\midrule
%\endfirsthead
\tbx{10-67}	&		&	PMP	&	Liana-S.	&	Benggoi	&	gloss	\\	\midrule
%\endhead
...
\tbx{10-69}	&	*ə /σ\und{σ}	&	*ul\tbr{ə}j	&	ul\tbr{e} 	&	ul\tbr{a}n-em	&	small worm  (possibly \it{ul-e})	\\
	...
	&		&	*ma-qit\tbr{ə}m	&	met\tbr{e}n-a	&	\tcg{(lobot)}	&	black (*ə > \it{e} in all \tsc{Ambon-Seram})	\\
...
p} and Benggoi has *ma-p/*mb > \it{b}
in the two identified reflexes.
Examples as shown in \qf{10-70}.
This is different to other \tsc{Ambon-Seram} languages which
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-70}	&	PMP	&	Liana-S.	&	Benggoi	&	gloss	\\	\midrule
%\endfirsthead
\tbx{10-70}	&	PMP	&	Liana-S.	&	Benggoi	&	gloss	\\	\midrule
%\endhead
	...
	&	*Ru\tbr{mb}ia		&	i\tbr{p}iya			&	\tcg{(bam)}	&	sago tree (cf. ``Liambata'' \it{bia} `sago' [\citealp[132]{Tauern1931}])	\\
	&	*ka\tbr{mb}u		&		&	a\tbr{b}un	&	pregnant	\\
\lspbottomrule
\end{tabularx}\mbox{}\\}

To summarise,
\tsc{Seti} and Benggoi group with \tsc{Ambon-Seram} on the basis of
...
which is different to most \tsc{Ambon-Seram}.
We place \tsc{Seti} and Benggoi together as a primary branch of \tsc{Ambon-Seram}
