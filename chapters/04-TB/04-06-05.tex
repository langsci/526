...
This group includes all the languages of the Babar archipelago
(except Wetan which is a member of the Luang language/dialect
cluster), as well as West Damer [drn] on Damer island to the north of Babar.
...
of data for five of these languages:\footnote{
		...
		languages, as well as the North Babar language.
		This data has been archived as \citet{Edwards2023}.
		With the exception of Emplawas and West Marsela,
		this data has not been integrated into this section.}
Dai [dij], North Babar [bcd], East Marsela [vme], Imroing [imr], and Tela-Masbuar [tvm].\footnote{
		We usually
		refer to Dawera-Daweloor as \it{Dawera}
		and Tela-Masbuar as \it{Tela} as these are the locations for
...
the following sources: \citet{Steinhauer2009} for Southeast Babar
[vbb], \citet{Chlenova2002,Chlenova2012} for Dawera-Daweloor [ddw],
\citet{ChlenovChlenova2008b} for West Damer,
\citet{Edwards2023} for Emplawas and West Marsela, as well as \citet{vanDijk2021}
			for Central Marsela, and Serili.\footnote{
...
and also provides a list of Proto-South Babar reconstructions.
...
for which we use the symbols in \citet{Taber1993} wherever possible.\footnote{
		...
		gives Dawera-Daweloor ‹ˈmɛtmel› `black' while \citet[165]{Chlenova2002}
		gives ‹metmel› `black'. Thus, we transcribe this word \it{mɛtmel}.}
This is because there is evidence that at least some languages
of the Babar Islands have a contrast between mid-high and mid-low
vowels\footnote{
		...
		Minimal pairs from Emplawas include: /we/ [β̞e] ‘water’ vs.
...
which may be under-represented in the available sources.\footnote{
		...
		The West Marsela and Serili data in \citet{vanDijk2021}
		was similarly compiled by native-speaker consultants,
		while the Central Marsela data was compiled by \citeauthor{vanDijk2021}
		...
		between mid /e o/ and mid-low /ɛ ɔ/ in Serili,
		as well as mid-high /e/ and mid-low /ɛ/
		in West Marsela and Central Marsela.
		While \citet{Steinhauer2009} does not report a contrast
		between mid-vowel heights for SE. Babar,
		Edwards' fieldwork found such a contrast
		for some SE. Babar-speaking villages.}
...
The simplest solution is to posit *s > **ʈ at Proto-Babar,
with *t > **k occurring before **ʈ > \it{t} in Proto-South Babar.
...
local gl.	&	{\hr}breast											&	{\hr}who							&	{\hr}one	&	{\hr}dog	&	{\hr}smoke	&	{\hr}teeth\\
PMP				&	\hr*\tbr{s}u\tbr{s}u						&	\hr*\tbr{s}ai					&	\hr*ma-ə\tbr{s}a	&	\hr*a\tbr{s}u	&	**ma-qa\tbr{s}u	&	\hr*ŋi\tbr{s}i\su{Δ}\\
P.-Babar	&	**\tbr{ʈ}u\tbr{ʈ}u							&	**\tbr{ʈ}ai						&	**me\tbr{ʈ}(en)	&	**a\tbr{ʈ}u	&	**ma\tbr{ʈ}u	&	**ŋi\tbr{ʈ}i\\ \midrule
W. Damer	&	{\hr\hr}\tbr{d}u\tbr{t}h-o			&	{\hr\hr}\tbr{d}esɛri	&	\hr\cg{(mɛhn-o)}\su{†}	&	{\hr\hr}o\tbr{t}h-o	&	\tcg{(o muhal-o)}\su{‡}	&	\hr\cg{(nin-o)}\\
Dawera		&	{\hr\hr}\tbr{d}u\tbr{d}k-ol			&	{\hr\hr}\tbr{d}eyɛ		&	{\hr\hr}mɛ\tbr{d}	&	{\hr\hr}a\tbr{d}k-ol	&	am mɛ\tbr{d}iky	&	{\hr\hr}i\tbr{d}-ol\\
Dai				&	{\hr\hr}\tbr{d}u\tbr{d}ʔ-on			&	{\hr\hr}\tbr{d}eyehe	&	{\hr\hr}mɛ\tbr{d}	&	{\hr\hr}a\tbr{d}y-on	&	ma\tbr{d}ʔ-ɛn-on	&	{\hr\hr}i\tbr{d}-on\\
N. Babar	&	{\hr\hr}\tbr{d}u\tbr{t}-nie			&	{\hr\hr}\tbr{d}ediɛ	&	{\hr\hr}mɛ\tbr{d}e	&	{\hr\hr}a\tbr{d}ui-ai	&	am-e ma\tbr{t}-ni-ai	&	{\hr\hr}i\tbr{t}-ne\\
C. Marsela&	{\hr\hr}\tbr{t}u\tbr{t}-ni			&	{\hr\hr}\tbr{t}yoi	&	{\hr\hr}mɛ\tbr{t}	&	{\hr\hr}e\tbr{t}y	&	\tcg{(owour i-ei)}	&	\hr\cg{(ninn)}\\
W. Marsela&	{\hr\hr}\tbr{t}u\tbr{t}y				&	{\hr\hr}\tbr{t}io i	&	{\hr\hr}mɛ\tbr{t}n	&	{\hr\hr}u\tbr{t}y	&	\tcg{(owr)}	&	\hr\cg{(nin)}\\
E. Marsela&	{\hr\hr}\tbr{t}u\tbr{t}					&	{\hr\hr}\tbr{t}oi	&	{\hr\hr}mɛ\tbr{t}el	&	{\hr\hr}u\tbr{t}	&	ui mo\tbr{t}y	&	\hr\cg{(lil)}\\
Serili		&	{\hr\hr}\tbr{t}u\tbr{t}					&	{\hr\hr}\tbr{t}oi	&	{\hr\hr}mɛ\tbr{t}el	&	{\hr\hr}u\tbr{t}	&	\tcg{(ui-ho bo{\tl}bor-ɛ)}	&	\hr\cg{(lil)}\\
SE. Babar	&	{\hr\hr}\tbr{t}u\tbr{t}					&	{\hr\hr}\tbr{t}oi	&	{\hr\hr}me\tbr{t}el	&	{\hr\hr}u\tbr{t}y	&	ui mo{\tl}mo\tbr{t}	&	\hr\cg{(lil)}\\
Emplawas	&	{\hr\hr}\tbr{t}u\tbr{t}y-o			&	{\hr\hr}\tbr{t}oi	&	{\hr\hr}mɛ\tbr{t}	&	{\hr\hr}u\tbr{t}y-o	&	mu\tbr{t}y-o	&	\hr\cg{(lil-wo)}\\
Imroing		&	{\hr\hr}\tbr{t}u\tbr{t}u-mu-te	&	{\hr\hr}\tbr{t}oi	&	{\hr\hr}mɛ\tbr{t}le	&	{\hr\hr}u\tbr{t}i-e	&	mu\tbr{t}i-le	&	\hr\cg{(lil-mu-te)}\\
Tela			&	{\hr\hr}\tbr{t}u\tbr{t}-ni			&	{\hr\hr}\tbr{t}eʔoi	&	{\hr\hr}me\tbr{t}nu	&	{\hr\hr}nu\tbr{t}i-e	&	\tcg{(obri-e)}	&	\hr\cg{(nin-e)}\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†]	{West Damer \it{mɛhn-o} ‘one’ is probably borrowed from East Damer \it{mehan} ‘one’.}
			\item[‡]	{West Damer \it{muhal-o} ‘smoke’ is probably a borrowing.
								Compare East Damer \it{muklan},
								Luang \it{moklə}, Wetan \it{mokla} ‘smoke’,
...
plosive /d/ is phonetically alveolar [d̳] or even slightly retroflex [ḍ].
...
This is clearly exemplified by Kisar which contrasts fully retroflex
(and voiceless) /ʈ/ with non-retroflex /t/ \citep{ChristensenChristensen1992}.
Kisar /ʈ/ is from PMP *d
...
Further support for this comes from Dai in which voiced [d]
...
Dai [ʈ] mostly occurs in syllable codas while [d] occurs elsewhere.
...
and \it{n-pud} [n̩ˈpuʈ] ‘rotten’.\footnote{
		...
		Exceptions in Dai where retroflex [ʈ] does not occur in coda
		position or [d] does not occur in onsets include \it{mɛd} [mɛd]
		‘one’ and \it{n-dɛr} [n̩ˈʈɛr] ‘dry’ (Dawera \it{dɛr-el} [ˈdɛrel] ‘dry’).
		There are also occasional instances in which coda [t] in Dai
		corresponds to **d, such as \it{dudʔ-on} [ˈdutʔon] ‘breast’
...
Examples of final *u > **i,\footnote{
		West Damer, Dai, and Dawera usually have fortition
		of final *u for nouns (\srf{04-06-05-01}).
		Other Babar languages a suffix \it{-i} which occurs on verbs and adjectives.
...
as well as *z > **h are given in \trf{04-46}.\footnote{
		An additional example of *z > **h is *zauq > West Damer \it{heyo} ‘far’.
		Other Babar languages have non-cognate words for ‘far’.}
Word-final *u > \it{i} is also found in nearby Wetan,
as well as Masiwang,
Yamdena and the \tsc{Bomberai Tip} languages,
all belonging to \tsc{Seram-Tanimbar-Bomberai}
(\crf{ch:STB}).
PMP *z > **h > {\0} in Dawera
and all \tsc{South Babar} languages except Serili.
...
P.-Babar	&	**tel\tbr{i}	&	**it\tbr{i}	&	**wut\tbr{i}	&	**\tbr{h}alan	&	**mo\tbr{h}o	&	**u\tbr{h}an\\ \midrule
W. Damer	&	{\hr\hr}wyɛ-tel\tbr{i}	&	{\hr\hr}wit\tbr{i}	&	{\hr\hr}uswut\tbr{i}	&	{\hr\hr}\tbr{h}oll-o	&	{\hr\hr}mɛh{\tl}mɛ\tbr{h}o	&	{\hr\hr}u\tbr{h}an-o\\
Dawera	&	{\hr\hr}tɛl	&	{\hr\hr}it\tbr{y}	&	{\hr\hr}de-wut	&	{\hr\hr}all-ol	&	\hr\cg{(hiʤau)}	&	{\hr\hr}ul-ol\\
Dai	&	{\hr\hr}tɛn	&	{\hr\hr}it\tbr{y}	&	{\hr\hr}d-wut	&	{\hr\hr}\tbr{h}ann-on	&	\hr\cg{(hiʤau)}	&	{\hr\hr}u\tbr{h}n-on\\
N. Babar	&	{\hr\hr}kin\tbr{i}	&	{\hr\hr}it\tbr{i}	&	{\hr\hr}de-wut\tbr{i}	&	{\hr\hr}\tbr{h}aʔan-ai	&	\hr\cg{(hiʤau)}	&	{\hr\hr}\tbr{h}ona\\
C. Marsela	&	{\hr\hr}wɔk-kɛl	&	{\hr\hr}wɔ-ii	&	{\hr\hr}wuk\tbr{i}	&	{\hr\hr}all	&	{\hr\hr}mo{\tl}moa	&	\hr\cg{(omn)}\\
W. Marsela	&	{\hr\hr}wo-kɛl	&	{\hr\hr}wo-ik	&	{\hr\hr}wukk\tbr{i}	&	{\hr\hr}al	&		&	\hr\cg{(omn)}\\
E. Marsela	&	{\hr\hr}wɔk-kɛl	&	{\hr\hr}wo-ik	&	{\hr\hr}wuk\tbr{i}	&	{\hr\hr}al	&		&	\hr\cg{(umul)}\\
Serili	&	{\hr\hr}bok-kɛl	&	{\hr\hr}boʔot	&	{\hr\hr}buk\tbr{i}	&	{\hr\hr}\tbr{h}al-ɛ	&	{\hr\hr}mo{\tl}m\tbr{h}o	&	\hr\cg{(omen)}\\
SE. Babar	&	{\hr\hr}wɔ-kɛl\tbr{y}	&	{\hr\hr}wɔ-ix\tbr{y}	&	{\hr\hr}wuk\tbr{i}	&	{\hr\hr}al	&		&	\hr\cg{(uml)}\\
Emplawas	&	{\hr\hr}wo-kɛl\tbr{y}	&	{\hr\hr}wo-ik	&	{\hr\hr}wukk\tbr{i}	&	{\hr\hr}as-o	&	{\hr\hr}mo{\tl}moy-i	&	\hr\cg{(op-o)}\\
Imroing	&	{\hr\hr}wo-kel\tbr{i}	&	{\hr\hr}wo-ik\tbr{i}	&	{\hr\hr}wuk\tbr{i}	&	{\hr\hr}ann-e	&	\hr\cg{(mot{\tl}mote)}	&	\hr\cg{(oml-e)}\\
	...
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†]	{**butu is reconstructed to PCEMP with the meaning ‘group, bunch, cluster’.
								Its reflexes also mean `ten' in \tsc{Ambon-Seram} languages.}
			\item[‡]	{Cognates of **mozo ‘green’ occur widely in other \tsc{Timor-Babar} languages.
								...
								Imroing \it{mot{\tl}mote} is borrowed from Wetan \it{mota}.}
		\end{tablenotes}
	\end{threeparttable}
%\end{adjustbox}
\end{table}
...
When *R/*j were lost,
this was probably through intermediate **y in the pre-Babar stage
...
P.-Babar	&	**\tbr{y}uma	&	**ra\tbr{y}a	&	**wa\tbr{y}a	&	**la\tbr{y}a	&	**wa\tbr{y}i	&	**(wa)riʈ\su{†}	&	**ŋan\\ \midrule
W. Damer	&	{\hr\hr}uma	&	{\hr\hr}ro-o	&		&	{\hr\hr}lawo-ni	&	{\hr\hr}wey-o	&	{\hr\hr}wadir-o	&	{\hr\hr}non-o\\
Dawera	&	{\hr\hr}um-ol	&	{\hr\hr}rai-ol	&	{\hr\hr}me-wael	&	{\hr\hr}ley-ol	&	{\hr\hr}wel-ol	&	{\hr\hr}le-wrid	&	\hr\cg{(wulɛtal-ol)}\\
Dai	&	{\hr\hr}um-on	&	{\hr\hr}raʔ-on	&	{\hr\hr}rɛ-viai	&	{\hr\hr}ne-on	&	{\hr\hr}wai-ny-on	&	{\hr\hr}nɛ-wrid	&	\hr\cg{(wnyɛtan)}\\
N. Babar	&	{\hr\hr}oma-ai	&	{\hr\hr}raʔa-nai	&	{\hr\hr}nɛ-wiai-ɛna	&	{\hr\hr}neya	&	{\hr\hr}wia-ny-ai	&	{\hr\hr}na-wrod-o	&	{\hr\hr}an-ai\\
C. Marsela	&	{\hr\hr}ɛm	&	{\hr\hr}rɛ	&	{\hr\hr}mo-wɛy-ei	&	{\hr\hr}loo	&	{\hr\hr}wei-ni	&	{\hr\hr}ne-itir	&	{\hr\hr}nɛn\\
W. Marsela	&	{\hr\hr}im	&	{\hr\hr}rɛ	&	\hr\cg{(mo-wɛki)}	&	{\hr\hr}lo	&	{\hr\hr}wɛy-ɛ	&	{\hr\hr}mo-tir	&	{\hr\hr}nun\\
E. Marsela	&	{\hr\hr}ɛm	&	{\hr\hr}ra	&	\hr\cg{(mo-riay-ei)}	&	{\hr\hr}loi	&	{\hr\hr}uwei	&	{\hr\hr}mo-tir=i	&	{\hr\hr}non\\
Serili	&	{\hr\hr}ɛm	&	{\hr\hr}ra-ɛ	&	{\hr\hr}rɛ-way-ɛ	&	{\hr\hr}lɛ	&	{\hr\hr}bia-liɛ	&	{\hr\hr}lya-tir	&	{\hr\hr}non\\
SE. Babar	&	{\hr\hr}ɛm	&	{\hr\hr}ra	&	\hr\cg{(mo-yar-e)}	&	{\hr\hr}le	&	{\hr\hr}wiau	&	{\hr\hr}mo-itir	&	{\hr\hr}non\\
Emplawas	&	{\hr\hr}im-o	&	{\hr\hr}rɛ-o	&	\hr\cg{(lɛ-wɛt-e)}	&	{\hr\hr}lo	&	{\hr\hr}wɛi-li	&	{\hr\hr}lɛ-tir	&	{\hr\hr}nun-o\\
Imroing	&	{\hr\hr}im-e	&	{\hr\hr}reɛ-mo	&	{\hr\hr}mo-wey-e	&	{\hr\hr}lo	&	{\hr\hr}weyeyi	&	{\hr\hr}mo-tiro	&	{\hr\hr}nun-mu\\
Tela	&	{\hr\hr}im-e	&	{\hr\hr}re-nye	&	{\hr\hr}re-wey-e	&	{\hr\hr}no-e	&	{\hr\hr}wei-e	&	{\hr\hr}ne-tir	&	{\hr\hr}nun-mu\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†] {W. Damer and \tsc{South Babar} reflexes of *diRus
								have C metathesis.
...
P.-Babar	&	**iu\tbr{r}/**i\tbr{r}u	&	**wa\tbr{r}i\su{†}	&	**o\tbr{r}	&	**wu\tbr{r}\su{‡}	&	**i\tbr{r}n	&	**i\tbr{r}a\\ \midrule
W. Damer	&	\hr\cg{(ehɛheya)}	&	\hr\cg{(wɛlwɛka)}	&	{\hr\hr}o\tbr{r}-o	&	{\hr\hr}awo\tbr{r}	&	\hr\cg{(su-no)}	&	\hr\cg{(wi)}\\
Dawera	&	{\hr\hr}i-ol	&	\hr\cg{(wikɛl)}	&	\hr\cg{(welel)}	&	{\hr\hr}wu\tbr{r}	&	\hr\cg{(ud-ol)}	&	{\hr\hr}i\tbr{r}\\
Dai	&	{\hr\hr}iʔ-on	&	\hr\cg{(wiwit)}	&	\hr\cg{(fitd-on)}	&	{\hr\hr}we\tbr{r}ʔ-on	&	\hr\cg{(ud-on)}	&	{\hr\hr}i\tbr{r}ə\\
N. Babar	&	{\hr\hr}i-ni-ai	&	{\hr\hr}wi{\tl}wiɛ	&	\hr\cg{(spinda)}	&	{\hr\hr}wu\tbr{r}a	&	\hr\cg{(ot-ne)}	&	{\hr\hr}i\tbr{r}e\\
C. Marsela	&	{\hr\hr}i\tbr{r}i-nyeo	&	{\hr\hr}war{\tl}wie\tbr{r}i	&	{\hr\hr}o\tbr{r}	&	{\hr\hr}wo\tbr{r}	&	{\hr\hr}i\tbr{r}n-ei	&	{\hr\hr}wie\tbr{r}a\\
W. Marsela	&	{\hr\hr}ir{\tl}i\tbr{r}y-ɛn	&	{\hr\hr}war{\tl}wyɛ\tbr{r}	&	{\hr\hr}o\tbr{r}	&	{\hr\hr}wo\tbr{r}	&	{\hr\hr}inn	&	{\hr\hr}wyɛ\tbr{r}a\\
E. Marsela	&	{\hr\hr}i-ly-ei	&	{\hr\hr}war{\tl}wia\tbr{r}	&	{\hr\hr}o\tbr{r}	&	{\hr\hr}wo\tbr{r}	&	{\hr\hr}i\tbr{r}n	&	{\hr\hr}wie\tbr{r}a\\
Serili	&	{\hr\hr}i-ly-ɛ	&	{\hr\hr}bar{\tl}bia\tbr{r}i	&	{\hr\hr}ɔ\tbr{r}	&	\hr\cg{(bunt-e)}	&	{\hr\hr}i\tbr{r}ɛl	&	\hr\cg{(nomia)}\\
SE. Babar	&	{\hr\hr}iy	&	{\hr\hr}wa{\tl}way	&	\hr\cg{(pul)}	&	{\hr\hr}wo\tbr{r}	&	{\hr\hr}i\tbr{r}l	&	\hr\cg{(nomya)}\\
Emplawas	&	{\hr\hr}ir{\tl}i\tbr{r}y-o	&	{\hr\hr}war{\tl}wyɛ\tbr{r}y-o	&	{\hr\hr}o\tbr{r}	&	{\hr\hr}wo\tbr{r}	&	\hr(h)itt-ɛ	&	{\hr\hr}wyɛ\tbr{r}a\\
Imroing	&	{\hr\hr}ir{\tl}i\tbr{r}i-e	&	\hr\cg{(peruti)}	&	\hr\cg{(lorl-e)}	&	{\hr\hr}wo\tbr{r}u	&	{\hr\hr}i\tbr{r}lɛ-mu	&	{\hr\hr}wo-i\tbr{r}u\\
	...
	\end{tabular}
		\begin{tablenotes}\tnsize
			...
			\item[‡]	{The reflexes in Dawera and
								North Babar are given for both ‘mountain’ and ‘forest’.
								The reflexes in Tela
								and Imroing are given for ‘forest’.
								Emplawas \it{wor} is ‘forest’.}
		\end{tablenotes}
	\end{threeparttable}
\end{adjustbox}
\end{table}
...
As discussed at the beginning of \srf{04-06},
it probably went through intermediate **s.
\tsc{Teun-Nila-Serua} also has *z > \it{s}.
However, we cannot place \tsc{Teun-Nila-Serua}
...
P.-Babar	&	**\tbr{w}ey	&	**\tbr{w}ayi	&	**\tbr{w}iay	&	**\tbr{w}atu	&	**\tbr{w}u-	&	**(li)-a\tbr{w}u	\\	\midrule
W. Damer	&	{\hr\hr}\tbr{w}i-o	&	{\hr\hr}\tbr{w}es-eni	&	{\hr\hr}\tbr{w}oto	&	{\hr\hr}\tbr{w}oth-o	&	{\hr\hr}uh-a	&	{\hr\hr}a\tbr{w}or	\\	
Dawera	&	{\hr\hr}\tbr{w}ee	&	{\hr\hr}\tbr{w}el-ol	&	{\hr\hr}\tbr{w}oy-el-ol	&	{\hr\hr}\tbr{w}atk	&	{\hr\hr}uk	&	{\hr\hr}le\tbr{w}k-ol	\\	
Dai	&	{\hr\hr}\tbr{w}ɛy-on	&	{\hr\hr}\tbr{w}ai-nyon	&	{\hr\hr}\tbr{o}i-on	&	{\hr\hr}\tbr{w}atʔ-on	&	{\hr\hr}\tbr{w}uʔ-ɛn-on	&	{\hr\hr}nya\tbr{w}ʔ-on	\\	
N. Babar	&	{\hr\hr}\tbr{w}iey-a	&	{\hr\hr}\tbr{w}ia-nyai	&	{\hr\hr}\tbr{w}ia-na	&	{\hr\hr}\tbr{w}aʔay-ai	&	{\hr\hr}\tbr{w}una	&	{\hr\hr}nia\tbr{w}i	\\	
C. Marsela	&	{\hr\hr}\tbr{w}ee	&	{\hr\hr}\tbr{w}ei-ni	&	{\hr\hr}\tbr{w}ɛ-nye	&	{\hr\hr}\tbr{w}ay	&	{\hr\hr}\tbb{b}ui-ni, \tbr{w}ui-ni	&	{\hr\hr}ɛ\tbr{w}y	\\	
W. Marsela	&	{\hr\hr}\tbr{w}e	&	{\hr\hr}\tbr{w}ɛy-ɛ	&	{\hr\hr}\tbr{w}ɛ-ni	&	{\hr\hr}\tbr{w}aky	&	{\hr\hr}\tbr{w}uy	&	{\hr\hr}u\tbr{w}y	\\	
E. Marsela	&	{\hr\hr}\tbr{w}e	&	{\hr\hr}\tbr{uw}ei	&	{\hr\hr}i\tbr{w}ier-ne	&	{\hr\hr}\tbr{w}ak	&	{\hr\hr}\tbr{w}u-liei	&	{\hr\hr}u\tbr{w}	\\	
Serili	&	{\hr\hr}\tbb{b}e	&	{\hr\hr}\tbb{b}ia-liɛ	&	{\hr\hr}\tbb{b}ia-le	&	{\hr\hr}\tbb{b}aʔay-e	&	{\hr\hr}\tbb{b}u-lye	&	{\hr\hr}u\tbb{b}i-e, u	\\	
SE. Babar	&	{\hr\hr}\tbr{w}ey	&	{\hr\hr}\tbr{w}iau	&	{\hr\hr}\tbr{w}ia	&	{\hr\hr}\tbr{w}axay	&	{\hr\hr}\tbr{w}u	&	{\hr\hr}u\tbr{w}y, u\tbb{b}i	\\	
Emplawas	&	{\hr\hr}\tbr{w}e	&	{\hr\hr}\tbr{w}ɛi-li	&	{\hr\hr}\tbr{w}ɛ-lyo	&	{\hr\hr}\tbr{w}aky-o	&	{\hr\hr}\tbr{w}ui-li	&	{\hr\hr}u\tbr{w}y-o	\\	
Imroing	&	{\hr\hr}\tbr{w}ey-e	&	{\hr\hr}\tbr{w}eyeyi	&	{\hr\hr}\tbr{w}ɛ-lye	&	{\hr\hr}\tbr{w}aky-e	&	{\hr\hr}\tbr{w}ui-lyɛ	&	{\hr\hr}u\tbr{w}i-e	\\	
...
With the exception of Serili, the outcome of this
...
Serili has *w/*b > \it{b} and it this could be due to *w > \it{b}
with retention of *b unchanged.
However, other \tsc{Babar} languages also have sporadic instances of *b = \it{b}.
In Emplawas -- for which the most phonetic data is
