...
Makuva [lva] (a.k.a Lovaia) is a highly endangered language of
...
historical phonology of Makuva,
...
and Makuva are given in \trf{04-26}.

%\begin{table}\tcp{PMP to Makuva correspondences (van Engelenhoven 2009:431--434)}{04-26}
...
*s	&	>	&	\it{t}		&		&	*susu > \it{tutu} ‘breast’, *sakay > \it{tai} ‘go up’, *asu > \it{ato} ‘dog’	\\	
...
Makuva shows extensive evidence of final VC > CV metathesis which
...
(e.g. Tetun \it{malus}, \tsc{Meto} \it{manus},
Kisar \it{maluh/malhu}).

While some of the changes in Makuva also take place in some other
languages of \tsc{Southwest Maluku} (e.g.
*t > \it{k} in Kisar,
*s > \it{t} in \tsc{South Babar}),
no other shared innovations unambiguously occur in both Makuva
