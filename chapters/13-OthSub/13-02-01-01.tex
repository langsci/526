...
medial *CC cluster in the region is like the Kambera data noted
...
The Buru data in example \qf{13-09} are updated
...
\lsptoprule
%\tbx{13-09}	&	PMP gloss	&	*-C1C2-	&	Buru -C2-	&	Buru Gloss	\\	\midrule
%\endfirsthead
\tbx{13-09}	&	PMP gloss	&	*-C1C2-	&	Buru -C2-	&	Buru Gloss	\\	\midrule
%\endhead
...
also lose C\sub{1} and retain C\sub{2}, as with the Buru data in example \qf{13-10},
and sporadic other cases such as Dhao *tu\tbr{k}tuk > \it{tu\tbr{k}u} ‘pound,
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{13-10}	&	Gloss	&	*-C1C2-	&	Buru --C1-	&	Gloss	\\	\midrule
%\endfirsthead
\tbx{13-10}	&	Gloss	&	*-C1C2-	&	Buru -C1-	&	Gloss	\\	\midrule
%\endhead
...
\lspbottomrule
\end{tabularx}\mbox{}\\}
\footnotetext{\citet{BlustTrussel2020} assign Buru \it{kisi}
to PCMP *kisi ‘pick out with fingers’,
based on Ngadha \it{kisi} ‘peel or pare off,
strip or draw off with the fingers’; Fordata \it{kisi} ‘pinch,
hold between thumb and forefinger’; Buru \it{kisi-h} ‘remove
(as eye-matter with the finger),
poke out, pry out, de-bone’.
The first bit of the Buru gloss ‘remove eye-matter with finger’
...
the usual pattern -- like Kambera
and Buru -- is to lose the first consonant.
...
Rikou	&		&	{\hr\hr}fu\tbr{f}u-ʔ	&	{\hr\hr}na-ke\tbr{k}o	&		&	{\hr\hr}ni\tbr{n}i-ʔ\\
Bokai	&	{\hr\hr}bu\tbr{b}u	&	{\hr\hr}fu\tbr{f}u-k	&	{\hr\hr}na-ŋe\tbr{ŋ}o	&	{\hr\hr}na-sa-ki\tbr{k}i	&	{\hr\hr}ni\tbr{n}i-k\\
Termanu	&	{\hr\hr}na-sa-bu\tbr{b}u	&	{\hr\hr}fu\tbr{f}u-k	&	{\hr\hr}na-ŋge\tbr{ŋ}o	&	{\hr\hr}na-sa-ki\tbr{k}i, ki\tbr{k}i	&	{\hr\hr}ni\tbr{n}i-k\\
Tii	&		&	{\hr\hr}fu\tbr{f}u-k	&	{\hr\hr}na-ŋge\tbr{ŋg}o	&	{\hr\hr}(na-saki\tbr{k}i ?)	&	{\hr\hr}ni\tbr{n}i-k\\
Dengga	&	{\hr\hr}bu\tbr{b}u	&	{\hr\hr}fu\tbr{f}u-ʔ	&	{\hr\hr}na-ŋge\tbr{ŋg}o	&		&	{\hr\hr}ni\tbr{n}i-ʔ\\
Oenale	&	{\hr\hr}na-sa-ɓu\tbr{ɓ}u	&	{\hr\hr}fu\tbr{f}u-ʔ	&	{\hr\hr}na-ŋge\tbr{ŋg}o	&	{\hr\hr}na-sa-ʔi\tbr{ʔ}i\su{†}	&	{\hr\hr}ni\tbr{n}i-ʔ\\
Kotos Amarasi	&		&	{\hr\hr}ʔfu\tbr{f}uʔ	&		&	{\hr\hr}na-ski\tbr{k}i	&	\hr\cg{(basi, muut)}\\
Molo	&	{\hr\hr}n-bu\tbr{b}u	&	{\hr}‹fu\tbr{f}uk›	&	{\hr}‹na-ke\tbr{k}u›, &	{\hr\hr}na-ski\tbr{k}i	&\\
			&										&											&	{\hr}‹na-ke\tbr{k}o›	&		&	\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†] {Dela has \it{na-saʔiʔi} is ‘use tobacco to rub one’s teeth after chewing betel nut’.}
		\end{tablenotes}
	\end{threeparttable}
\end{adjustbox}
\end{table}
...
Rikou	&	{\hr\hr}se\tbr{s}e	&	{\hr\hr}na-se\tbb{k}e	&	{\hr\hr}tu\tbr{t}u	&	{\hr\hr}to\tbb{ʔ}o	&		&	\\
Bokai	&	{\hr\hr}se\tbr{s}e	&	{\hr\hr}na-ka-se\tbb{ʔ}e	&	{\hr\hr}tu\tbr{t}u	&	{\hr\hr}to\tbb{k}o	&		&	\\
Termanu	&	{\hr\hr}se\tbr{s}e	&	{\hr}(na-ka-)se\tbb{ʔ}e	&	{\hr\hr}tu\tbr{t}u	&	{\hr\hr}to\tbb{k}o	&	{\hr\hr}bi\tbb{ʔ}i	&	{\hr\hr}fi\tbb{ʔ}i\\
Ba{\Q}a	&		&		&		&		&		&	{\hr\hr}fi\tbb{ʔ}i\\
Tii	&	{\hr\hr}se\tbr{s}e	&	{\hr\hr}na-ka-se\tbb{ʔ}e	&	{\hr\hr}tu\tbr{t}u	&	{\hr\hr}to\tbb{k}o	&	{\hr\hr}ɓi\tbb{ʔ}i	&	{\hr\hr}fi\tbb{ʔ}i\\
Dengga	&	{\hr\hr}se\tbr{s}a	&	{\hr\hr}na-ʔa-se\tbb{ʔ}e	&	{\hr\hr}tu\tbr{t}u	&	{\hr\hr}to\tbb{ʔ}o	&	{\hr\hr}bi\tbb{ʔ}i	&	\\
Oenale	&	{\hr\hr}se\tbr{s}a	&	{\hr\hr}na-ʔa-se\tbb{ʔ}e	&	{\hr\hr}tu\tbr{t}u	&	{\hr\hr}to\tbb{ʔ}o	&		&	\\
K. Amarasi	&	{\hr\hr}na-ʔsee\tbr{s}\su{†}	&	{\hr\hr}na-ʔse\tbb{k}eʔ	&	{\hr\hr}n-tu\tbr{t}u	&		&	{\hr\hr}kbi\tbb{t}i	&	{\hr\hr}n-fi\tbb{t}i\\
Molo	&		&	{\hr}‹n(a)-se\tbb{k}e›	&	{\hr\hr}tu\tbr{t}u	&		&	{\hr}‹bi\tbb{t}i›, kabi\tbb{t}i	&	{\hr\hr}n-fi\tbb{t}i\\
Kusa-Manea	&		&		&		&		&	{\hr\hr}bi\tbb{t}i	&	{\hr\hr}fii\tbb{ʔ}\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†]	{Kotos Amarasi \it{na-ʔsees} ‘crowded,
								tight’ has final CV → VC metathesis.
								The unmetathesised form has not yet been attested.
								It could be *[na-ʔsesa] or *[na-ʔsese].}
			\item[‡]	{Termanu \it{na-ka-seʔe,
								seʔe} ‘squeezed/stuck into something’,
								\it{seʔe{\tl}seʔe} ‘completely trapped in something; squeezed, very cramped’.
								Kotos Amarasi \it{na-ʔsekeʔ} ‘force,
			...
			\item[{ǁ}]	{Termanu \it{fiʔi} is glossed as ‘pinch with the tip of
								the fingers or fingernails.
								From that: hold fast with the tips of the fingers’ \citep[135]{Jonker1908},
								Meto reflexes are ‘carry an item hanging below the waist (typically
								hanging from a rope or strap)’.
								**t > \it{ʔ} is not the usual reflex of PRM **t in the Rote languages or Kusa-Manea,
								and may be explicable if we reconstruct medial *tb to Proto-Rote-Meto.}
		\end{tablenotes}
	\end{threeparttable}
\end{adjustbox}
\end{table}
...
show the teeth’ > Proto-Rote-Meto **ni\tbb{s}i-k ‘teeth’
...
the data from Buru,
Dhao, and \tsc{Rote-Meto} show that the other pattern is also
...
and \citet{Edwards2021} has 1,174 Proto-Rote-Meto reconstructions.
...
As yet, we find no patterns involving these medial *CC clusters
