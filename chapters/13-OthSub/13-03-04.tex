...
Malay \it{kepala \tbf{saya}} ‘my head’) from those in the east
that have preposed possessors (e.g.
Kotos Amarasi \it{\tbf{au} ʔnakak} ‘my head’).
...
As a typological areal feature resulting from contact,
...
languages to the east that do (see \crf{ch:BL}).
Banggai and \tsc{Taliabu} have preposed possessors,
