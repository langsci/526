...
\begin{itemize}
	\item	Merger of PMP *ñ/*n > \it{n}: In \srf{13-01-01} it was noted
				...
				*ñ can be elusive; (b) individual languages in several subgroups
				...
				and (e) *ñ is retained unchanged in \tsc{Bima-Lembata} (specifically,
				\tsc{Havu-Dhao}) 
	\item	Weakening of PMP *p > \it{ɸ,
				...
				there are some languages that retain *p = \it{p} in (at least
...
\begin{itemize}
	\item	\tsc{Sula-Buru} + \tsc{Ambon-Seram} = Central Maluku: *a/*-ay
				> \it{a}; *n/*ñ > \it{n}.
	...
	\item	\tsc{Ambon-Seram} + \tsc{Seram-Tanimbar-Bomberai} = Maluku-Bomberai:
				*a/\mbox{*-ay} > \it{a}; *d/*z > **d: These two mergers together may
				...
				In \tsc{Ambon-Seram} *d/*z > **r,
				while in STB *d/*z > **d,
				at least word initially (see \srf{07-03-03}).
	...
	\item	Banda + \tsc{Ambon-Seram}? Banda + \tsc{Seram-Tanimbar-Bomberai}?:
				Banda shares some features in its historical phonology with both
				subgroups, and is also divergent from both (see \crf{ch:Ban}).
				The shared mergers of PMP nasals *ŋ/*n/*ñ > \it{n}
				and *d/*z > \it{r} could link it with \tsc{Ambon-Seram},
				but the different mergers involving *R,
				and the different behaviour of *a make such a combination difficult.
				Lexically, Banda is equally (un)related to languages in both
				...
				There is no agreement among investigators as to how Banda should be classified.
...
As yet there appears to be no evidence in the archaeological
