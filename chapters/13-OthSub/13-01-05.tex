...
\begin{itemize}
	...
	\item	6-vowel systems (some with schwa \it{ə}) in a number of
				\tsc{Bima-Lembata} languages are discussed in \srf{03-02-01} and \srf{03-03-01}.
	\item	Just outside the target region,
				several SHWNG languages have 7-vowel systems with \it{i,
				ɛ, e, a, ɔ, o, u}.
	\item	Some \tsc{East Bomberai} languages such as Irarutu also
	...
	\item	The Tarangan languages in the \tsc{Aru} subgroup also have
				a 7-vowel system, with contrasting /e/,
				/ɛ/ and /o/, /ɔ/ (see \ref{ch:Aru}).
	\item Some languages \tsc{Southwest Maluku} also have multiple
				mid vowels, such as Emplawas contrasting /e/ with /ɛ/.
				(But no /o/ vs. /ɔ/ contrast.)
	\item	As shown in the following discussion,
	...
	\item	As shown in \trf{13-03}
				...
				*aya > \it{ea, ae}).
				...
				They got there via different paths.\footnote{
						For example,
						in \tsc{Sula-Buru} languages Buru
						and Lisela, PMP *ə > \it{e}.
						In \tsc{Taliabu} languages Taliabu
						and Soboyo, *ə > \it{o}, but *-əj > \it{o}, \it{e}.
	...
	\item	The unconditioned split in PMP *u > \it{u,
				...
				For example in the \tsc{Ambon-Seram} subgroup,
	...
	\item	There are several cases of high vowels (*i,
				*u) lowering (to \it{e, o}) before PMP *R.
				This is found in parts of \tsc{Bima-Lembata} (\trf{03-28}),
				\tsc{Rote-Meto} (\trf{04-04}; \citealp[84f]{Edwards2021}),
				and \tsc{Central Timor} (\trf{05-11}).
