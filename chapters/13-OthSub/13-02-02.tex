...
He also observed a similar phenomenon in Kei,
\tsc{Teor-Kur} (\tsc{Seram-Tanimbar-Bomberai} languages), and Gorontalo (northern Sulawesi).

\citet{Dyen1962} added an additional sound *W to the \tsc{PAn}
consonant inventory largely in response to this word-initial
phenomenon in data from languages in Maluku and Chamorro.
\citet{ChlenovSirk1973} saw an unexpected initial \it{h} in languages
around Ambon and Seram and concluded it was a prothetic sound that precedes
...
He says “various word-initial irregularities in Central Maluku
...
the occurrence of initial \it{w-} in certain Central Maluku languages” \citep[130]{Collins1983}.
But “the occurrence of prothetic segments in Central Maluku languages
cannot constitute evidence in any subgrouping argument involving
Central Maluku and Oceania because it is a retention
...
in PCM.” (\citet[131]{Collins1983}; PCM = Proto-Central Maluku,
...
We initially focus on \tsc{Ambon-Seram} languages
...
For example, we note that in modern Malay \it{si} is commonly
...
in PAN or some language ancestral to both Central Maluku
...
in \tsc{East Piru Bay} languages are a retention of PMP *q.
The data for Kamarian,
Rumakai, Haruku, and Saparua in \trf{13-09} are repackaged
...
Buru				&	{\hr}alu								&	{\hr}ata-n 						&	‘spleen’	&	{\hr}iso							&	{\hr}ule ‘maggot’	&	\cg{(ŋee-n)}\\
Kamarian		&	{\hr}haru					{\crd}&	\cg{(hatuʔa)}					&						&	‹hisu›					{\crd}&	‹hure›			{\crd}&	{\hr}hiru{\crd}\\
Rumakai			&	{\hr}haru					{\crd}&	{\hr}ata							&						&	{\hr}ha-hisur-e	{\crd}&	‹hure›			{\crd}&	{\hr}hiru{\crd}\\
Haruku			&	‹haru›						{\crd}&	‹hata›					{\crd}&						&	{\hr}isur							&	\cg{(lade)}				&	{\hr}iru\\
Saparua			&	‹halu›						{\crd}&	{\hr}ata							&						&	{\hr}isur-o						&	{\hr}ure-ure-o		&	{\hr}irim\\
Alune				&													&	{\hr}ata							&						&	{\hr}isu							&	{\hr}ule ‘maggot’	&	{\hr}inu bata-i\\
Wemale			&	{\hr}halu					{\crd}&	{\hr}yata				{\cbl}&						&	{\hr}hisu				{\crd}&	{\hr}ulu-te				&	{\hr}ili\\
Sepa				&	{\hr}ana alu						&	\cg{(hule)}						&						&	{\hr}isu							&	\cg{(hiayalo)}		&	{\hr}iri-n\\
Tamilou			&	\cg{(hatu anan)}				&	\cg{(hule)}						&						&	{\hr}isu							&	\cg{(hiyalo)}			&	{\hr}uli \it{(met.)}\\
Kowiai			&	\cg{(lesun-e ana-i)}		&	{\hr}lata\su{†}	{\cor}&						&												&										&	\\
Yamdena			&	{\hr} alu								&	{\hr}ata-ŋw						&						&												&	\cg{(kbwatar)}		&	{\hr}iri-ŋw\\
Kei Kecil		&	\cg{(luhun yana-n)}			&	{\hr}yata-n			{\cbl}&	‘heart’		&	\cg{(ror)}						&	\cg{(laŋar)}			&	{\hr}niru-n\\
Fordata			&	\cg{(saʔa)}							&	{\hr}yata-n			{\cbl}&						&												&	{\hr}ular ‘caterpillar’	&	{\hr}niru-n\\
Onin				&													&	{\hr}yata-n			{\cbl}&						&												&		&	\\
Uruangnirin	&													&	{\hr}lata-n\su{†}	{\cor}&					&												&		&	\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†] {The \it{l}-onsets in Kowiai
							and Uruangnirin are due to regular **y > \it{l} (see \srf{11-03-02},
							\srf{11-05-01}).}
		\end{tablenotes}
	\end{threeparttable}
\end{adjustbox}
...
Similarly, \citet{Blust1981} in “The Soboyo reflexes of PAN *S”
and \citet{Collins1981} assert that some h-onsets in some words
in Soboyo and some languages of Ambon are a retention of \tsc{PAn} *S (PMP *h).
...
Buru 				&	{\hr}asu					&	\mc{2}{l}{{\hr}ate-t}				&	{\hr}lafu-n				{\cor}&	{\hr}apu					&	{\hr}aa-n					&	{\hr}aŋin				\\	\midrule
Boano				&										&														&	&	{\hr}lahuʔi				{\cor}&										&	{\hr}ala-					&									\\
Asilulu			&	{\hr}asu					&	\mc{2}{l}{\cg{(kaha)}}			&	{\hr}sahut							&	\cg{(kapul)}			&	{\hr}ala-n				&	{\hr}anin				\\
Haruku			&	{\hr}asu					&	\mc{2}{l}{{\hr}ate-o}				&	\cg{(hau mata-e)}				&	\cg{(aheti-e)}		&	{\hr}ala					&	{\hr}anin-o			\\
Saparua			&	{\hr}asu-ro				&	\mc{2}{l}{{\hr}ato-o}				&													&	{\hr}haullo	{\crd}&	{\hr}wala		{\cye}&	{\hr}anin-o			\\
Amahai			&	{\hr}asu-lo				&														&	&	\cg{(hau maa-no)}				&	\cg{(lokal-o)}		&	{\hr}wala		{\cye}&	{\hr}anin-o			\\
Paulohi			&	{\hr}asu					&	\mc{2}{l}{{\hr}ate}					&	\cg{(afu mata-i)}				&	\cg{(losa)}				&	{\hr}ala					&	{\hr}anin-e			\\
Alune				&	{\hr}asu					&	\mc{2}{l}{{\hr}ate}					&	\cg{(ndopo-ne)}					&	\cg{(asai)}				&	{\hr}ala-mu				&	\cg{(balat-e)}	\\
N. Wemale		&	{\hr}yasu		{\cbl}&	{\hr}yate-ye	{\cbl}			&	&	\cg{(mutu-i)}						&	\cg{(kaun-e)}			&	{\hr}yala		{\cbl}&	{\hr}yanin-e	{\cbl}\\
S. Wemale		&	{\hr}yasu		{\cbl}&	{\hr}yate			{\cbl}			&	&													&										&	{\hr}ala-mu				&											\\
Sepa				&	{\hr}wasu		{\cye}&	\mc{2}{l}{\cg{(laun-o)}}		&	\cg{(hau mata-n)}				&	\cg{(losa)}				&	{\hr}wala-n	{\cye}&	{\hr}yanin-o	{\cbl}\\
Tehoru			&	{\hr}wasu		{\cye}&														&	&													&	{\hr}yafi-o	{\cbl}&	{\hr}wala-n	{\cye}&	{\hr}yann-o		{\cbl}\\
Tamilou			&	{\hr}wasu		{\cye}&	\mc{2}{l}{\cg{(laun-o)}}		&	\cg{(hau mata-n)}				&	{\hr}haul-o	{\crd}&	{\hr}wala-n	{\cye}&	{\hr}yaann-o	{\cbl}\\
Yalahatan		&	{\hr}asu					&	\mc{2}{l}{{\hr}ateaa}				&	{\hr}laho-ne						&	{\hr}ahotoi				&	{\hr}ara-i				&	\cg{(yolil-e)}			\\
S. Nuaulu		&	{\hr}asu					&	\mc{2}{l}{{\hr}ainata-e}		&	{\hr}tapu-ne						&										&	{\hr}ana nohu-e		&	\cg{(ihut-e)}				\\
Manusela		&	{\hr}wasu-a	{\cye}&	{\hr}wate-a	{\cye}				&	&	{\hr}lahu-a				{\cor}&										&	{\hr}aha-nia			&	{\hr}anino-a				\\
Liana-Seti	&	\cg{(inauwa)}			&	\mc{2}{l}{{\hr}ata-lanːe}		&	{\hr}laf-na				{\cor}&	\cg{(loosa)}			&	{\hr}ala-m				&	\cg{(simala)}				\\	\midrule
Bobot				&	{\hr}yasw		{\cbl}&	\mc{2}{l}{{\hr}yata}				&													&										&	{\hr}yala-n	{\cbl}&	{\hr}yakin		{\cbl}\\
Masiwang		&	{\hr}yai\su{‡}{\cbl}&	\mc{2}{l}{\cg{(ilan)}}		&	{\hr}yafh tai-n					&	{\hr}yavis	{\cbl}&	{\hr}yala-n	{\cbl}&	{\hr}yakin		{\cbl}\\
Geser				&	{\hr}asu					&	\mc{2}{l}{\cg{(barém)}}			&	{\hr}afi korus					&	\cg{(lodar)}			&	{\hr}ar						&	{\hr}aŋin						\\
Kowiai			&	\cg{(aɸuna)}			&	\mc{2}{l}{\cg{(barem)}}			&	{\hr}abuba							&	{\hr}laɸor	{\cor}&	{\hr}laraʔai{\cor}&	\cg{(lor)}					\\
Watubela		&										&	\mc{2}{l}{{\hr}kataf}				&													&										&	\cg{(kakelan)}		&	{\hr}aŋin						\\
Yamdena			&	{\hr}asu					&	\mc{2}{l}{{\hr}dafat \it{(met.)}}		&	{\hr}afu, afu-ny				&	{\hr}yafur	{\cbl}&	\cg{(kekan)}			&	\cg{(mnaur)}				\\
Kei Kecil		&	{\hr}yahaw	{\cbl}&	\mc{2}{l}{{\hr}rafat \it{(met.)}}		&	{\hr}haruv \it{(met.)}	&	{\hr}yafur	{\cbl}&	\cg{(kakeə-n)}		&	\cg{(niit, yaran)}	\\
Fordata			&	{\hr}yaha		{\cbl}&	\mc{2}{l}{{\hr}rafat \it{(met.)}}		&	{\hr}kiavu							&	{\hr}yafur	{\cbl}&	\cg{(demi-n)}			&	\cg{(nait)}					\\
Sekar				&	{\hr}yasi		{\cbl}&							&								&													&	{\hr}yafer	{\cbl}&										&	\cg{(dirig)}\\
Uruangnirin	&	{\hr}lasi		{\cor}&							&								&													&	{\hr}lafur	{\cor}&										&	\cg{(dirin)}\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†]	{\citet{BlustTrussel2020} list *labu ‘ashen,
								...
								Buru \it{lafu} ‘ashes’ and Kelabit \it{labuh} ‘grey,
								colour of darker clouds’.
								The Buru form only occurs with suffixes \it{lafu-n} and \it{lafu-t}.
			...
			\item[‡]	{Masiwang: unexplained loss of *s; final *u{\#} > \it{i} is regular.}
		\end{tablenotes}
	\end{threeparttable}
\end{adjustbox}
\end{table}
...
Buru				&	{\hr}asa-n					&	\cg{(bana)}						&	{\hr}kami				&	{\hr}kau				&	{\hr}kasa						&	{\hr}kawil		\\	\midrule
Kelang			&											&	{\hr}au								&									&	{\hr}hai	{\crd}&	{\hr}hasa-e		{\crd}&								\\
Asilulu			&	{\hr}asa-na					&	{\hr}au								&	{\hr}ami				&	{\hr}ai					&	{\hr}ʔasa						&	{\hr}ahil			\\
Alang				&	{\hr}hasa-na	{\crd}&												&									&									&											&								\\
Kairatu			&	{\hr}hasa-i		{\crd}&												&									&									&											&								\\
Haruku			&											&	{\hr}hau				{\crd}&	{\hr}ami				&	{\hr}ai					&											&								\\
Saparua			&											&	{\hr}hau				{\crd}&	{\hr}ami				&	{\hr}ai					&											&	{\hr}hahillo	{\crd}\\
Amahai			&	\cg{(pa-kae)}				&	{\hr}hau				{\crd}&	{\hr}ami				&	\cg{(uwon)}			&	{\hr}aka						&	{\hr}ahir-olo	\\
Paulohi			&											&	{\hr}afu							&	{\hr}ami				&	{\hr}ai					&	{\hr}asa						&	{\hr}ahir-e		\\
Alune				&	{\hr}sasa-e		{\cdr}&	{\hr}au-e							&	{\hr}ami				&	{\hr}ai, ai-ni	&	{\hr}asakwe					&	{\hr}ahil-e mata-i\\
Watui				&											&												&									&									&	{\hr}wasaʔwe	{\cye}&								\\
Naka{\Q}ela	&											&												&									&									&	{\hr}kwasake	{\cye}&								\\
N. Wemale		&	{\hr}sasa-e		{\cdr}&	{\hr}yahu				{\cbl}&	{\hr}yami	{\cbl}&	{\hr}yai	{\cbl}&	{\hr}yasa			{\cbl}&								\\
S. Wemale		&											&	{\hr}yahu				{\cbl}&									&	{\hr}yai	{\cbl}&	{\hr}yasa-i pul{\cbl}&{\hr}yapil-e	{\cbl}\\
Sepa				&											&	{\hr}hau				{\crd}&	{\hr}yam	{\cbl}&	{\hr}yai	{\cbl}&	{\hr}wasa			{\cye}&	{\hr}yahil-o	{\cbl}\\
Tehoru			&											&	{\hr}yafu				{\cbl}&	{\hr}yam	{\cbl}&	{\hr}yai	{\cbl}&	{\hr}wasa			{\cye}&	{\hr}yahil-o	{\cbl}\\
Tamilou			&											&	{\hr}hau				{\crd}&	{\hr}yam	{\cbl}&	{\hr}yai	{\cbl}&	{\hr}wasa			{\cye}&								\\
Yalahatan		&	{\hr}asa-i					&	\cg{(usa)}						&	{\hr}(y)am{\cbl}&	{\hr}ai					&	{\hr}wasa			{\cye}&	{\hr}ahir-e		\\
S. Nuaulu		&	{\hr}asa-e					&	\cg{(usa)}						&	{\hr}ami				&	{\hr}ai					&	{\hr}wasa			{\cye}&	{\hr}yahil-o	{\cbl}\\
Manusela		&	\cg{(nake-ni)}			&	{\hr}wouw-a			{\cye}&	{\hr}ami				&	{\hr}ai					&	{\hr}hasa			{\crd}&	\cg{(kasaha)}	\\
Liana-Seti	&	{\hr}yasa-na	{\cbl}&	{\hr}waha				{\cye}&	{\hr}ʔam				&	{\hr}ai-a				&	{\hr}asa-ʔa					&	{\hr}ail-a		\\	\midrule
Bobot				&	{\hr}yasa-n		{\cbl}&	{\hr}yafw				{\cbl}&	{\hr}am					&	{\hr}ai					&	{\hr}asa-						&								\\
Masiwang		&	{\hr}yasa-n		{\cbl}&	{\hr}yah, yaaf	{\cbl}&	{\hr}im-				&	{\hr}ai					&	{\hr}asa						&								\\
Geser				&											&	{\hr}ahi, afi					&	{\hr}ami				&	{\hr}(k)ai			&											&								\\
Kowiai			&	\cg{(laŋgus)}				&	{\hr}laɸ				{\cor}&	{\hr}am					&	{\hr}ai					&	{\hr}asa						&	\cg{(ises)}		\\
Watubela		&											&	{\hr}afi							&									&									&											&								\\
Yamdena			&	\cg{(ŋeŋ-ar)}				&	{\hr}au								&	{\hr}kam(i)			&	{\hr}ka					&	{\hr}as-e						&	\cg{(irit)}		\\
Kei Kecil		&	{\hr}vaha-n		{\cbl}&	{\hr}yaf				{\cbl}&	{\hr}ʔam				&	{\hr}ay					&	{\hr}aha						&	{\hr}ail			\\
Fordata			&	{\hr}ala-n					&	{\hr}yafu				{\cbl}&	{\hr}ami				&	{\hr}aa					&	{\hr}aha						&	\cg{(ihi)}		\\
Onin				&											&	{\hr}yafi				{\cbl}&	{\hr}ami				&									&											&								\\
Sekar				&											&	{\hr}yafi				{\cbl}&	{\hr}yami	{\cbl}&									&											&								\\
Uruangnirin	&											&	{\hr}lafi				{\cor}&	{\hr}ami				&									&											&								\\
Arguni			&											&	{\hr}iyáf				{\cbl}&	{\hr}mbami{\cdr}&									&											&								\\
Bedoanas		&											&	{\hr}iaf				{\cbl}&	{\hr}mbami{\cdr}&									&											&								\\
Erokwanas		&											&	{\hr}iaf				{\cbl}&	{\hr}mbemi{\cdr}&									&											&								\\
		\lspbottomrule
	\end{tabular}
\end{adjustbox}
\end{table}
...
\begin{itemize}
		...
		\item	Some individual languages (the horizontal rows) seem to
					...
					For example, in our data Wemale,
					Bobot, and Masiwang seem to use \it{{\#}y} on (almost) all words
					that have irregular onsets.
					And Kowiai and Uruangnirin use \it{{\#}l} on all words that have
					irregular onsets, but this is due to a regular **y > \it{l}
					sound change in Uruangnirin (cf.
					*buqa\tbr{y}a > \it{pua\tbr{l}a} ‘crocodile’).
		\item	Other individual languages,
					such as Sepa, Tehoru,
					and Tamilou (\tsc{East Littoral},
					...
					a packet, such as North and South Wemale, or \tsc{East Littoral},
...
Central Maluku languages can be explained if we assume that these
...
“In these [\tsc{East Piru Bay}] languages,
...
*suja ‘spike trap’, *susu ‘female breast’, *siwa ‘nine’,
...
\tsc{East Piru Bay} languages in Maluku reflect a *su nominal marker
reconstructed for Proto-Philippines, and that therefore *su should be reconstructed at a level ancestral
to both Proto-Philippines and Central Maluku.
...
onsets are found sporadically in several subgroups: \tsc{Sula-Buru}, \tsc{Ambon-Seram}, and \tsc{Seram-Tanimbar-Bomberai}.
In \tsc{Timor-Babar} Idate, irregular \it{y}-onsets are found -- some
involving the same words that have irregular onsets in \tsc{Ambon-Seram}
...
languages \tsc{Teun-Nila-Serua} -- some involving the same words
that have irregular onsets in \tsc{Ambon-Seram}.
...
some involving the same words that have irregular onsets in \tsc{Ambon-Seram},
...
enough to be useful for subgrouping at lower levels for \tsc{Teun-Nila-Serua}
(\srf{04-06-04}, particularly \trf{04-40}), and for subgrouping in \tsc{Aru} (\srf{06-01-03}).
We do not find the irregular onsets in \tsc{East Piru Bay} languages
in \tsc{Ambon-Seram} to be systematic enough to be convincing
...
In \tsc{Sula-Buru}, Buru and Lisela are the only languages that
show a \it{y}-onset in the \tsc{1sg} pronoun \it{yako, ya}.
Since the other \tsc{Sula-Buru} languages (Mangole \it{aku},
Sanana \it{ak}, Ambelau \it{au-ni}) do not have such an onset,
...
In \tsc{Sula-Buru}, \tsc{Ambon-Seram}, and \tsc{Seram-Tanimbar-Bomberai}
...
the latter is involved in at least some languages.
