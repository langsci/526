...
and PCEMP **pa(Ra)- ‘reciprocal’\footnote{
		...
		For example, one function of Malay \it{bər-} is ‘reciprocal’,
		...
		of the morphology of Tagalog and Bahasa Indonesia.
...
\tsc{Bima-Lembata}	&	*ma-	&	*pa-	&	*paRa-\\
\tsc{Timor-Babar}		&	*ma-	&	*(p)a-	&	{\hr}\it{apa-, hak-, wa-}\\
\tsc{Central Timor}	&	*ma-	&	*a-	&	*a- (?)\\
\tsc{Aru}						&	{\hr}\it{ma-}	&	{\hr}\it{ka-}	&	{\hr}\it{r-}\\
STB									&	*ma-	&	*pa-	&	*paR-\\
Banda								&	\it{-m(a)-, mo-}	&	{\hr}\it{mbo-, (fo-)}	&	\\
\tsc{Ambon-Seram}		&	*ma-	&	*pa-	&	\it{\cg{(baku)}}\\
...
\lsptoprule
%\tbx{13-19}	&	Dhao	&	Dhao gloss			&		\\	\midrule
%\endfirsthead
\tbx{13-19}	&	Dhao	&	Dhao gloss	&		\\	\midrule
%\endhead
...
Example \qf{13-20} shows the causative prefix \it{pa-} in Dhao
and example \qf{13-21} shows the homophonous reciprocal prefix
\it{pa-} in Dhao.\footnote{
		...
		“Dhao has only one derivational affix; that is the prefix is \it{pa-}.
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{13-20}	&	Dhao	&	gloss	&	Dhao	&	gloss	\\	\midrule
%\endfirsthead
\tbx{13-20}	&	Dhao	&	gloss	&	Dhao	&	gloss	\\	\midrule
%\endhead
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{13-21}	&	Dhao	&	gloss	&	Dhao	&	gloss	\\	\midrule
%\endfirsthead
\tbx{13-21}	&	Dhao	&	gloss	&	Dhao	&	gloss	\\	\midrule
%\endhead
	...
	&		&		&	pa-ʧəri	&	separate from each other, divorce (cf. Malay \it{cərai})	\\
	&		&		&	pa-katoo	&	curse each other	\\
\lspbottomrule
\end{tabularx}\mbox{}\\}

As retentions rather than innovations,
...
such as Malay \it{-kan},
and Tukang Besi \it{-ako} \citep{Donohue1999a},
...
As a retention rather than an innovation,
...
\tsc{Seram-Tanimbar-Bomberai}, and \tsc{Timor-Babar} (especially \tsc{Southwest Maluku}.\footnote{
		...
		Wolio and Chamorro, as well as for Oceanic languages Tolai, Hoava and Roviana.
...
%\endhead
						&	TB				&	Roma		&	\<ny\>/\<ɲ\>	&	sinin 				&	sing		\\	\hhline{~}
						&						&					&								&	s\<ny\>inin 	&	song		\\
						&	TB				&	Wetan		&	\<ini\>				&	wali					&	answer (v.)	\\	\hhline{~}
						&						&					&								&	w\<ini\>ali		&	answer (n), response	\\
						&	STB				&	Yamdena	&	\<ny\>/\<ɲ\>	&	tasiŋ					&	cry (v.)		\\	\hhline{~}
						&						&					&								&	t\<ny\>asiŋ		&	(act of) crying	\\
						&	STB				&	Fordata	&	\<n\>					&	vuat					&	load (v.)		\\	\hhline{~}
						&						&					&								&	v\<n\>uat			&	cargo	\\
...
language Buru, which derives deverbal nouns (including abstract nouns) from
active verb roots only,\footnote{
		The ability (or not) to take \it{en-} is one of the morphosyntactic
		tests for distinguishing active from non-active verb roots in Buru.}
...
Prefixes added to V-initial roots in Buru trigger palatalization,
...
\tsc{Flores-Lembata} node of \tsc{Bima-Lemabata}.
There are several words which
occur with medial \it{n}.
Examples from \citet{Fricke2019} include:
*salaq > Kalikasa \it{s\tbr{n}alak} `wrong',
*ma-həyaq > Alorese \it{m\tbr{n}iaŋ} `shy, ashamed',
and Sanskrit \it{sama} > Kalikasa \it{s\tbr{n}amaŋ} `same'.
...
in \tsc{Sula-Buru}, Taliabu, \tsc{Ambon-Seram}, and  \tsc{Timor-Babar} (both in \tsc{Rote-Meto}
...
function, as does \it{-r} in Kemak.
...
\tsc{Ambon-Seram} and also in \tsc{Rote-Meto} languages,
...
much like English \it{-er} (\it{farmer,
...
Relativisers flagging role are illustrated for the \tsc{Ambon-Seram}
language South Nuaulu \citep[61--63,
77f, 164--170]{Bolton1990} in example \qf{13-22},
and in example \qf{13-23}
for the \tsc{Sula-Buru} language of Buru \citep[183, 429--436]{Grimes1991c},
...
llll}
\lsptoprule
%\tbx{13-22}	&	Nuaulu	&	gloss	&	relativised	&	gloss	\\	\midrule
%\endfirsthead
\tbx{13-22}	&	Nuaulu	&	gloss	&	relativised	&	gloss	\\	\midrule
%\endhead
...
\begin{exe}\setcounter{xnumi}{23}
	\ex{\gll	Petu du pefa hum.tapa dii ep-sia-k tu {\brac} kaka-wai-t rua \tbf{ha} dii du ba ep-mata dii \bracr{NP}\\
			...
			\glt	‘Then they burned down the hunting lodge together with [those two brothers whom they had killed.]’ \jambox*{(Buru: relative clause)}
						\label{ex:13-24}
\end{exe}

The Buru relativiser can be marked according to the plurality
...
\begin{exe}
	\ex{\gll	Petu geba \tbf{ha-r} dii, ba poto nunu-r ʧeŋke-r dii, {\ldots}\\
			...
			\glt	‘Then those people whose cloves got burned, {\ldots}’ \jambox*{(Buru: relative clause)}
						\label{ex:13-25}
\end{exe}
...
(In \trf{13-13} (\it{yaŋ}) indicates a Malay loan.)
...
%\begin{adjustbox}{width=\textwidth}
	...
	Ngadha	&	da, (yaŋ)	&	\tsc{rel}	&	\tsc{BL}	&	\citet[44, 100, 145f]{Djawanai1983}	\\	
	Keo	&	ta	&	\tsc{rel}	&	\tsc{BL}	&	\citet[409--412]{Baird2002}	\\	
	Lio	&	eo	&	\tsc{rel}	&	\tsc{BL}	&	\citet{Elias2018}	\\	
	Solor Lamaholot	&	pe	&	\tsc{rel}	&	\tsc{BL}	&	\citet[196ff]{Kroon2016}	\\	
	Kalikasa	&	(yaŋ)	&	\tsc{rel}	&	\tsc{BL}	&	\citet[77]{Fricke2019}	\\	
	Laboya	&	ha-, ka-	&	\tsc{rel}	&	\tsc{BL}	&	\citet{Verdizade2019a}	\\	
	Kambera	&	ma-, pa-	&	\tsc{rel}	&	\tsc{BL}	&	\citet[316f]{Klamer1998a}	\\	
	Dhao	&	ɖ͡ʐu	&	\tsc{rel}	&	\tsc{BL}	&	\citet{GrimesRanohAplugi2008}	\\	\hhline{~}
		&	ka ɖ͡ʐu	&	contr. focus	&		&		\\	
	Havu	&	do	&	\tsc{rel}	&	\tsc{BL}	&	\citet{Grimes2008}	\\	
	Dela	&	mana, fo	&	\tsc{rel}	&	\tsc{TB}	&	\citet[401ff]{Tamelan2021};\\		\hhline{~}
				&						&						&						&	only \it{fo} for non-subject arguments	\\	
%	Bilbaa	&	lia	&	\tsc{rel}	&	\tsc{TB}	&	\citet[293]{Edwards2021}	\\	
	...
	Roi{\Q}is Amarasi	&	heʔ	&	\tsc{rel}	&	\tsc{TB}	&	Edwards and Grimes fieldnotes	\\		\hhline{~}
		&	es heʔ	&	contr. focus	&		&		\\		\hhline{~}
		&	ka- {\ldots} -t	&	role, \tsc{nmlz}	&		&	not \tsc{rel}	\\	
	Helong	&	in	&	\tsc{rel}	&	\tsc{TB}	&	\citet{UBB2012a}; 	\\	\hhline{~}	
		&	man	&	role	&		&	Grimes fieldnotes	\\	
	Tetun	&	mak, ma,	&	\tsc{rel}, role	&	\tsc{TB}	&	\citet[70-78]{vanKlinken1999}; Grimes fieldnotes;	\\		\hhline{~}
		&	nebee	&	\tsc{rel}	&		&	 (variant: \it{maka})	\\	
	Galolen	&	be,	&	\tsc{rel}	&	\tsc{TB}	&	\citet{CristoReiGrimes2011}	\\		\hhline{~}
		&	mak	&	role	&		&		\\	
	Dadu{\Q}a	&	namee	&	\tsc{rel}	&	\tsc{TB}	&	\citet{Penn2006}	\\	
	Raklungu	&	maʔ, manei	&	\tsc{rel}, role	&	\tsc{TB}	&	Grimes fieldnotes	\\	
	Luang	&	maka k-	&	\tsc{rel}	&	\tsc{TB}	&	\citet[117ff]{TaberTaber2015}	\\		\hhline{~}
		&	ha	&	\tsc{rel}	&		&		\\	
	Selaru	&	ma-	&	\tsc{rel}	&	\tsc{TB}	&	\citet{Coward2005}	\\	
	Kemak	&	naba ta	&	\tsc{rel}	&	\tsc{CT}	&	Celcia Elliot (pers. comm.)	\\	
	S. Mambae	&	bae ke,	&	\tsc{rel}	&	\tsc{CT}	&	\citet{GrimesMarcalFereira2014}	\\		\hhline{~}
		&	fe, ke	&	\tsc{rel}	&		&		\\	
	Sanana	&	(yaŋ)	&	\tsc{rel}	&	\tsc{SB}	&	\citet[330]{Bloyd2020}	\\	
	Buru	&	ha	&	\tsc{rel}	&	\tsc{SB}	&	\citet[183, 429--436]{Grimes1991c}	\\		\hhline{~}
		&	ka	&	role	&		&		\\	
	Larike	&	(yaŋ)	&	\tsc{rel}	&	\tsc{AS}	&	\citet{LaidigLaidig1991}	\\	
	Asilulu	&	(yaŋ)	&	\tsc{rel}	&	\tsc{AS}	&	\citet[63]{Collins2003a}	\\		\hhline{~}
		&	maka-	&	role	&		&		\\	
	Sou Amana Teru	&	(yaŋ)	&	\tsc{rel}	&	\tsc{AS}	&	\citet{Musgrave2010}	\\	
	Yalahatan	&	re	&	\tsc{rel}	&	\tsc{AS}	&	Beckley n.d.	\\	
	S. Nuaulu	&	(w)ai, (w)a		&	\tsc{rel}	&	\tsc{AS}	&	\citet[61--63, 77--78, 164--170]{Bolton1990};\\	\hhline{~}
						&								&						&						&	\it{(w)ai} human; \it{(w)}a non-human	\\	
	Dobel	&	ne	&	\tsc{rel}	&	\tsc{Aru}	&	\citet[171--177]{Hughes2000}	\\	
	Banda	&	mana	&	‘which’	&	Banda	&	\citet[564]{CollinsKaartinen1998}	\\	
	Kei Kecil	&	en	&	\tsc{rel}	&	STB	&	\citet{Travis2019}	\\		\hhline{~}
		&	maŋ	&	role	&		&		\\	
	Kowiai	&	ima	&	\tsc{rel}	&	STB	&	\citet[204, 230, 241]{WalkerWalker1991}	\\	
		\lspbottomrule
	\end{tabular}
\end{adjustbox}
\end{table}
...
as illustrated with data from Buru in \trf{13-00}.
...
\lsptoprule
Structure							&	Buru								&	Gloss						&Function								&	Stem		&	Stem gloss	\\	\midrule
