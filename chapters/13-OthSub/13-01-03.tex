...
\tsc{Ambon-Seram}, and STB, and part of what connects it with \tsc{Eastern Celebic}.
...
Banda			&	\hr\it{a, e}						&	\hr\it{a}							&	\hr\it{u, o}									&	\hr\it{e}					&	\hr\it{a, o}				\\
...
As mentioned briefly in \srf{01-07},
...
For example, looking at patterns of sound change in Bima,
Manggarai, Kambera and Havu, data provided in \citet[92]{Blust2008}
show that none of them fit the pattern of the glide being lost
and the vowel retained in all the vowel-glide sequences.
Buru mostly follows the truncation pattern: *-ay > \it{a},
*-aw > \it{a}, *-uy > \it{u, o}.
But the reflexes of *-iw are not clear in Buru.
For example, PMP *kahiw > Buru \it{kau} ‘tree,
wood’, but PMP *baliw ‘dual division,
moiety [\ldots] opposite side or part; partner,
friend, enemy’
> Buru \it{in-fali-n} ‘mother’s younger sister’.
At the higher level node of the \tsc{Sula-Buru} subgroup to which
Buru belongs, we find: *-ay > \it{a}; *-aw > \it{a}; *-uy > \it{u,
o, i,} {\0}; *-iw > \it{i, u}.
...
as in Malay *pajay > \it{padi} ‘rice plant’,
*babuy > \it{babi} ‘pig’,
...
For example, in Tii (a \tsc{Timor-Babar} language of Rote),
...
llll}
\lsptoprule
%\tbx{13-04}	&	*gloss	&	PMP	&	Tii	&	local gl.	\\	\midrule
%\endfirsthead
\tbx{13-04}	&	*gloss	&	PMP	&	Tii	&	local gl.	\\	\midrule
%\endhead
...
position are \tsc{Sula-Buru}, \tsc{Ambon-Seram}, Banda, and \tsc{Seram-Tanimbar-Bomberai} which
all share *-ay > \it{a}.
Yet the same change in Banda must have come about by parallel
...
any evidence that final *-ay > \it{a} would have for such a subgroup.\footnote{
		There is some evidence that the extinct Batumerah language,
		formerly spoken in the present day location of Ambon city,
		...
		corresponding to \it{-e} in other \tsc{Ambon-Seram} languages.}
