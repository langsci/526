...
As yet, we have found no evidence to unify the eight Wallacean
...
For instance, languages as far east as
Arguni (STB, Papua) retain the penultimate
vowel of *qalu-hipan > **qalipan \it{arifen} `centipede',
as does Hoti of eastern Seram with \it{urial} `centipede'.

In \srf{11-03-01} we noted that Watubela preserves PMP *q in
...
at least two millennia (see \srf{02-02-01}).
