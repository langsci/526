...
For example, Dela (western Rote) is predominantly prepositional,
...
As is typical with predominantly head-marking languages,
...
and complementisers, as well as verbs.\footnote{
		...
		of words in Kotos Amarasi as verbs.}
...
\newpage
\begin{exe}
	\ex{Dela [row]\label{ex:02-29}}\jambox*{\citep{UBB2020a}}\vspace{-1mm}
	\sn{\gll	ɓasa ma, ana lao na-kandoo seriʔ rulu \tbf{n-eu}\\
						after and \tsc{3sg.nom} go \tsc{3sg}-continue side east \tsc{3sg}-go\\
			\glt	`After that, he continued journeying to the east.'
						}\label{ex:}
