...
%for at least seven Papuan languages of north Halmahera; {\#}kisor(o)
...
%from \tsc{Muna-Buton} in Sulawesi throughout much of linguistic
...
%Reflexes of **mantəR ‘cuscus’ are not found in \tsc{Bima-Lembata},
...
%Far to the west,
%Proto-Timor-Alor-Pantar *madəl ‘flying fox’,\footnote{
		%\tsc{Timor-Alor-Pantar}
		%is proposed to be a branch of \tsc{Greater West Bomberai} \citep{UsherSchapper2022}.}
 %is fairly resemblant of nearby Proto-Central Timor **mantəR
%‘cuscus’, or Proto-Timor-Babar **mantəR/**məntəR ‘cuscus’.
