...
\begin{itemize}
	...
	\item	Do some verbs take subject-indexing
				...
				such as those found in \tsc{Ambon-Seram} languages (and Banda,
	...
	\item	Is there a kind of zero-marking on nouns when they are talked
				...
				Buru \it{isi-t} is meat dried for taking to market; vs.,
				\it{isi-n} ‘its meat’.)
	...
	\item	Where is the quote margin introducing direct speech positioned
				...
				direct quote (as is sometimes found in English literature)? Does
				it ever come at the end (like in journalistic English)? Do they
