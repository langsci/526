...
As discussed in detail in \srf{13-01-05},
...
west of the Blust line such as with Malay,
...
nevertheless the languages east of the Blust line are clearly
...
the Alune vowel shift to \it{loi-ni} ‘leaf’,
...
and those subgroups from the PMP form.\footnote{
		...
		of Helong (TB, west Timor) \it{duiŋ} `dugong'.
		Instead, Helong \it{duiŋ}
...
and glosses of the Oceanic data far to the east.
...
and \tsc{Muna-Buton} that may or may not be related to \tsc{POc}
