...
For example, the \tsc{Flores-Lembata} node of \tsc{Bima-Lembata}
\citep{Fricke2017}, \tsc{Ambon-Seram} \citep{Florey2010}, and the \tsc{Rote-Meto}
...
Malay, in example \qf{02-22}, illustrates the
...
\begin{exe}
\setcounter{xnumi}{21}
	\ex{Malay; western pattern; preverbal}\vspace{-1mm}
...
\begin{exe}
	\ex{Tetun Foho [tet]; preverbal\label{ex:02-23}}\jambox*{\citep[751]{UBB2013}}\vspace{-1mm}
	\sn{\gll	haʔu \tbf{la} k-atene\\
						\tsc{1sg} \tsc{neg} \tsc{1sg}-know\\
			\glt	`I don't know.'}
	\ex{Dela [row]; bipartite\label{ex:02-24}}\jambox*{\citep[945]{UBB2020a}}\vspace{-1mm}
...
\newpage
\begin{exe}
	\ex{Tetun Fehan [tet]; clause final\label{ex:02-23b}}\jambox*{(Grimes' fieldnotes)}\vspace{-1mm}
	\sn{\gll	ha k-atene \tbf{haʔi}\\
						\tsc{1sg} \tsc{1sg}-know \tsc{neg} \\
			\glt	`I don't know.'}
	%\ex{Helong [heg]; clause final\label{ex:02-25}}\jambox*{\citep[855]{UBB2012a}}\vspace{-1mm}
	%\sn{\gll	auk tanan \tbf{lo}\\
						%\tsc{1sg} know \tsc{neg}\\
			%\glt	`I don't know.'}
\end{exe}

While Tetun, Dela, and Helong are separated from each other by
...
For example, Kotos Amarasi has bipartite negation \it{ka {\ldots} fa}.
Neighbouring Roi{\Q}is Amarasi has clause final negation \it{maeʔ} \citep[412]{Edwards2020}.
...
is found among younger speakers of Rote-cluster languages Tii and Lole.
...
bipartite, and clause-final negation from three \tsc{Ambon-Seram} languages.
...
\begin{exe}
	...
	\ex{Haruku [hrk]; bipartite\label{ex:02-27}}\jambox*{\citep[233]{Florey2010}}\vspace{-1mm}
	\sn{\gll	au \tbf{taʔ} ane \tbf{sa} hahu\\
						\tsc{1sg} \tsc{neg1} eat \tsc{neg2} pig\\
			\glt	`I don't eat pork.'}
	\ex{Yalahatan [jal]; clause final\label{ex:02-28}}\jambox*{\citep{BeckleyND}}\vspace{-1mm}
...
many SVO languages east of the Blust line,
but not west of it?
...
of kilometres away, such as in the Austronesian languages of Dhao,
Helong, Buru, and many languages on the island of Seram.
