...
and \tsc{Ambon-Seram} languages show *j > \it{l} in *pajay, *pija.
All \tsc{Sula-Buru} and \tsc{Ambon-Seram} languages show *j > {\0} in *qaləjaw.
PMP *j > {\0} in \tsc{Sula-Buru} in *ŋajan ‘name’,
*huaji ‘younger sibling (same sex)’,
but is preserved as *j > **l in \tsc{Ambon-Seram} languages in the same words.
