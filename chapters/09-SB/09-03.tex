...
Proto-Sula-Buru has the following retentions,
...
.1 {\tsc{Sula-Buru}}.
		.2 {\tsc{Nuclear Sula-Buru} *z/*y > **y; *b > \it{f}; **mb > \it{b}; *d > **r; **muyu \tsc{neg}}.
				.3 {\tsc{Sula} *e > \it{i} /{\gap}{\#}; **h > \it{ʔ,} {\0}; *l > {\0} /Vα{\gap}Vα (**y = \it{y})}.
						.4 {Mangole [mqc] **r > \it{l}; *uCu > \it{uCo}}.
						.4 {Sanana [szn] **r > \it{h}; *uCu > \it{uCa}}.
				.3 {\tsc{Buru} **y > {\0}} (**r = \it{r}).
						.4 {Buru [mhs] *uCu > \it{oCo, uCu}}.
						.4 {Lisela [lcl] (*uCu = \it{uCu}; lexical and morphological influence from Kayeli and Sanana)}.
		.2 {Ambelau [amv] *p > \it{f}; *b > \it{b} /{\#}{\gap}, \it{β} /V{\gap}V; *w > \it{β}; **mb > \it{p}; **d/*l > \it{l, h}; *z > \it{l}; *ŋ/*n > \it{n}; *k > \it{k, ʔ,} {\0}; *t > \it{ʧ, r} /i{\gap}, \it{t} /n{\gap}, \it{r}; *y > traces}.
}
\hspace{3.5mm}--- Hukumina [huw] (classification uncertain)