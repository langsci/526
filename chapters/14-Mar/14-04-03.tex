...
and meaning in two separate branches of the \tsc{Muna-Buton}
...
to explain all of them.\footnote{
		...
		fronting affect of *R is only regular in Munan languages (Kaimbulawa,
		Pancana, Kioko, Kambowa, and Busoa in \trf{14-07a}.
		See \trf{14-09} for more data on fronting).
		Given this, Cia-Cia and Kaisabu \it{mante} ‘bear cuscus’ are
		likely borrowings from a Munan language.}
The \it{mante} forms
in two separate branches of the \tsc{Muna-Buton} subgroup in
