...
The \tsc{Muna-Buton} word \it{mante} ‘bear cuscus’ in seven languages
...
phonology in \crf{ch:SB} of links from Central Sulawesi-Banggai-Taliabu,
the latter in Maluku east of the Blust line.
In this chapter we provide additional lexical evidence through
the distribution of ubiquitous reflexes of **mantəR ‘cuscus’
and closely related forms in \tsc{Muna-Buton}
and throughout our Wallacean subgroups (minus \tsc{Bima-Lembata}),
as well as Buru \it{tonal} ‘cuscus’ borrowed from a southeast Sulawesi language.\footnote{
		One other borrowing in Buru from southeast Sulawesi is \it{bara}
		`don't, \tsc{prohibative}'
		from Tukang Besi \it{bara} `don't, \tsc{prohibative}'.}
...
in \tsc{Sula-Buru} and \tsc{Ambon-Seram} languages.
The Sulawesi forms also require *əR{\#} to derive *ə > \it{e},
instead of the otherwise expected *ə > \it{o}.
Many \tsc{Ambon-Seram} and \tsc{Seram-Tanimbar-Bomberai} languages
regularly preserve the final *R{\#} that is regularly lost in \tsc{Muna-Buton} languages.
...
while medial *nt cannot.\footnote{
  Malcolm Ross (pers. comm. September 2025) now finds that the
	...
	This form also find support in EMP from Ambai
