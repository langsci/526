...
\ili{Watubela} is an important witness with *q/*k > \it{k} in nearly all cases.
Other STB languages usually have *q > {\0},
but the reflexes of *k are distinct in \ili{Bati} (*k = \it{k}),
\ili{Geser} (*k = \it{k}),
\ili{Gorom} (*k > \it{ʔ}),
and \ili{Kowiai} (*k > {\0}, \it{ʔ}).
...
\ili{Kesui}, which is closely related to \ili{Watubela},
has *q/*k > {\0}, \it{h}.
An example of *k > \it{h} in \ili{Kesui} is *wakaR > ‹ai áha›
...
\ili{Bati}	&	‹tolor›	&	‹lunini›	&		&		&	‹miatan›	&		&	\\
\ili{Geser}	&	{\hr}tolu	&	{\hr}ilú	&	\cg{(barem)}	&	{\hr}ena	&	{\hr}metan	&	{\hr}matuu	&	\cg{(tora)}\\
\ili{Gorom}	&	{\hr}tolur	&	{\hr}ilú	&	\cg{(barem)}	&	{\hr}ena	&	{\hr}metan	&	\cg{(mataʔena)}	&	{\hr}moti\\
\ili{Watubela}	&	{\hr}\tbr{k}atlu	&	{\hr}\tbr{k}ulu	&	{\hr}\tbr{k}ataf	&	{\hr}\tbr{k}ena wo	&	{\hr}ma\tbr{k}etan	&	{\hr}mtu\tbr{k}a	&	{\hr}m\tbr{k}oti\\
\ili{Kesui}	&	‹atulú›	&	‹alúda›	&		&		&	‹meten›	&		&	\\
\ili{Kowiai}	&	{\hr}toron	&	\cg{(umun)}	&	\cg{(barem)}	&	{\hr}ena	&	{\hr}maetan	&	\cg{(na-ɸameteʔena)}	&	{\hr}mot\\
		\lspbottomrule
	\end{tabular}
\end{adjustbox}
\end{table}
...
\ili{Bati}	&	‹\tbr{k}aya›	&	‹\tbr{k}utim›	&		&		&		&		&		&	‹a\tbr{k}ar›\su{†}	&	‹i\tbr{k}an›\\
\ili{Geser}	&	{\hr}\tbr{k}ai	&	{\hr}\tbr{k}utu	&	{\hr}\tbr{k}am	&	{\hr}\tbr{k}ita	&	{\hr}\tbr{k}umu	&	{\hr}mata\tbr{k}ut	&	{\hr}sa\tbr{k}a	&	{\hr}a\tbr{k}ar	&	{\hr}i\tbr{k}an\\
\ili{Gorom}	&	{\hr}ai	&	{\hr}utu	&	{\hr}ami	&	{\hr}ita	&	{\hr}umu	&	{\hr}mata\tbr{ʔ}ut	&	{\hr}sa\tbr{ʔ}a	&	{\hr}a\tbr{ʔ}ar	&	{\hr}i\tbr{ʔ}an\\
Watub.	&	{\hr}\tbr{k}ai	&	{\hr}\tbr{k}utu	&	{\hr}\tbr{k}ami	&	{\hr}\tbr{k}ita	&	{\hr}\tbr{k}emiu	&	{\hr}mata\tbr{k}ut	&	{\hr}ha\tbr{k}a	&	{\hr}a\tbr{k}al	&	{\hr}i\tbr{k}an\\
\ili{Kesui}	&	‹aʹi›	&	‹utun›	&		&		&		&		&		&	‹ai á\tbr{h}a›	&	‹iʹan›\\
\ili{Kowiai}	&	{\hr}ai	&	{\hr}ut	&	{\hr}am	&	{\hr}ita	&	{\hr}ou	&	{\hr}-matatuʔ	&	{\hr}-sa\tbr{ʔ}a	&	\cg{(rarin)}	&	\cg{(don)}\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†] {\citet[127]{LoskiLoski1989} give \ili{Bati} \it{aʔal} ‘root’.}
		\end{tablenotes}
	\end{threeparttable}
\end{adjustbox}
\end{table}

\ili{Watubela} even preserves *q/*k > \it{k} word finally.
Examples in the available data are given in \qf{11-01}.
We have so far identified only one example in which *q is not
preserved as \it{k} in \ili{Watubela}: *qapəju > \it{feli-n} ‘gall’.

\noindent{\wg\st{6pt}\tblr{>{\hspace{-\tabcolsep}}l<{\hspace{-\tabcolsep}}
>{\hspace{-\tabcolsep}\enspace}
lll}
\lsptoprule
%\tbx{11-01}	&	PMP	&	\ili{Watubela}	&	local gl.	\\	\midrule
%\endfirsthead
\tbx{11-01}	&	PMP	&	\ili{Watubela}	&	local gl.	\\	\midrule
%\endhead
