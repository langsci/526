...
There are no certain reflexes of these words in \ili{Bedoanas}
and \ili{Erokwanas}, and only two likely reflexes in \ili{Arguni}.
...
\ili{Yamdena}	&	{\hr}le\tbr{r}-e	&	{\hr}i\tbr{r}i-ŋw	&	{\hr}fi\tbr{r}	&	{\hr}fe\tbr{r}u-	&	{\hr}fusa\tbr{r}	&	{\hr}ul-e\\	\midrule
\ili{Fordata}	&	{\hr}le\tbr{r}a	&	{\hr}ni\tbr{r}u-n	&	{\hr}ifi\tbr{r}a	&	{\hr}fe\tbr{l}ur-n	&	{\hr}fua\tbr{r}	&	{\hr}ula\tbr{r}\\
\ili{Kei}	&	{\hr}le\tbr{r}	&	{\hr}ni\tbr{r}u-n	&	{\hr}n-fi\tbr{r}	&	{\hr}fi\tbr{r}u-n	&	{\hr}fuha\tbr{r}	&	\cg{(laŋar)}\\
\ili{Onin}	&	{\hr}re\tbr{r}a	&	{\hr}i\tbr{r}i-r	&	{\hr}fi\tbr{r}as	&	{\hr}ma\tbr{r}ik\su{†}	&	{\hr}fusa	&	\\
\ili{Sekar}	&	{\hr}re\tbr{r}a	&	\cg{(idum)}	&	{\hr}fi\tbr{r}as	&	{\hr}ma\tbr{r}ik\su{†}	&	\cg{(ogoban)}	&	\\
Uruang.	&	{\hr}ne\tbr{r}a	&	{\hr}ni\tbr{r}iŋgain	&	{\hr}fi\tbr{r}a	&	\cg{(geram)}	&	{\hr}fusa\tbr{l}	&	\\
\ili{Arguni}	&	\cg{(rúas)}	&	\cg{(sigyó)}	&	{\hr}fí\tbr{s} (loan?)	&	{\hr}ma\tbr{r}i\su{†}	&	\cg{(gomber)}	&	\\	\midrule
\ili{Bedoanas}	&	\cg{(sáni)}	&	\cg{(suʔu)}	&		&		&		&	\\
Erokw.	&	\cg{(úruas)}	&	\cg{(suʔu)}	&		&		&		&	\\
\ili{Irarutu}	&	{\hr}re, rre	&	\cg{(wegur}	&	\cg{(ɲa)}	&	-fi\tbr{r}- ‘bile’	&	{\hr}fwi\tbr{r}	&	\\
\ili{Kuri}	&	{\hr}ro\tbr{r}, rəˈrɔː\tbr{r}	&	\cg{(iwɛ, ya-we-gə̆)}	&	\cg{(ɛnɔ)}	&		&	{\hr}ʷuɛ\tbr{r}ɛ	&	\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†]	{\ili{Onin}/\ili{Sekar} \it{marik}, and \ili{Arguni} \it{mari}
								all mean ‘bitter’ and are reflexes
								of intermediate **ma-pəju.}
			%\item[‡]	{The final part of \ili{Irarutu} \it{wegur} nose may be connected
...
\citet[272]{Jackson2014} gives both \ili{Irarutu} \it{re} ‘day’
and \it{rre} [rəre] ‘sun,
day’, the latter of which he interprets as historically reduplicated
\it{r{\tl}re} with loss of the final syllable; *jaw.
\ili{Kuri} \it{ror} retains *j > \it{r}
and alongside this word has [rəˈrɔːr] ‘daylight’.

Regarding the reflexes of *(ŋ)ijuŋ,
the \ili{Arguni}, \ili{Bedoanas}, and \ili{Erokwanas} words for ‘nose’ are probably
not derivable from *ijuŋ as discussed in \srf{11-05-02-01}.
Linking \ili{Irarutu} \it{wegur} [weŋgurə] to the doublet *ujuŋ or *ŋijuŋ
is possible, though much more difficult, on the assumption that initial \it{weg} can be analysed historically
as an independent morpheme -- as perhaps attested by \ili{Kuri} \it{ya-weg} [ya-wegə].
See \srf{11-05-02-02} for more discussion.
\ili{Sekar} \it{idum} is probably borrowed from \ili{Malay} \it{idung} [iduŋ],
not inherited from *(ŋ)ijuŋ. \ili{Sekar} also has \it{ipir} ‘nose’.
...
day’ and *(ŋ)ijuŋ ‘nose’ (excepting the potential \ili{Arguni},
\ili{Bedoanas}, and \ili{Erokwanas} reflexes).
Other words are not as straightforward.
Firstly, *j > \it{r} in *pija requires positing that \ili{Arguni} \it{fís}
is a borrowing (perhaps from \ili{Biak},
\ili{Kowiai}, or \ili{Geser} \it{fis}).
Secondly, *j > **r in *qapəju requires positing medial **r >
\it{l} in \ili{Fordata} \it{felur-n} ‘gall bladder’,
...
> \it{l} in \ili{Uruangnirin} \it{fusal} ‘navel’.
Lastly, *j > **r for *quləj requires sporadic loss of the final consonant in \ili{Yamdena}.
...
However, the \tsc{Bomberai Tip} languages (\ili{Onin},
\ili{Sekar}, \ili{Uruangnirin}) keep them distinct with *j > \it{r},
but *d/*z > \it{n}.\footnote{
		Word finally \ili{Yamdena} has *d > \it{r}, \it{t}.
		Examples are: PMP *tuhu\tbr{d} > \ili{Yamdena} \it{tu\tbr{r}-e}
		‘knee’ (\ili{Fordata} \it{tura}, \ili{Kei} \it{tuur}),
		*qabatə\tbr{d} > \it{bata\tbr{r}} ‘sago grub’,
		and *sumaŋə\tbr{d} > \it{smaŋa\tbr{t}} ‘soul’.
		\ili{Arguni} \it{mesia simiat} ‘soul’ may be from *sumaŋəd with final
...
Likewise, \ili{Yamdena} keeps the reflexes partially distinct with *j > \it{r},
but *d/*z > \it{r, d}.
...
\ili{Yamdena}	&	\cg{(das)}	&	{\hr}be{\tl}be\tbr{r}y	&	{\hr}da\tbr{r}a-ny	&	{\hr}si\tbr{r}-e	&	{\hr}du\tbr{r}i	&	{\hr}na-mdi\tbr{r}y	&	{\hr}wey\\
\ili{Fordata}	&	\cg{(rahan)}	&	\cg{(ŋorvaʔan)}	&	{\hr}la\tbr{r}a-n	&	{\hr}si\tbr{r}a	&	{\hr}lu\tbr{r}i-n	&	{\hr}n-di\tbr{r}i	&	{\hr}wea\tbr{r}\\
\ili{Kei}	&	\cg{(raha)}	&	{\hr}vi\tbr{r}un	&	{\hr}la\tbr{r}	&	{\hr}si\tbr{r}	&	{\hr}lu\tbr{r}i-n	&	{\hr}di\tbr{r}	&	{\hr}wea\tbr{r}\\
\ili{Onin}	&	{\hr}\tbr{r}uma	&	{\hr}per{\tl}pe\tbr{r}i	&	{\hr}ra\tbr{r}a	&	{\hr}si\tbr{r}a	&	{\hr}ru\tbr{r}i-r	&	{\hr}mari\tbr{r}i	&	{\hr}we\tbr{r}\\
\ili{Sekar}	&	{\hr}\tbr{r}uma	&	{\hr}bìri{\tl}bí\tbr{r}i	&	{\hr}ra\tbr{r}a	&	{\hr}si\tbr{r}a	&	{\hr}ru\tbr{r}i-r	&	{\hr}mri\tbr{r}i	&	{\hr}we\tbr{r}\\
Uruang.	&	\cg{(kapala)}	&	{\hr}per{\tl}pe\tbr{r}i	&	{\hr}na\tbr{r}a	&	{\hr}si\tbr{r}a	&	{\hr}nu\tbr{r}i-n	&	{\hr}a-mri\tbr{r}i	&	{\hr}we\tbr{r}\\
\ili{Arguni}	&	{\hr}\tbr{r}ume	&	{\hr}ir{\tl}í\tbr{r}	&	{\hr}ra\tbr{r}e	&	{\hr}si\tbr{r}er	&	\cg{(tór)}	&	\cg{(gáser)}	&	{\hr}wiyê\tbr{r}\\
\ili{Bedoanas}	&	\cg{(windi)}	&	{\hr}ur{\tl}u\tbr{r}u	&	\cg{(rita)}	&		&	\cg{(tóʔor)}	&	\cg{(usar)}	&	{\hr}wie\tbr{r}\\
Erokw.	&	\cg{(widi)}	&	{\hr}pu{\tl}pwa\tbr{r}i	&	\cg{(rita)}	&	{\hr}si\tbr{r}ar	&	\cg{(toʔar)}	&	\cg{(waser)}	&	{\hr}we\tbr{r}\\
\ili{Irarutu}	&	\cg{(san)}	&	\cg{(bunat)}	&	\cg{(wams)}	&	{\hr}te\tbr{r}ir\su{†}	&	{\hr}ru\tbr{r}	&	{\hr}n-mari\tbr{r}	&	{\hr}we\tbr{r}\\
\ili{Kuri}	&	\cg{(wɛˈnɔm)}	&	\cg{(aˈbɔb)}	&	\cg{(wams)}	&		&	{\hr}ru\tbr{r}	&	{\hr}itə-bri\tbr{r}	&	{\hr}wɛ\tbr{r}\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†]	{\ili{Irarutu} \it{terir} either has irregular *s > \it{t} or is not from *qasiRa.}
			\item[‡]	{\ili{Yamdena},
								\ili{Onin}, and \ili{Sekar} reflexes mean ‘thorn, bone’.
...
\ili{Yamdena}	&	{\hr}fa\tbr{s}-e	&	{\hr}wara\tbr{s}	&	{\hr}ŋa\tbr{r}-e	&	{\hr}bu{\tl}bu\tbr{s-}e	&	{\hr}wai-ny	&	{\hr}suan\\
\ili{Fordata}	&	\cg{(wanat)}	&	{\hr}wara\tbr{t}	&	{\hr}na\tbr{r}a-n	&		&	{\hr}wa\tbr{r}i-n	&	{\hr}u\tbr{r}a\\
\ili{Kei}	&	\cg{(kokat)}	&	{\hr}wara\tbr{t}	&	\cg{(mema-n)}	&		&	{\hr}wa\tbr{r}i-n	&	{\hr}hu\tbr{x}\\
\ili{Onin}	&	{\hr}pa\tbr{s}a	&	{\hr}wara\tbr{s}	&	{\hr}ga\tbr{r}a-r	&		&	{\hr}wa\tbr{r}i-r	&	\\
\ili{Sekar}	&	{\hr}pa\tbr{s}a	&	{\hr}wara\tbr{s}	&	{\hr}ga\tbr{r}a-r	&		&	{\hr}wa\tbr{r}e-r	&	\\
Uruang.	&	{\hr}fa\tbr{s}a	&	{\hr}wara\tbr{s}, wiri\tbr{s}	&	{\hr}(ŋ)ga\tbr{r}an	&		&	{\hr}wa\tbr{r}i-n	&	\\
\ili{Arguni}	&	{\hr}pwá\tbr{s}en	&	{\hr}wári\tbr{r}	&	{\hr}gá\tbr{d}in	&		&	{\hr}twá\tbr{r}i	&	\\
\ili{Bedoanas}	&	{\hr}pá\tbr{s}a	&	{\hr}wári\tbr{r}	&	{\hr}ga\tbr{d}iŋ	&		&		&	\\
Erokw.	&	{\hr}pá\tbr{s}a	&	{\hr}wári\tbr{r}	&	{\hr}ga\tbr{d}in	&		&		&	\\
\ili{Irarutu}	&	{\hr}fa\tbr{s} 	&	{\hr}wara	&	\cg{(no)}	&	{\hr}fu\tbr{s}	&	\cg{(nefut)}	&	\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†]	{The words in the languages of the Bomberai Peninsula were responses to ‘rope’.
								\ili{Uruangnirin} \it{waras} is ‘rope’ and \it{wiris} ‘string’.}
			\item[‡]	{*huaji is reconstructed meaning ‘same sex younger sibling’.
								\ili{Onin}, \ili{Sekar}, and \ili{Arguni} words were given in response to ‘friend’ (Indonesian \it{teman}).
								\ili{Arguni} \it{tuari} is from *ta-huaji.
								(compare \ili{Arguni} \it{támana} ‘father’ from *ta-ama.) \ili{Uruangnirin}
			...
			\item[Δ]	{*suja is reconstructed with the meaning ‘pitfall or trail spikes
								...
								\ili{Kei} \it{hux} ‘pointed bamboo stake’ is from \ili{Kei} Besar with regular **r > \it{x}.}
		\end{tablenotes}
	\end{threeparttable}
%\end{adjustbox}
\end{table}
...
The two identified reflexes of PMP *bujəq ‘foam’ in \ili{Yamdena}
and \ili{Irarutu} also show *j > \it{s.} \citet{BlustTrussel2020} derive
\ili{Yamdena} \it{bu{\tl}bus-e} from the doublet *busa,
...
PMP *busa may be spurious.\footnote{
		...
		of *busa may be \ili{Malay} loans; e.g.
		\citet{BlustTrussel2020} give \ili{Buru} \it{busa} in support of this
		form, but this is a \ili{Malay} loan,
		as shown by *b = \it{b.} \ili{Buru} has native *bujəq > \it{fue-n.}}
...
Reflexes of *huaji and *suja have *j > {\0} in \ili{Yamdena},
