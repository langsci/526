...
do not favour a simple continuation from \tsc{\ili{Bima}-Lembata}.
\ili{As} mentioned in \srf{15-06-01},
...
In the far west (\ili{Helong}),
and the far \ili{east} (\tsc{Southwest Tanimbar}),
...
The direction of sound changes from \ili{east}-to-west or west-to-\ili{east}
...
current locations, and being in intense contact with the \tsc{\ili{Central} Timor} subgroup
as well as the Papuan language of \ili{Bunak}.
