...
The possibility of linking the \tsc{Aru} languages within “\ili{Central}
Maluku” suggested \citet{GrayGreenhill2009} appears to have little to support it in the historical
phonology or the lexicon.

The idea of a link further \ili{east} deserves further investigation,
...
and then drifted on the currents to \ili{Aru} with one surviving to
reach those islands (pers. comm.
Jock Hughes, confirmed by email 30 October 2020).
So a possible (secondary) link to the \ili{east} with Austronesian
languages such as \ili{Motu} or Papuan Tip languages should not be
