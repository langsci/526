...
of work, and at l\ili{east} one additional volume.
...
\begin{itemize}
	...
	\item	If a new word in a subgroup replaces a term with the same meaning
				...
				except in the nearby \ili{Kayeli} language due to contact with \tsc{Sula-Buru} languages.
				So **dama ‘eye’ is a lexical replacement assigned to Proto-Sula-\ili{Buru},
	...
	\item	If the new form co-exists alongside a retention of the equivalent
				...
				albeit in more obscure uses (such as \ili{Buru} \it{ben{\tl}beno} ‘sagging
