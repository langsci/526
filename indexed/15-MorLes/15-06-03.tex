\sscp{Possible Austronesian incursion(s): from north\ili{east} to southwest}{15-06-03}
...
we understand “north\ili{east} Indonesia” to mean that Blust sees that
...
and EMP occurring in or around “north\ili{east} Indonesia”.
...
(Fiawat, Proto-\ili{Ambel}-\ili{Biga}, and Proto-Ma{\Q}ya-\ili{Matbat}).
Of the remaining two primary branches,
\ili{As} would have spread eastward to the Bird’s Head,
...
and South Halmahera coming from the \ili{east},
...
\tsc{\ili{Ambon}-Seram}, and to a lesser degree \tsc{Seram-Tanimbar-Bomberai} subgroups.
...
Archaeological dating has artifacts associated with Austronesian-speaking
peoples present in \ili{Banda} in central Maluku around 3,500 BP.
...
*b = \it{b}, *ə = **ə,
and *-aw = **-aw in \tsc{\ili{Ambon}-Seram},
among other things.
Although some of these proto-phonemes in \tsc{\ili{Ambon}-Seram} are retained
...
\tsc{\ili{Ambon}-Seram} languages suggest a stronger (Papuan) substrate influence there.
...
and \tsc{\ili{Ambon}-Seram} having a shared history through their phonologies.
...
or \tsc{\ili{Bima}-Lembata} were derived from or through \tsc{Sula-Buru} or \tsc{\ili{Ambon}-Seram}.
The opposite scenario, that \tsc{Sula-Buru} or \tsc{\ili{Ambon}-Seram}
were derived from or through \tsc{Timor-Babar} or \tsc{\ili{Bima}-Lembata},
