\sscp{Secondary Papuan incursion(s): \ili{east}-to-west}{15-06-04}
\ili{As} described in \srf{02-01},
there is considerable archaeological evidence that the Timor
region had human habitation by at l\ili{east} 42,000 BP \citep{OConnor2015}.
...
These features are still widely found in the Papuan \tsc{Timor-\ili{Alor}-Pantar}
...
\ili{As} discussed in \srf{02-01},
the idea of \tsc{Timor-\ili{Alor}-Pantar} (TAP) languages linking to
...
\ili{east}-to-west link also parallels the westward movement away from
...
The \ili{east}-to-west spread of the term {\#}muku ‘banana’ from the
