\sscp{Major Austronesian incursion: west-to-\ili{east} along southern islands}{15-06-01}
There are retentions of many features in the historical phonology,
morphosyntax, and lexicon in the \tsc{\ili{Bima}-Lembata} subgroup
(\crf{ch:BL}) that are fairly conservative,
and are often associated more with languages west of the Blust
line than with those to the \ili{east}.
...
In particular, the \tsc{Flores-Lembata} node of \tsc{\ili{Bima}-Lembata}
...
Lombok, \ili{Sumbawa}, Flores southwardswards to Sumba to Sabu,
...
or stopped at \ili{Pantar} and \ili{Alor}.
...
are not so commonly found in much of the \tsc{\ili{Bima}-Lembata} subgroup (see \srf{15-04}).
...
\ili{As} mentioned above, many structural features in the wider region
attributed to contact with SOV Papuan languages are much less common in \tsc{\ili{Bima}-Lembata}.
...
western and southern regions of \tsc{\ili{Bima}-Lembata},
...
‘banana’ reach as far west as \ili{Manggarai} in western Flores
(\srf{02-03-01-07}).
...
languages not very divergent from PMP entered the \tsc{\ili{Bima}-Lembata}
region probably in the west.
They travelled west to \ili{east},
...
and more bilingualism the further \ili{east} they travelled.

But drawing a clear link in the historical phonology between
\tsc{\ili{Bima}-Lembata} and \tsc{Timor-Babar} below the level of PMP is difficult.
