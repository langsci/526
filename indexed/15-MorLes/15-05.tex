...
stones’ from the eastern tip of Timor across to \ili{Aru},
...
Reflexes are also found in Papuan Timor-\ili{Alor}-\ili{Pantar} languages.
...
For example, \ili{Ujir} \it{luti} ‘stone wall (n); stack up stones
(v)’ shows regular sound correspondences (inherited),
whereas \ili{Ujir} \it{lutur} ‘stone wall fortification’ is irregular
and marks it as borrowed (diffusion) (p.242).
Similarly \ili{Central} \ili{Marsela} \it{lukra} ‘stone wall around garden’
shows regular sound correspondences (inherited),
whereas \ili{Central} \ili{Marsela} \it{lutur} ‘protective stone wall around
...
\begin{quote}
	...
	led to the most extreme linguistic effect -- the development of \ili{Ndyuka-Trio} Pidgin.
...
pointed out that \ili{Ndyuka-Trio} Pidgin ceased to be used by around
...
with the useful role of \ili{Ndyuka-Trio} Pidgin narrowed down to 200 years or so.
...
For example, we noted that the STB language of \ili{Geser}-\ili{Gorom} has
...
It was used in the trade links with \ili{Onin},
traces of \ili{Geser} loans are widespread in the region in both Austronesian
and Papuan languages, and its role has waned significantly in
the last 60 years or so as its utility has been superceded by \ili{Malay}.

Similarly, the STB language of \ili{Fordata} has functioned in the
past as a language of wider communication
and the favoured language of ceremony in the \ili{Kei} islands,
and in Tanimbar in the \ili{Yamdena}-speaking regions \citep{Hughes1987,McKinnon1991}.
Traces are still found in \ili{Yamdena} rituals,
but its role has waned significantly.

We noted that the \tsc{North Halmahera} (West Papuan) language
of \ili{Ternate} has left significant traces throughout the Sula archipelago,
\ili{Buru}, western Seram, and in languages spoken in the \ili{Manipa} Straits
between \ili{Buru} and Seram \citep{Collins1982b,Grimes1993}.
\ili{Ambon} \ili{Malay} \it{kusu} ‘cuscus’ is very likely a \ili{Ternate} loan
...
sultan of \ili{Ternate} had significant reach into central Maluku,
the legacy of which is still felt today.
The \tsc{North Halmahera} (West Papuan) language of \ili{Tidore} had
a similar influence in the Bird’s Head region of west Papua.

The \tsc{Southwest Maluku} (\tsc{Timor-Babar}) language of \ili{Luang}
has functioned as a ceremonial language
and in other roles extending its reach both westward,
as well as to the \ili{Babar} islands
and even the \ili{Kei} islands far to the \ili{east} \citep[400, note 13]{Taber1993}.

In \crf{ch:CT}, we noted that \ili{Tetun} [tet] has had significant
impact on \tsc{\ili{Central} Timor} languages over a long period of time.
More recently with the independence of Timor-Leste,
the different variety of \ili{Tetun} Dili [tdt] has seen a resurgence
...
\ili{Makasar} (in South Sulawesi) had a considerable impact on \ili{Sumbawa}
and western Flores, and after 1727 \ili{Bima} exerted its influence
...
\ili{Makasar}, \ili{Sanskrit}, \ili{Arabic}, Portuguese,
and Dutch, most of which spanned several centuries.
The role of \ili{Malay} has gradually increased in the region over
...
This is further complicated by the earlier role of trade \ili{Malay}
that developed into a number of different contact creoles in
the region (such as \ili{Ambon} \ili{Malay},
\ili{Kupang} \ili{Malay}, \ili{Aru} \ili{Malay}, \ili{Larantuka} \ili{Malay}, etc.).
And these are now in contact with Indonesian (Standard \ili{Malay}),
which developed from official language/literary Malays of the
sultans’ courts in the western regions,
rather different from the trade \ili{Malay} formerly used in what is
