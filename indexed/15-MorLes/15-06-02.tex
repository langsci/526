...
In \crf{ch:Tal}, we provided various kinds of evidence that \ili{Taliabu},
\ili{Soboyo}, and \ili{Kadai} spoken in the Sula archipelago in western Maluku
near Sulawesi share a number of features in their historical
phonologies with \ili{Banggai} and other \tsc{Celebic} languages to the west that are not shared
...
and lexicon of the nearby \tsc{Sula-Buru} languages of \ili{Mangole}
and \ili{Sanana}, a reduced influence on \ili{Lisela},
and very little on \ili{Buru} and \ili{Ambelau}.
...
and \ili{Taliabu} via \ili{Banggai}.
In \srf{14-01} it was noted that the \it{Strigocuscus pelengensis}
‘\ili{Banggai} (dwarf) cuscus’, is also found throughout the Sula archipelago,
but not across the gap to \ili{Buru}.
