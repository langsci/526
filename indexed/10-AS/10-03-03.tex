...
other than as Proto-\ili{Ambon} languages that did not fit with Sub-\ili{Ambon} or Sub-\ili{Buru}.
Similarly, \citet{Collins1983} did not discuss the innovations
defining the \tsc{Patakai-Manusela} branch of his Nunusaku (roughly our \tsc{\ili{Ambon}-Seram}).
...
following languages: the \ili{Manusela} cluster,
North \ili{Nuaulu}, and South \ili{Nuaulu} (also known as “Patakai” or “Fatakai”).

\begin{table}
	\centering\tcp{ Lexical similarity among varieties of Manusela}{10-10}
	\st{6pt}\begin{tabular}{llllllllll}\lsptoprule
\mc{4}{l}{\it{Alakmat} {\cgr}}									 		 		&{\cgr}		&{\cgr}		&{\cgr}		&{\cgr}		&{\cgr}		& \ili{Huaulu} [hud]\\
72{\cgr}	&	\mc{4}{l}{\it{Kanikeh}}								 		 		&		&		&		&		& \ili{Kanikeh}\\	\hhline{~~--------}
...
71{\cgr}	&	74	&	67{\cgr}	&	73	&	72{\cgr}	&	\mc{3}{l}{\it{Air Besar}}			 		&		& \ili{Hatuolo}\\	\hhline{~~~~~~----}
64{\cgr}	&	66	&	65{\cgr}	&	70	&	72{\cgr}	&	75	&	\mc{3}{|l}{\it{\ili{Maneo} Rendah}{\cgr}}	 			&\mc{1}{l|}{}\\
66{\cgr}	&	67	&	66{\cgr}	&	72	&	73{\cgr}	&	73	&	\mc{1}{|l}{86{\cgr}}	&	\mc{2}{l}{\it{Maneoratu}}	&\mc{1}{l|}{\multirow{-2}{*}{Maneo}}\\	\hhline{~~~~~~----}
		\lspbottomrule
	\end{tabular}
\end{table}

Evidence in \citet[117--121]{LoskiLoski1989} suggests that “\ili{Manusela}” (a.k.a.
\ili{Sou Upaa}) is best thought of as a chain or cluster of related
...
Of these varieties, only \ili{Huaulu} (originally spoken in the interior)
has been assigned a separate ISO 639-3 code.
This variety is also referred to by other \ili{Manusela} speakers as
...
northern area marked “\ili{Manusela} cluster” in \frf{07-03}.
Data marked “(K)” is the \ili{Kowa} variety of \ili{Manusela} from the Holle list \citep[185--191]{Stokhof1981a}.
South \ili{Nuaulu} is currently spoken in a few villages in south central Seram.
It is related to but distinct from North \ili{Nuaulu},
...
differentiate \tsc{\ili{Ambon}-Seram} from neighbouring subgroups.
They also share merger of *R/*l/*j > **l which occurs in all
\tsc{\ili{Ambon}-Seram} languages except Boano (\srf{10-03-01}).
However, they have distinct *d/*z > **h that sets them apart
as a separate branch within \tsc{\ili{Ambon}-Seram}.
...
\lsptoprule
%\tbx{10-47}	&	PMP	&	\ili{Manusela}	&	S. \ili{Nuaulu}	&	N. \ili{Nuaulu}	&	local gl.	\\	\midrule
%\endfirsthead
	&	PMP	&	\ili{Manusela}	&	S. \ili{Nuaulu}	&	N. \ili{Nuaulu}	&	local gl.	\\	\midrule
%\endhead
\tbx{10-47}	&	*\tbr{ŋ}ajan	&	\tbr{l}ala-ni	&	\tbr{n}ana-i	&	\tbr{n}ana-e	&	name	\\
	&	*\tbr{ŋ}ilu/*\tbr{n}ilu	&	ai aka maka\tbr{n}inu-a	&	ma\tbr{n}inu-e	&	ma\tbr{n}inu-e	&	Man. `tamarind', S. \ili{Nuaulu} `sour'	\\
...
and *laŋit > \it{lali-a} in \ili{Manusela} appear to show progressive
and regressive assimilation respectively of the nasal to the lateral.
While such assimilation is frequent among \tsc{\ili{Ambon}-Seram} languages
...
in available \ili{Manusela} data to test whether this is a regular pattern.
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-49}	&	PMP	&	\ili{Manusela}	&	S. \ili{Nuaulu}	&	N. \ili{Nuaulu}	&	local gl.	\\	\midrule
%\endfirsthead
\tbx{10-49}	&	PMP	&	\ili{Manusela}	&	S. \ili{Nuaulu}	&	N. \ili{Nuaulu}	&	local gl.	\\	\midrule
%\endhead
	&	*\tbr{p}ajay	&	\tbr{h}ala	&	ana	&		&	rice (\ili{Kowa} Man. \it{fala})	\\
	...
	&	**qali\tbr{p}an	&	ni{\tl}ni\tbr{h}al-a	&	ni{\tl}nian-e	&	ni{\tl}nian-e	&	centipede (C metathesis in \ili{Manusela})	\\
...
South \ili{Nuaulu} \it{mpia} ‘raw sago’ probably attests usual *R >
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-50}	&	PMP	&	\ili{Manusela}	&	S. \ili{Nuaulu}	&	N. \ili{Nuaulu}	&	local gl.	\\	\midrule
%\endfirsthead
\tbx{10-50}	&	PMP	&	\ili{Manusela}	&	S. \ili{Nuaulu}	&	N. \ili{Nuaulu}	&	local gl.	\\	\midrule
%\endhead
	...
	&	*Ru\tbr{mb}ia	&	i\tbr{p}ia	&	\tbr{mp}ia-e, \tbr{p}ia-e	&	\tcg{(fatanetinai)}	&	Man. `sago' S. \ili{Nuaulu} `raw sago'	\\
...
\lspbottomrule
\end{tabularx}\mbox{}\\}
\footnotetext[10]{For **(ma-)putu compare \ili{Buru} \it{poto} ‘hot,
	burn’, \ili{Kayeli} \it{mpoto} ‘fever’, Proto-Rote-\ili{Meto} *mbutu ‘hot’
\citep[273]{Edwards2021}.}
\footnotetext{For **kambəR compare \ili{Kamarian} \it{aper} \citep[76]{vanEkris1864} among others.
	For medial **mb compare Proto-Rote-\ili{Meto} *kambe ‘saliva,
	spittle’ and subentries in \citet[192]{Edwards2021}.}

\tsc{Patakai-Manusela} has *d/*z > **h.
This is retained as \it{h} in \ili{Manusela}
and is lost in \ili{Nuaulu}.
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-51}	&	PMP	&	\ili{Manusela}	&	S. \ili{Nuaulu}	&	N. \ili{Nuaulu}	&	local gl.	\\	\midrule
%\endfirsthead
	&	PMP	&	\ili{Manusela}	&	S. \ili{Nuaulu}	&	N. \ili{Nuaulu}	&	local gl.	\\	\midrule
%\endhead
...
\tbx{10-52}	&	*\tbr{z}alan	&	\tbr{h}ala	&	\tcg{(arena)}	&	\tcg{(arena)}	&	path, way	\\
	...
	&	*qa\tbr{z}ay	&	a\tbr{h}a-nia	&	a\tbr{n}a-i	&	a\tbr{n}a-ri nofua	&	chin, jaw, cheek (irr. *z > \it{n} in \ili{Nuaulu})	\\
\lspbottomrule
\end{tabularx}\mbox{}\\}
\footnotetext{South \ili{Nuaulu} \it{ai} ‘take’ is possibly a reflex of
*dakəp, but this requires irregular *ə > \it{i}.}

Four exceptions have been identified in South \ili{Nuaulu}.
...
One possible exception has been identified in \ili{Manusela} *zəlay
(PWMP) > \it{lela-ni} ‘tongue’.

Like many \tsc{\ili{Ambon}-Seram} languages,
\ili{Manusela} and \ili{Nuaulu} share *R/*l/*j > **l.
This is retained as \it{l} in \ili{Manusela}
and shifts to \it{n} in \ili{Nuaulu}.
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-53}	&		&	P\tcg{(CE)}MP	&	\ili{Manusela}	&	S. \ili{Nuaulu}	&	N. \ili{Nuaulu}	&	local gl.	\\	\midrule
%\endfirsthead
&		&	PMP	&	\ili{Manusela}	&	S. \ili{Nuaulu}	&	N. \ili{Nuaulu}	&	local gl.	\\	\midrule
%\endhead
\tbx{10-53}		&	*l	&	*\tbr{l}ima	&	\tbr{l}ima	&	\tbr{n}ima	&	\tbr{n}ima	&	five	\\
	...
	&		&	*qu\tbr{l}əj	&	u\tbr{l}eh	&	u\tbr{n}e	&	u\tbr{n}e putut-e	&	maggot N. \ili{Nuaulu} `caterpillar'	\\
...
\tbx{10-54}	&	*R	&	*\tbr{R}umaq	&	\tbr{l}uma	&	\tbr{n}uma	&	\tbr{n}uma	&	house	\\
	...
	&		&	*\tbr{R}amut	&	\tbr{l}amu-nia	&	\tbr{n}amt-e	&	\tbr{n}amt-e	&	Man. `fibre', S. \ili{Nuaulu} `root'	\\
...
\tbx{10-55}	&	*j	&	*pa\tbr{j}ay	&	ha\tbr{l}a	&	a\tbr{n}a	&		&	rice	\\
	...
	&		&	*hua\tbr{j}i	&		&	wa\tbr{n}i-ni	&	wa\tbr{n}i-n	&	S. \ili{Nuaulu} `same sex ySib', N. \ili{Nuaulu} `grandchild' (gloss error?)	\\
\lspbottomrule
\end{tabularx}\mbox{}\\}

\ili{Manusela} tends to have word-final *R > {\0} while South \ili{Nuaulu}
tends to retain word-final *R as \it{n}.
This is consistent with the tendency for South \ili{Nuaulu} to preserve word final consonants.
Examples in addition to *qatəluR
and *liqəR in \qf{10-53} above  include *wahiyəR > \ili{Manusela} \it{wae-a}
South \ili{Nuaulu}, North \ili{Nuaulu} \it{waen-e}, *niuR/**niwəR > \ili{Manusela} \it{nue-a},
South \ili{Nuaulu} \it{nion-e} and *mantəR > South \ili{Nuaulu} \it{maran-e} ‘cuscus’.
...
Such words include *kalaw > \ili{Manusela} \it{kaa} ‘Blyth’s hornbill
(Rhyticeros plicatus)’, *qalima > \ili{Manusela} \it{ima-ni} ‘hand,
wrist’, and *qatəluR > South \ili{Nuaulu} \it{toun-e} ‘egg’ (\ili{Manusela} \it{tolu-a}).
Consistent with other \tsc{\ili{Ambon}-Seram} languages (see \trf{07-05},
\srf{07-03-02}) *qalejaw  has *j > {\0} in \ili{Manusela} \it{lea} ‘sun’.
(South \ili{Nuaulu} has non-cognate \it{rani-e} ‘sun’).

The normal reflex of schwa in \ili{Manusela}
and \ili{Nuaulu} is \it{o},
...
Many of these words also show *ə > e in other \tsc{\ili{Ambon}-Seram}
languages which otherwise have *ə > \it{o}.
Thus, for instance, reflexes of *ma-qitəm ‘black’ has final *ə
> \it{e} in all \tsc{\ili{Ambon}-Seram} languages for which data is
...
specific innovation at the level of Proto-\ili{Ambon}-Seram.
...
>{\raggedright\arraybackslash}X}
\lsptoprule
%\tbx{10-56}	&	PMP	&	\ili{Manusela}	&	S. \ili{Nuaulu}	&	N. \ili{Nuaulu}	&	local gl.	\\	\midrule
%\endfirsthead
	&	PMP	&	\ili{Manusela}	&	S. \ili{Nuaulu}	&	N. \ili{Nuaulu}	&	local gl.	\\	\midrule
%\endhead
...
\tbx{10-57}	&	*p\tbr{ə}ñu	&	p\tbr{e}nu-a (K)	&	\tbr{e}nu	&		&	turtle	\\
	...
	&	*ul\tbr{ə}j	&	ul\tbr{e}h	&	un\tbr{e}	&	u\tbr{n}e putut-e	&	maggot, N. \ili{Nuaulu} `caterpillar'	\\
	&	*waR\tbr{ə}j	&	w\tbr{e}li-nia	&	a-wan\tbr{e}	&	auwan\tbr{e}	&	vine, rope	\\
	&	*tuq\tbr{ə}d	&		&	tu\tbr{e}te	&		&	tree stump (*əd{\#} > \it{e}?, or nominal suffix \it{-te})	\\
	&	*qat\tbr{ə}p	&	wat\tbr{e}-a	&	ainat\tbr{a}-e	&		&	thatch, roof (S. \ili{Nuaulu} morphology unclear, possibly non-cognate)	\\
	&	*ma-qit\tbr{ə}m	&	met\tbr{e}-a, meta	&	met\tbr{e}n-e	&	met\tbr{e}n-e	&	black	\\
\lspbottomrule
\end{tabularx}\mbox{}\\}

To summarise,
\ili{Manusela} and \ili{Nuaulu} can be placed within \tsc{\ili{Ambon}-Seram} on
the basis of shared *ŋ/*ñ/*n > \it{n},
*p > **h, and *ma-p/*mb/*mp > \it{p}.
In addition they share *R/*l/*j > **l with most other \tsc{\ili{Ambon}-Seram} languages.
However, they have a distinct reflex of *d/*z > **h,
and on this basis we place \tsc{Patakai-Manusela} as a primary
branch within \tsc{Nuclear \ili{Ambon}-Seram}.
