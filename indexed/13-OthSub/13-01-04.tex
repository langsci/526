...
language \ili{Watubela} retains PMP *q in all positions.
...
needs to be reconstructed in some forms for Proto-Timor-\ili{Babar}.”
...
In \tsc{\ili{Ambon}-Seram} languages, retention of initial *q has been
...
Also in \tsc{\ili{Ambon}-Seram} languages,
...
And in the \tsc{\ili{Ambon}-Seram} language \ili{Alune},
...
whole: it is retained fully in \ili{Watubela},
...
*h) in \ili{Soboyo}, a \tsc{Taliabu} language (linked with \tsc{Celebic}; see \crf{ch:Tal}).
The normal reflex in \ili{Soboyo} is PMP *h > {\0},
...
The words which seem to reflect initial PMP *h = \it{h} in \ili{Soboyo}
...
is \ili{Soboyo} \it{kuhi} ‘knock down with an upward blow,
...
It is unclear if the \ili{Soboyo} semantics of ‘knock down’ are actually
related to the glosses hovering around ‘reach in with the finger’.
And \ili{Soboyo} retains final *t > \it{c} in some etyma (e.g.
...
*h in some \tsc{\ili{Ambon}-Seram} languages explains why the reflexes
