...
\begin{quote}
		...
		Some WMP languages (as \ili{Malay}) have simplified PMP reduplicative
...
in South\ili{east} Sulawesi, for instance,
...
*tuktuk > \ili{Tukang Besi} \it{tutu} ‘pound’ (Donohue 1999) [\citealp{Donohue1999a}].”
...
\ili{Malay} \it{tutok}, \ili{Kulisusu} \it{mon-cucu},
\ili{Wolio} \it{tutuk-i}; data from \citealp{BlustTrussel2020}).
...
All \ili{Central}-Eastern Malayo-Polynesian languages
...
retained: *seksek > \ili{Manggarai} \it{cəcək} ‘stuff,
cram in’, *bejbej > \ili{Kambera} \it{búburu} ‘bundle’,
*bukbuk > \ili{Tetun} \it{fuhuk} ‘wood weevil’,
*sepsep > Javanese \it{səsəp} ‘suck’,
*buŋbuŋ > \it{wuwuŋ} ‘ridge of the roof’,
*bukbuk > \ili{Malay} \it{bubok} ‘wood weevil’,
but *diŋdiŋ > \it{dindiŋ} ‘wall’.
\ili{As} these examples illustrate,
...
\ili{Kambera}, a \tsc{\ili{Bima}-Lembata} language spoken on Sumba.
We supplement his \ili{Kambera} examples in \trf{13-05} with data from
...
%(Note: \ili{Kodi} orthographic ‹gh› = velar fricative [ɣ]; \ili{Anakalang}
%and \ili{Mamboru} orthographic ‹ḅ› are implosive [ɓ].
...
\ili{Kambera}	&	{\hr}bu\tbr{b}ur-u\su{†}	&	{\hr}bu\tbr{b}ur-u	&	‹bú\tbr{h}i›	&	{\hr}hu\tbr{h}uk-u	&	{\hr}pu\tbr{p}ut-u	&	{\hr}tu\tbr{t}uk-u\\
\ili{Mangili}	&	{\hr}bu\tbr{b}ur-u	&		&	‹bú\tbr{h}i›	&	{\hr}hu\tbr{h}uk-u	&	{\hr}pu\tbr{p}ut-u	&	{\hr}tu\tbr{t}uk-u\\
\ili{Lewa}	&	{\hr}bu\tbr{b}ur-u	&		&	{\hr}bo\tbr{h}u	&	{\hr}hu\tbr{h}uk-u	&	{\hr}pu\tbr{p}ut-u	&	{\hr}to\tbr{t}uk-u\\
\ili{Anakalang}	&	{\hr}bu\tbr{b}ur-u	&		&	{\hr}ɓo\tbr{s}i	&	{\hr}su\tbr{s}uk-a,&	{\hr}pu\tbr{p}ut-u	&	{\hr}to\tbr{t}uk-u\\
					&											&		&									&{\hr}si\tbr{s}ik-u	&		&	\\
\ili{Mamboru}	&	{\hr}ba\tbr{b}ur-a	&		&	{\hr}ɓo\tbr{s}i	&	{\hr}su\tbr{s}uk-a	&	{\hr}pu\tbr{p}ut-a	&	‹tú\tbr{t}u›\\
\ili{Weyewa}	&	{\hr}bu\tbr{b}ur-a	&	‹wò\tbr{b}ola›	&	{\hr}bo\tbr{z}e	&		&	{\hr}po\tbr{w}i	&	{\hr}katu\tbr{t}uk-a\\
\ili{Kodi}	&	{\hr}bu\tbr{b}ur-o	&	{\hr}ɣo\tbr{b}ːol-o	&	{\hr}bo\tbr{h}e	&	{\hr}hu\tbr{h}uk-o	&	{\hr}pu\tbr{p}ut-o	&	{\hr}tu\tbr{t}uk-o\\
		\lspbottomrule
	\end{tabular}
