...
This occurs in \ili{Manggarai} \citep{VerheijenGrimes1995},
\ili{Ngadha} \citep{DjawanaiGrimes1995}, \ili{Lio} \citep{Elias2018},
Palu{\Q}e, and \ili{Sika} \citep{LewisGrimes1995}.\footnote{
		\ili{Havu} and \ili{Dhao} also have schwa which is discussed separately in \srf{03-03-02}.}
...
Some other \tsc{\ili{Bima}-Lembata} languages also have six-vowel systems,
though lack a true schwa.
Thus, \ili{Kedang} has lost surface/phonetic schwa but has developed
...
%In languages like \ili{Ngadha} “schwa /ə/ never occurs in vowel sequences”
%\citep[595]{DjawanaiGrimes1995}.
%But in \ili{Havu} and \ili{Dhao}, schwa frequently occurs in vowel sequences
...
%
%In \ili{Ngadha} schwa is described as: “The schwa /ə/ is of short duration
...
%
%In \ili{Manggarai} schwa is described as follows: “Schwa occurs in
...
%
%In \ili{Sika} schwa is described as: “Syllables with schwa /ə/ as their
...
\ili{Manggarai}&{\hr}d\tbr{ə}ŋe&\tcg{(laiŋ)}&{\hr}ʋ\tbr{ə}li&{\hr}ʋ\tbr{ə}ru&\hp{*qa}t\tbr{ə}lo&{\hr}t\tbr{ə}lu&{\hr}\tbr{ə}ma\\
\ili{Waerana}&{\hr}d\tbr{ə}ŋeʔ&{\hr}\tbr{ə}nar&{\hr}w\tbr{ə}li&{\hr}w\tbr{ə}ru&\hp{*qa}t\tbr{ə}loʔ&{\hr}t\tbr{ə}luʔ&{\hr}ame\\
\ili{Ngadha}&{\hr}z\tbr{ə}ŋe&{\hr}\tbr{ə}na&{\hr}v\tbr{ə}li&\tcg{(muzi)}&\hp{*qa}t\tbr{ə}lo&{\hr}t\tbr{ə}lu&{\hr}\tbr{ə}ma\\
\ili{Lio}&\tcg{(lele)}&{\hr}\tbr{ə}na&\tcg{(gəti)}&\tcg{(muri)}&\hp{*qa}t\tbr{ə}lo&{\hr}t\tbr{ə}lu&{\hr}\tbr{ə}ma\\
Palu{\Q}e&\tcg{(tee)}&\tcg{(kəri)}&&\tcg{(muri)}&\hp{*qa}t\tbr{ə}lo&{\hr}t\tbr{ə}lu&{\hr}ama\\
\ili{Sika}&{\hr}r\tbr{ə}na&\tcg{(nee)}&\tcg{(βotər)}&\mbox{{\hr}β\tbr{ə}ru-ŋ,}&\hp{*qa}t\tbr{ə}lo&{\hr}t\tbr{ə}lu&{\hr}ama\\
&&&&\hp{*}βoo&&&\\
\ili{Kalikasa}&{\hr}d\tbr{ə}ŋ\tbr{ə}r&\tcg{(botan)}&\tcg{(opi)}&{\hr}v\tbr{ə}run&\hp{*qa}t\tbr{ə}luk,&{\hr}t\tbr{ə}lu&{\hr}ama\\
&&&&&\hp{*qa}teluk&&\\
		\lspbottomrule
	\end{tabular}
\end{table}
