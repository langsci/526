...
While the evidence for a \tsc{\ili{Havu}-Dhao} node is compelling,
...
though reflexes are currently only known in \ili{Kambera},
\ili{Lewa}, and \ili{Mangili} (\tsc{East Sumba}),
and one word may show *z > {\0}.
\tsc{\ili{Havu}-Dhao} have *z > \it{ʄ} in the three identified reflexes.
...
\ili{Kodi}	&	{\hr}la\tbr{r}a	&	{\hq}u\tbr{r}ːa	&	{\hr}mba\tbr{r}oyo	&	\cg{(tukːa)}	&		&		&	\hp{*z}akic-o\\
\ili{Weyewa}	&	{\hr}la\tbr{r}a	&	{\hq}u\tbr{r}ːa	&	{\hr}ma\tbr{r}ːo	&		&		&		&	\hp{*z}akut-a\\
\ili{Loli}	&	{\hr}la\tbr{r}a	&	{\hq}u\tbr{r}ːa	&	{\hr}ma\tbr{r}ːo	&	\cg{(tukːe)}	&		&		&	\\
\ili{Laboya}	&	{\hr}laː\tbr{r}a	&	{\hq}u\tbr{r}a	&	{\hr}ma\tbr{r}au	&	\cg{(daheka)}	&		&		&	\\
\ili{Wanukaka}	&	{\hr}la\tbr{r}a	&	{\hq}u\tbr{r}a, u\tbr{r}aŋ&	{\hr}ma\tbr{r}ou	&	{\hr}ma\tbr{r}ani	&		&		&	\\
\ili{Mamboru}	&	{\hr}la\tbr{r}a	&	{\hq}u\tbr{r}a	&	\cg{(malera)}	&	{\hr}ma\tbr{r}ani	&		&		&	\hp{*z}akat-a\\
\ili{Anakalang}	&	{\hr}la\tbr{r}a	&	{\hq}u\tbr{r}aŋ-u	&	{\hr}ma\tbr{r}au	&		&		&		&	\hp{*z}akat-u\\
\ili{Lewa}	&	{\hr}la\tbr{r}a	&	{\hq}u\tbr{r}aŋ-u	&	{\hr}\tbr{r}au	&	{\hr}maranu	&	{\hr}\tbr{ʤ}araŋ-u	&	{\hr}\tbr{ʤ}olu	&	\hp{*z}akat-u\\
\ili{Kambera}	&	{\hr}la\tbr{r}a	&	{\hq}u\tbr{r}aŋ-u	&	{\hr}\tbr{r}au, ma\tbr{r}au&	{\hr}ka\tbr{r}eni	&	{\hr}\tbr{ʤ}araŋ-u	&	{\hr}\tbr{ʤ}uli\su{‡}&	\hp{*z}akat-u\\
\ili{Mangili}	&	{\hr}la\tbr{r}a	&	{\hq}u\tbr{r}aŋ-u	&	{\hr}\tbr{r}au	&	{\hr}ka\tbr{r}eni	&	{\hr}\tbr{ʤ}araŋ-u	&	{\hr}\tbr{ʤ}uli	&	\hp{*z}akat-u\\	\midrule
\ili{Havu}	&	{\hr}ru\tbr{ʄ}ara	&	{\hq}ə\tbr{ʄ}i	&	{\hr}\tbr{ʄ}əu	&	\cg{(umu)}	&		&		&	\hp{z}\cg{(apa)}\\
\ili{Dhao}	&	{\hr}\tbr{ʄ}ara	&	{\hq}ə\tbr{ʄ}i	&	{\hr}ka\tbr{ʄ}əu	&	\cg{(dətu)}	&		&		&	\hp{z}\cg{(b͡βelu)}\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†]	{Reflexes of *zalan have metathesis of the initial
								and medial consonants in Sumba.}
			\item[‡]	{\citet[71]{Onvlee1984} gives \ili{Kambera} \it{ʤuli} as ‘small kind
			...
			\item[Δ]	{If the words given here are reflexes of *zaqat,
								...
								and irregular changes of the final vowel in \ili{Kodi} and \ili{Weyewa}.}
		\end{tablenotes}
	\end{threeparttable}
\end{adjustbox}
\end{table}
...
these languages together apart from \tsc{\ili{Havu}-Dhao}.
...
Languages are reordered (roughly from \ili{east} to west)
...
\tsc{East Sumba}, \tsc{\ili{Central} Sumba}, \tsc{West Sumba}, \ili{Laboya}, and \tsc{\ili{Kodi}-Gaura}.
...
62 \cgr								&	63 \cgr	&	66 \cgr	&	70 {\SY}&	67 \cgr	&	67 \cgr	&	73 {\SY}&	74 {\SY}&	77 {\SY}&	74 {\SY}&	\mc{3}{|l}{Mamboru}	&\mc{5}{r|}{\tsc{\ili{Central} Sumba}}	\\	
...
All members of \tsc{\ili{Central} Sumba},
except \ili{Mamboru}, have denasalisation of prenasalised stops: **mb
> \it{b}, **nd > \it{d}, and **ŋg > \it{g}
and this could be used to further group these four languages.
However, this sound change also occurs in \ili{Loli} and \ili{Gaura}.
...
%This is known to occur to some extent in \ili{Wanukaka},
%\ili{Weyewa}, and \ili{Kodi} and there is historical evidence that it occurred
%in \ili{Laboya} (see \srf{03-03-01}).
However, the full extent of consonant lengthening is not known,
partly due to transcriptional and/or analytical differences.
This may provide evidence for a node containing \tsc{West-Sumba}, \ili{Laboya}, and \tsc{\ili{Gaura}-Kodi}.
...
as well as \ili{Havu}, have *s > \it{h},
this change does not occur in \ili{Dhao} nor in all languages of Sumba.
There is evidence that this shift happened in historical
times in both \ili{Kambera} \citep[12]{Klamer1998a} and \ili{Havu} \citep[3]{WalkerA1982}.
