\clearpage
\ssscp{\tsc{\ili{Havu}-Dhao}}{03-03-02-HD}
Within \tsc{Sumba-Havu} there is very strong
evidence for placing \ili{Havu} and \ili{Dhao} together and apart
...
sources of schwa in \tsc{\ili{Havu}-Dhao}.
Keep in mind in all the following examples
that penultimate schwa in \ili{Havu} and \ili{Dhao} is syllabic,
stress bearing, and triggers phonetic
lengthening of the following consonant.

One source of schwa in \tsc{\ili{Havu}-Dhao} is retention.
PMP *ə = \it{ə} in penultimate syllables,
as shown in \trf{02-09a}.

\begin{table}
	\centering\tcp{\tsc{\ili{Havu}-Dhao} *ə = \it{ə}}{02-09a}
...
\ili{Havu}	&	{\hr}v\tbr{ə}li	&	{\hr}\tbr{ə}pu	&	\hp{*qa}d\tbr{ə}lu	&	{\hr}r\tbr{ə}ŋe	&	\hp{*p}\tbr{ə}ɲu	&	{\hr}l\tbr{ə}ku	&	{\hr}r\tbr{ə}pa	\\
\ili{Dhao}	&	{\hr}h\tbr{ə}li	&	{\hr}\tbr{ə}pu	&	\tcg{(kanaɖ͡ʐu)}	&	{\hr}tad\tbr{ə}ŋi	&	\hp{*p}\tbr{ə}ɲu	&	\tcg{(ləpa)}	&	{\hr}r\tbr{ə}pa	\\
		\lspbottomrule
	\end{tabular}
	%\end{adjustbox}
\end{table}

Many penultimate schwas in \ili{Havu}
and \ili{Dhao} are derived from PMP *a
...
Two examples are *talih > \ili{Havu} \it{dari}, \ili{Dhao} \it{ɖ͡ʐari} `rope, cord'
and *walu > \ili{Havu}, \ili{Dhao} \it{aru} `eight'.

\begin{table}
	\centering\tcp{\tsc{\ili{Havu}-Dhao} *a > \it{ə} /{\gap}V\tsc{+high}}{02-10a}
	%\begin{adjustbox}{width=\textwidth}
	\st{6pt}\begin{tabular}{llllllll}\lsptoprule
...
\ili{Havu}	&	{\hr}v\tbr{ə}u	&	{\hr}d\tbr{ə}u	&	\hp{*ka}ʄ\tbr{ə}u	&	{\hr}r\tbr{ə}u	&	{\hr}t\tbr{ə}u	&	{\hr}d\tbr{ə}i	&	{\hr}\tbr{ə}i	\\	
\ili{Dhao}	&	{\hr}h\tbr{ə}u	&	{\hr}ɖ͡ʐ\tbr{ə}u	&	{\hr}kaʄ\tbr{ə}u	&	{\hr}r\tbr{ə}u	&	{\hr}t\tbr{ə}u	&	{\hr}ɖ͡ʐ\tbr{ə}i	&	{\hr}\tbr{ə}i	\\	
		\lspbottomrule
	\end{tabular}
	%\end{adjustbox}
\end{table}
...
with \ili{Kambera} and \ili{Kodi} cognates to show that
this change separates \tsc{\ili{Havu}-Dhao}
from \tsc{Sumba.}
%and many more \ili{Havu} examples
%can be found in \citet{Blust2012a}.

\begin{table}
	\centering\tcp{\tsc{\ili{Havu}-Dhao} *V\tsc{[+high]}CV\tsc{[-high]} > əC\tsc{[+high]}}{02-10b}
	%\begin{adjustbox}{width=\textwidth}
...
\ili{Havu}		&	{\hr}v\tbr{ə}r\tbb{u}	&	\hp{*R}\tbr{ə}m\tbb{u}	&	\hp{*p}\tbr{ə}h\tbb{u}	&	\hp{*k}\tbr{ə}r\tbb{u}	&	{\hr}m\tbr{ə}ɲ\tbb{i}	&	{\hr}l\tbr{ə}m\tbb{i}	&	{\hr}m\tbr{ə}d\tbb{i}	\\	
\ili{Dhao}		&	{\hr}h\tbr{ə}r\tbb{u}	&	\hp{*R}\tbr{ə}m\tbb{u}	&	\hp{*p}\tbr{ə}s\tbb{u}	&	\hp{*k}\tbr{ə}r\tbb{u}	&	{\hr}m\tbr{ə}ɲ\tbb{i}	&	{\hr}l\tbr{ə}m\tbb{i}	&	{\hr}m\tbr{ə}ɖ͡ʐ\tbb{i}	\\	\midrule
\ili{Kodi}		&	{\hr}wulːa						&	\hp{*R}umːa							&	‹puhu›									&	{\hr}ɣurːa							&	{\hr}miɲːa						&	{\hr}limːa						&	{\hr}mete	\\	
\ili{Kambera}	&	{\hr}wulaŋ-u					&	\hp{*R}uma							&	{\hr}puhu								&	{\hr}wuruŋ-u						&	{\hr}mina							&	{\hr}lima							&	{\hr}mitiŋ-u	\\	
		\lspbottomrule
	\end{tabular}
	%\end{adjustbox}
\end{table}
...
*ə > \it{i} in \ili{Dhao} *dəŋəR > \it{tadəŋi} may due to earlier *R > **y
(see discussion associated \trf{03-51}).
%XXX back reference.mention otehr sources of e

\begin{table}
	\centering\tcp{\tsc{\ili{Havu}-Dhao} *ə > \it{ə, a} /{\gap}C{\#}}{02-09b}
%\begin{adjustbox}{width=\textwidth}
...
\ili{Havu}	&	pe-dan\tbr{e}	&	{\hr}rəŋ\tbr{e}	&	\hp{(R)}\cg{(lie)}	&	{\hr}ɗar\tbr{a}	&	{\hr}ən\tbr{a}	&	\hp{*ha}pəɗ\tbr{a}	\\
\ili{Dhao}	&	pa-ɖ͡ʐan\tbr{e}	&	{\hr}tadəŋ\tbr{i}	&	\hp{*(R)}eɖ͡ʐ\tbr{e}	&	{\hr}ɗar\tbr{a}	&	{\hr}ən\tbr{a}	&	\hp{*ha}pəɗ\tbr{a}, pəd\tbr{a}	\\
		\lspbottomrule
	\end{tabular}
	%\end{adjustbox}
\end{table}

Similarly, the vowel-glide sequence *-ay > \it{e} in \tsc{\ili{Havu}-Dhao}.
...
\begin{table}
	\centering\tcp{Sources of \it{ə} and \it{e} in \ili{Havu} and Dhao}{02-09c}
%\begin{adjustbox}{width=\textwidth}
...
\ili{Havu}	&{\hr}haʔ\tbr{e}&\hp{*p}ar\tbr{e}	&\hp{*q}ad\tbr{e}	&{\hr}mad\tbr{e}	&{\hr}mon\tbr{e}	&{\hr}m\tbr{e}a\\
\ili{Dhao}	&{\hr}ʧaʔ\tbr{e}&\hp{*p}ar\tbr{e}	&\hp{*q}aɖ͡ʐ\tbr{e}&{\hr}maɖ͡ʐ\tbr{e}	&{\hr}mon\tbr{e}	&{\hr}m\tbr{e}a\\
		\lspbottomrule
	\end{tabular}
%	\end{adjustbox}
\end{table}
