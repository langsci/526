...
Sumba is \citet{Onvlee1984}, a dictionary focussed on \ili{Kambera}.\footnote{
...
\ili{Mangili}, \ili{Lewa}, \ili{Anakalang}, \ili{Mamboru}, \ili{Weyewa}, and \ili{Kodi}.
...
bearing stress, as stressed vowels have increased length in \ili{Kambera} \citep[252]{Klamer2009}.
Hence, the word ‘egg’ is analysable as /tilu/ (e.g.
see the examples transcribed ‹tilu› ‘egg’ in \citealp[148, 207]{Klamer1998a}).
\ili{As} a result of such issues “[{\ldots}] \citet{Onvlee1984} is
not a reliable source for research on \ili{Kambera} vowel length or
...
the representation of lengthened consonants in \ili{Kodi} and \ili{Weyewa}.
\citeauthor{Onvlee1984} marks lengthened consonants with a grave accent over the
vowel preceding the consonant.
Thus, \ili{Kodi} ‹lòdo› for /loɗːo/ ‘day’ (p.
243) and ‹lodo› for /loɗo/ ‘sing’ (p.246).\footnote{
		Recall that vowels preceding a lengthened consonant in \ili{Kodi} are shorter
...
e.g. \ili{Kodi} /ɓiɲːa/ ‹binya› ‘door’ (p. 414) vs.
/iɲa/ ‹inya› ‘mother’ (p.
...
The only language with the latter system in \citet{Onvlee1984} is \ili{Anakalang}.
For \ili{Anakalang} \citeauthor{Onvlee1984} transcribes plain voiced stops with normal
