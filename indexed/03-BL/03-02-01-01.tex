...
Firstly, \ili{Lio} has a voiced coronal affricate/fricative transcribed
...
Similarly, \ili{Ngadha} has a voiced coronal affricate/fricative which
...
We follow the transcription used by Arndt in our presentation of \ili{Ngadha} data.

\ili{Rembong} also has a voiced alveolar fricative/affricate.
...
that the realisation of the \ili{Rembong} segment varies between an
alveolar affricate or fricative,
similar to the situation described for \ili{Lio} and \ili{Ngadha}.
...
Languages in which this segment is known to occur include: \ili{Rongga},
\ili{Ende}, Watumite Nga{\Q}o, and East \ili{Nage}.
In none of these languages is this segment in contrast with /z/.
\citet{ArkaEtAl2007} transcribe \ili{Rongga} /ɹ/ as ‹zh›, while \citet{AokiNakagawa1993}
transcribe \ili{Ende} /ɹ/ as ‹rh›.
In \ili{Rongga}, Watumite Nga{\Q}o,
and East \ili{Nage} this segment develops from PMP *d/*z/*j (see \srf{03-02-02}),
while \ili{Ende} has *l > \it{ɹ}.
...
Finally, \ili{Komodo} has contrastive implosives with both plain
