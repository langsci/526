\scp{Nasals}{12-01}
PMP *n/*ŋ/*ñ > \it{n} in \ili{Banda}.
This merger also occurs in \tsc{\ili{Ambon}-Seram}
...
such as \ili{Ambelau}), can easily be due to parallel development,
...
While \ili{Banda} has a phonetic [ɲ] in a number of words,
...
lll}
\lsptoprule
%\tbx{12--1}	&	PMP	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule
%\endfirsthead
&	PMP	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule
%\endhead
