\scp{Vowels}{12-05}
The reflexes of vowels in penultimate syllables in \ili{Banda} are mostly straightforward.
...
lll}
\lsptoprule
%\tbx{12-12}	&	PMP	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule
%\endfirsthead
\tbx{12-12}	&	PMP	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule
%\endhead
...
llll}
\lsptoprule
\tbx{12-13}		&	env.	&	PMP	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule	\hhline{~}
\endfirsthead
\lsptoprule
\qf{12-13}		{\cwh}&	env.	{\cwh}&	PMP	{\cwh}&	\ili{Banda}	{\cwh}&	\ili{Banda} gloss	{\cwh}\\	\midrule
\endhead
...
lll}
\lsptoprule
\tbx{12-14}	&	PMP	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule	\hhline{~}
\endfirsthead	
\lsptoprule
\qf{12-14}	{\cwh}&	PMP	{\cwh}&	\ili{Banda}	{\cwh}&	\ili{Banda} gloss	{\cwh}\\	\midrule
\endhead						
...
lll}
\lsptoprule
\tbx{12-15}		&	PMP	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule
	&	*duha	&	ru\tbr{o}	&	two	\\
...
At l\ili{east} some words also show a productive process of vowel alternation,
...
\lsptoprule
%\tbx{12-16}	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule
%\endfirsthead
\tbx{12-16}	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule
%\endhead
	&	rum\tbr{o}	&	house	\\
...
it may show that loss of final glides in \ili{Banda} is a relatively
recent change.
...
lll}
\lsptoprule
%\tbx{12-17}	&	PMP	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule
%\endfirsthead
\tbx{12-17}		&	PMP	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule
%\endhead
...
%\tbx{12-17}	&	PMP	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule
%\endfirsthead
\tbx{12-18}		&	PMP	&	\ili{Banda}	&	\ili{Banda} gloss	\\	\midrule
%\endhead
...
Finally, in the literature two varieties of \ili{Banda} are
identified named after the villages in which they
are spoken: \ili{Banda}-Eli and \ili{Banda}-Elat.
