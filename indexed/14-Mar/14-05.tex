...
\ili{As} can be seen from the forms glossed ‘bandicoot’ in \trf{14-14},
there is great diversity of forms,
suggesting that terms for the elusive bandicoot developed independently
from region to region.
There is consistency across some \ili{Aru} languages,
such that \citet[267]{Schapper2011} reconstructs **kawaran ‘bandicoot’
for \ili{Manombai}, \ili{Lorang}, and West \ili{Kola}.
Southwest \ili{Tarangan} \it{man} is clearly anomalous within \ili{Aru} for
words glossed ‘bandicoot?’, and is also anomalous for
reflexes of Proto-\ili{Aru} **medaR ‘cuscus’ (see \srf{14-04-03}).
Anomalous Southwest \ili{Tarangan} \it{man} ‘bandicoot’ is the only
...
S. \ili{Nuaulu}	&	imanona	&	long-nosed marsupial\su{†}	&	\tsc{AS}	\\
\ili{Manusela}\su{‡}	&	mape-a	&	Seram long-nosed bandicoot,	&\tsc{AS}\\
		&		&	\it{Rhynchomeles prattorum}	&		\\
	&	mabaya	&	bandicoot	&	\tsc{AS}	\\	\midrule
\ili{Kei} Besar	&	helé	&	bandicoot, \it{Echymipera rufescens}	&	STB	\\
\ili{Kei} Kecil	&	halee	&	mouse-like marsupial	&	STB	\\	\midrule
\ili{Ujir}	&	koa	&	bandicoot, \it{Echymipera rufescens}	&	\tsc{Aru}	\\
East \ili{Kola}	&	koyi	&	bandicoot, \it{Echymipera rufescens}	&	\tsc{Aru}	\\
West \ili{Kola}	&	kawaran	&	bandicoot, \it{Echymipera rufescens}	&	\tsc{Aru}	\\
\ili{Batuley}	&	koyi	&	bandicoot, \it{Echymipera rufescens}	&	\tsc{Aru}	\\
				&	karsirem	&	\it{tikus tanah} (`earth rat') which&	\tsc{Aru}	\\
				&						&	lives in cliff holes	&	\tsc{Aru}	\\
\ili{Dobel}	&	ʔosi	&	bandicoot, \it{Echymipera rufescens}	&	\tsc{Aru}	\\
\ili{Koba}	&	ŋarukwabala	&	bandicoot, \it{Echymipera rufescens}	&	\tsc{Aru}	\\
\ili{Lorang}	&	kagwaran	&	bandicoot, \it{Echymipera rufescens}	&	\tsc{Aru}	\\
\ili{Manombai}	&	kagaran	&	bandicoot, \it{Echymipera rufescens}	&	\tsc{Aru}	\\
SW \ili{Tarangan}	&	man	&	bandicoot?	&	\tsc{Aru}	\\
	&	karsiram	&	a kind of marsupial	&	\tsc{Aru}	\\	\midrule
\ili{Matbat}	&	isɔ¹²k	&	bandicoot, \it{Echymipera kalubu}	&	SHWNG	\\
\ili{Biak}	&	karau (sop)	&	bandicoot, \it{Echymipera kalubu}	&	SHWNG	\\
Ma{\Q}ya	&	kalubu	&	bandicoot, \it{Echymipera kalubu}	&	SHWNG	\\
\ili{Ansus}	&	pimunau	&	bandicoot (unspecified)	&	SHWNG	\\
\ili{Moor}	&	atíata	&	bandicoot (unspecified)	&	SHWNG	\\
\ili{Ambai}	&	kafa	&	bandicoot (generic)	&	SHWNG	\\
\lspbottomrule
	\end{tabular}
