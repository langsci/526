...
and to the \ili{east} in Indonesian Papua.
...
Cognates of **mantəR are found outside the purported “CEMP” area in \tsc{\ili{Muna}-Buton}
languages, and **kVndoR(a) is only attested unproblematically in EMP
and in a single “CMP” witness (\ili{Watubela}) on the edge of the area
...
and SHWNG languages, including \ili{Watubela}.
