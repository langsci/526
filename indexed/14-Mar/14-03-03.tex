...
Bird’s Head and \ili{Onin} peninsula of Papua,
...
\tsc{Austronesian {(STB)}}	&	\ili{Onin}	&	oni	&	kisor	&	tree wallaby\\
\tsc{West Bird's Head}	&	Mooi	&	mxn	&	kasyor	&	tree wallaby\\
\tsc{East Bird's Head}	&	\ili{Sougb}	&	mnx	&	ucira, usira	&	marsupial\\
\tsc{\ili{Konda}-\ili{Yahadian}\su{‡} }	&	\ili{Yahadian}	&	ner	&	kisoro	&	kangaroo\\
\tsc{\ili{Inanwatan}-\ili{Duriankere}\su{‡}}	&	\ili{Duriankere}	&	dbn	&	kesyoro	&	tree wallaby\\
\tsc{\ili{Inanwatan}-\ili{Duriankere}\su{‡}}	&	\ili{Inanwatan}	&	szp	&	isoro	&	tree wallaby\\
\tsc{South Bird's Head\su{‡}}	&	\ili{Kais}	&	kzm	&	kisoro	&	tree wallaby\\
		\lspbottomrule
	\end{tabular}
		\begin{tablenotes}\tnsize
			\item[†] {Glosses for all forms in this table are not certain.}
			\item[‡] {\tsc{\ili{Konda}-Yahadian} and \tsc{\ili{Inanwatan}-Duriankere}
...
Of these languages, \ili{Inanwatan} has been described by \citet{deVries2004},
and some comments on the form \it{isoro} ‘wallaby,
tree wallaby’ can be made on the basis of this description.

Firstly, \ili{Inanwatan} has a contrast between words with an initial
...
Secondly, \ili{Inanwatan} does not allow final consonants,
and “vowel insertion and consonant deletion are employed to adapt
foreign words to \ili{Inanwatan} phonotactics” \citep[6]{deVries2004}.
Examples include \ili{Malay} \it{wakil} > \ili{Inanwatan} [ˈmakiri] ‘deputy
headman’; Dutch \it{emmer} > \ili{Malay} \it{ember} > \ili{Inanwatan} [ˈɛβɛro]
‘bucket’; and \ili{Malay} \it{kapal} > [ˈkaparo] ‘ship’.
Thus, if \it{isoro} has been acquired by contact the final vowel
may be an insertion.
Finally, most nouns in \ili{Inanwatan} end in final [o] \citep[33]{deVries2004}.
