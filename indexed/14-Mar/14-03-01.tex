...
P.-\ili{Sangir}					&	**kusay	&	cuscus			&	\tsc{Sangir}				&	\citet[89]{Sneddon1986}	\\
P.-\ili{Gorontalo}-			&	**kusoy	&	bear cuscus	&	\tsc{Greater C.}		&	\citet[322]{Usup1986}	\\
\hp{P.-}\ili{Mongondow}	&					&							&	 \tsc{Philippines}	&	\hp{\,}	\\
...
l\ili{east} three contiguous subgroups of Malayo-Polynesian: \tsc{Philippine}
(including \tsc{Sangir}, \tsc{Minahasan}, and \tsc{\ili{Mongondow}-Gorontalo}), \tsc{South Sulawesi}, and \tsc{Celebic}.
...
(not found north of \ili{Sangir}-\ili{Talaud}),
**kusay ‘(bear) cuscus’ cannot credibly be assigned to PMP.
Thus, unless one is willing to propose a supergroup which contains
all these subgroups, borrowing must have played at l\ili{east} some role in the distribution
of **kusay across Sulawesi.

The \ili{Sangir} languages and two languages of \tsc{\ili{Mongondow}-Gorontalo}
(\tsc{Greater \ili{Central} Philippine}) in the north preserve a final vowel-glide
sequence within this form: \ili{Ponosakan} \it{kusoy},
\ili{Mongondow} \it{kutoy} (regular *s > \it{t}),
\ili{Bantik}, \ili{Ratahan} \it{kusey}, and \ili{Sangir} \it{kusai, kuse}.
...
\ili{Banggai} \it{kuai} ‘bear cuscus’ also preserves a final vowel-glide
sequence, but that, along with the loss of /s/ flag the \ili{Banggai} form as irregular.