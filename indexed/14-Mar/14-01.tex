...
Looking at marsupials from west to \ili{east},
...
A distinct species of \it{Ailurops melanotis} ‘\ili{Talaud} bear cuscus’
is found in the \ili{Talaud} Islands to the north\ili{east} of Sulawesi.
Another species, the \it{Strigocuscus pelengensis} ‘\ili{Banggai} (dwarf)
cuscus’ is said to be found on \ili{Banggai}
...
The \it{Phalanger alexandrae} ‘\ili{Gebe} cuscus’ is found on the island
of \ili{Gebe} between Halmahera
and the Raja Ampat islands.
The \it{Phalanger gymnotis} ‘ground cuscus’ is found in the Raja
Ampat islands, the Bird’s Head and Bird’s Neck of Indonesian Papua, and in \ili{Aru}.
...
maculatus}) was transported as far west as \ili{Selayar} Island off of South Sulawesi.
Like the food crops,
...
Line, so \ili{Aru} is included within their natural range (see \frf{02-01}).
The \it{Echymipera rufescens} ‘long-nosed spiny bandicoot, a.k.a.
long-nosed echymipera’ is found on the \ili{Aru} Islands,
and also has been reported in the \ili{Kei} Islands.
Words glossed ‘bandicoot’ have been identified in nine languages
of \ili{Aru}, and two languages of \ili{Kei} (see \srf{14-05}).
...
node of the \tsc{\ili{Ambon}-Seram} subgroup (see \crf{ch:AS}).
...
the \ili{Aru} Islands and \ili{Kei} Islands.
At l\ili{east} one species,
...
Three extant species are attested on the \ili{Aru} Islands: \it{Murexis
...
and \it{Sminthopis virginiae} ‘Red-cheeked Dunnart’.\footnote{
		...
		and known from the fossil record on the \ili{Aru} Islands.}
An additional
species \it{Myoictis melas} ‘Müller’s Three-striped Dasyure’
occurs on Waigeo, Batanta and \ili{Salawati}. \citep[42--48]{LaveryFlannery2023}.
...
in the \ili{Kei} Islands,
\ili{Aru}, Misool, and Halmahera \citep{Salas2016}.
