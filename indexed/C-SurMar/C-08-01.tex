...
these languages (\ili{Ambel}, \ili{Biga}, \ili{As}, \ili{Matbat}, Ma{\Q}ya,
\ili{Legenyem}, \ili{Salawati}, \ili{Batta}): \it{Spilocuscus papuensis} is endemic
...
information for \ili{Ambai}, and includes many additional words for
kinds of cuscus (or possums) which are compounds for \it{fimuna}.\footnote{
		These \ili{Ambai} phrases are:
...
kinds of cuscus which are compounds with \it{kapa} `mammal'.\footnote{
		\ili{Ansus} phrases involving \it{kapa} in \citet{PriceDonohue2009} are:
...
\endhead	
\ili{Ambel}			&	wgo	&	tamʧám;				&	cuscus;					&	\it{misc.}		&	\cite[777]{Arnold2018}, LA\footnotemark	\\
					&			&	tamʧám hu;		&	ground cuscus;	&								&	\hp{\,}	\\
					&			&	tamʧám 				&	kind of cuscus	&								&	\hp{\,}	\\	\hhline{~}
					&			&	malélen				&									&								&	\hp{\,}	\\
\ili{Biga}			&	bhc	&	ta³f;					&	cuscus;					&	\it{misc.}		&	\hp{\,}	\\
					&			&	kaˈsu³t				&	ground cuscus		&	\it{misc.}		&	LA	\\
\ili{As}				&	asz	&	do³;					&	cuscus;					&	**kVndoR(a)/	&	LA	\\	\hhline{~}
					&			&								&									&	**kindoR			&	\hp{\,}	\\
					&			&	le³ntati gu³	&	ground cuscus		&	\it{misc.}		&	\hp{\,}	\\
\ili{Matbat}		&	xmt	&	doː (?);			&	cuscus;					&	**kVndoR(a)/	&	\cite[241]{Blust1982};	\\	\hhline{~}
					&			&								&									&	**kindoR;			&	\hp{\,}	\\
					&			&	iba¹²¹ŋ				&	cuscus					&	\it{misc.}		&	\cite{Schapper2011}	\\
Ma{\Q}ya	&	slz	&	amˈʧa¹²m			&	cuscus					&	\it{misc.}		&	LA	\\
\ili{Legenyem}	&	lcc	&	tamˈca¹²m			&	cuscus					&	\it{misc.}		&	LA	\\
\ili{Salawati}	&	xmx	&	yo³l;					&	cuscus;					&	\it{misc.}		&	LA	\\
					&			&	əsu¹²k				&	ground cuscus		&	\it{misc.}		&	\hp{\,}	\\
\ili{Batta}			&	xmx	&	yo¹l;					&	cuscus;					&	\it{misc.}		&	LA	\\
					&			&	qəwi¹²t				&	ground cuscus		&	\it{misc.}		&	\hp{\,}	\\
\ili{Buli}			&	bzq	&	do						&	small marsupial	&	**kVndoR(a)/	&	\cite[241]{Blust1982}	\\	\hhline{~}
					&			&								&									&	**kindoR			&	\hp{\,}	\\
\ili{Sawai}			&	szw	&	sɛfsɛf				&	cuscus					&	\it{misc.}		&	\cite{WhislerWhisler1995b}	\\
\ili{Patani}		&	ptn	&	sifsɛf				&	cuscus					&	\it{misc.}		&	Linne Iren Sjånes Rødvand (pers. comm. August 2023)	\\
\ili{Giman}			&	gzn	&	do						&	cuscus					&	**kVndoR(a)/	&	\cite{Teljeur-Grimes1990}	\\	\hhline{~}
					&			&								&									&	**kindoR		&	\hp{\,}	\\
\ili{Taba}	&	mky	&	kusok					&	cuscus					&	*kusor			&	\cite[105]{Collins1982a}	\\
\end{xltabular}}
...
Language	&	ISO	&	Term					&	Gloss						&	Etymon				&	Source	\\	\midrule	\hhline{~}
\endhead	
\ili{Biak}			&	bhw	&	rambav				&	cuscus					&	\it{misc.}	&	\cite{Heuvel2019}	\\
\ili{Roon}			&	rnn	&	maŋgadiaβi		&	opossum					&	\it{misc.}	&	SV \citeyear[248]{SmitsVoorhoeve1992b}	\\
\ili{Dusner}		&	dsn	&	urɛm					&	opossum					&	\it{misc.}	&	SV \citeyear[248]{SmitsVoorhoeve1992b}	\\
\ili{Meoswar}		&	mvx	&	karau					&	opossum					&	\it{misc.}	&	SV \citeyear[248]{SmitsVoorhoeve1992b}	\\
\ili{Yaur}			&	jau	&	ˈubiɛ					&	opossum					&	\it{misc.}	&	SV \citeyear[249]{SmitsVoorhoeve1992b}	\\
\ili{Yerisiam}	&	ire	&	átóòrà 				&	cuscus					&	**kVndoR(a)	&	\cite[69]{Kamholz2014}	\\
Yeretaur	&	gop	&	naˈgɔmbrar		&	opossum					&	\it{misc.}	&	SV \citeyear[249]{SmitsVoorhoeve1992b}	\\
\ili{Moor}			&	mhz	&	aˈtiɛta/			&	opossum					&	\it{misc.}	&	SV \citeyear[249]{SmitsVoorhoeve1992b}	\\	\hhline{~}
					&			&	aˈtiat				&									&							&	\hp{\,}	\\
\ili{Warembori}	&	wsa	&	maya-ro/			&	cuscus					&	**mantəR		&	\cite{Donohue1999b}	\\	\hhline{~}
					&			&	maye					&									&							&	\hp{\,}	\\
\ili{Yoke}			&	yki	&	maraɣi				&	cuscus					&	**mantəR		&	\cite{Donohue1999b}	\\
\ili{Ansus}			&	and	&	amu						&	cuscus					&	\it{misc.}	&	\cite{PriceDonohue2009}	\\
...
\ili{Ambai}			&	amk	&	fimuna;				&	cuscus;					&	\it{misc.}	&	\cite{Price2002}	\\
					...
					%&			&	kamirei 		&									&							&	\hp{\,}	\\	\hhline{~}
					%&			&	roroŋ				&									&							&	\hp{\,}	\\	
\ili{Wandamen}	&	wad	&	aniai 				&	opossum					&	\it{misc.}	&	SV \citeyear[248]{SmitsVoorhoeve1992b}	\\	%\hhline{~}
%					&			&	(kaˈkɔpa)			&									&							&	\hp{\,}	\\
\ili{Serui-Laut}&	seu	&	wondoi				&	opossum					&	\it{misc.}	&	SV \citeyear[248]{SmitsVoorhoeve1992b}	\\
\lspbottomrule
\end{xltabular}}
